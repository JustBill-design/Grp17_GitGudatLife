...
HD_PWD='C:/Users/yourmum/Downloads/fpga-pain/fpga-pain/cores/managed_ip_project/managed_ip_project.runs/clk_10_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_10.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_10.tcl
