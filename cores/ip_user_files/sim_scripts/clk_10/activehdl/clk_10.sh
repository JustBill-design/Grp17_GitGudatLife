...
#                script (type 'clk_10.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/yourmum/Downloads/fpga-pain/fpga-pain/cores/managed_ip_project/managed_ip_project.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
