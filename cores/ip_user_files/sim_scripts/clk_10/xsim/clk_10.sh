...
#
# Script generated by Vivado on Tue Apr 15 22:42:23 +0800 2025
...
#
# Usage        : clk_10.sh
#                clk_10.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clk_10.sh [-reset_run]
#                clk_10.sh [-reset_log]
#                clk_10.sh [-help]
#
...
# script info
echo -e "clk_10.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clk_10.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_10 xil_defaultlib.clk_10 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim clk_10 -key {Behavioral:sim_1:Functional:clk_10} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb clk_10.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./clk_10.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: clk_10.sh [-help]\n\
Usage: clk_10.sh [-step]\n\
Usage: clk_10.sh [-lib_map_path]\n\
Usage: clk_10.sh [-reset_run]\n\
Usage: clk_10.sh [-reset_log]\n\
Usage: clk_10.sh [-keep_index]\n\
Usage: clk_10.sh [-noclean_files]\n\n\
