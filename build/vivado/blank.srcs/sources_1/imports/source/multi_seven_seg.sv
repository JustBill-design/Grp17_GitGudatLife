...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_872404754 = DIGIT_BITS;
    localparam _MP_DIV_872404754 = DIV;
    localparam _MP_TOP_872404754 = DIGITS - 1'h1;
    localparam _MP_UP_872404754 = 1'h1;
    logic [(_MP_SIZE_872404754)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_872404754),
        .DIV(_MP_DIV_872404754),
        .TOP(_MP_TOP_872404754),
        .UP(_MP_UP_872404754)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_499570903 = 3'h4;
    localparam _MP_LEADING_ZEROS_499570903 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_499570903),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_499570903)
    ) decimal_renderer (
