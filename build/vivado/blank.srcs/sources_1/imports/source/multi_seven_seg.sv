...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_918861099 = DIGIT_BITS;
    localparam _MP_DIV_918861099 = DIV;
    localparam _MP_TOP_918861099 = DIGITS - 1'h1;
    localparam _MP_UP_918861099 = 1'h1;
    logic [(_MP_SIZE_918861099)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_918861099),
        .DIV(_MP_DIV_918861099),
        .TOP(_MP_TOP_918861099),
        .UP(_MP_UP_918861099)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_36072775 = 3'h4;
    localparam _MP_LEADING_ZEROS_36072775 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_36072775),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_36072775)
    ) decimal_renderer (
