...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_734295110 = DIGIT_BITS;
    localparam _MP_DIV_734295110 = DIV;
    localparam _MP_TOP_734295110 = DIGITS - 1'h1;
    localparam _MP_UP_734295110 = 1'h1;
    logic [(_MP_SIZE_734295110)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_734295110),
        .DIV(_MP_DIV_734295110),
        .TOP(_MP_TOP_734295110),
        .UP(_MP_UP_734295110)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_879489833 = 3'h4;
    localparam _MP_LEADING_ZEROS_879489833 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_879489833),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_879489833)
    ) decimal_renderer (
