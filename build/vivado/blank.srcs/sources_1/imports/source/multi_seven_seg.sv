...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_921463692 = DIGIT_BITS;
    localparam _MP_DIV_921463692 = DIV;
    localparam _MP_TOP_921463692 = DIGITS - 1'h1;
    localparam _MP_UP_921463692 = 1'h1;
    logic [(_MP_SIZE_921463692)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_921463692),
        .DIV(_MP_DIV_921463692),
        .TOP(_MP_TOP_921463692),
        .UP(_MP_UP_921463692)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1715572115 = 3'h4;
    localparam _MP_LEADING_ZEROS_1715572115 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1715572115),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1715572115)
    ) decimal_renderer (
