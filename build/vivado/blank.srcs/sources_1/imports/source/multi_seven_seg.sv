...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_813660842 = DIGIT_BITS;
    localparam _MP_DIV_813660842 = DIV;
    localparam _MP_TOP_813660842 = DIGITS - 1'h1;
    localparam _MP_UP_813660842 = 1'h1;
    logic [(_MP_SIZE_813660842)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_813660842),
        .DIV(_MP_DIV_813660842),
        .TOP(_MP_TOP_813660842),
        .UP(_MP_UP_813660842)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1312552217 = 3'h4;
    localparam _MP_LEADING_ZEROS_1312552217 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1312552217),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1312552217)
    ) decimal_renderer (
