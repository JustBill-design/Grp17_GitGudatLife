...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_460462313 = DIGIT_BITS;
    localparam _MP_DIV_460462313 = DIV;
    localparam _MP_TOP_460462313 = DIGITS - 1'h1;
    localparam _MP_UP_460462313 = 1'h1;
    logic [(_MP_SIZE_460462313)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_460462313),
        .DIV(_MP_DIV_460462313),
        .TOP(_MP_TOP_460462313),
        .UP(_MP_UP_460462313)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1952316951 = 3'h4;
    localparam _MP_LEADING_ZEROS_1952316951 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1952316951),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1952316951)
    ) decimal_renderer (
