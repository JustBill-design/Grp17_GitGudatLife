...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_962488225 = DIGIT_BITS;
    localparam _MP_DIV_962488225 = DIV;
    localparam _MP_TOP_962488225 = DIGITS - 1'h1;
    localparam _MP_UP_962488225 = 1'h1;
    logic [(_MP_SIZE_962488225)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_962488225),
        .DIV(_MP_DIV_962488225),
        .TOP(_MP_TOP_962488225),
        .UP(_MP_UP_962488225)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1902451440 = 3'h4;
    localparam _MP_LEADING_ZEROS_1902451440 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1902451440),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1902451440)
    ) decimal_renderer (
