...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_649496473 = DIGIT_BITS;
    localparam _MP_DIV_649496473 = DIV;
    localparam _MP_TOP_649496473 = DIGITS - 1'h1;
    localparam _MP_UP_649496473 = 1'h1;
    logic [(_MP_SIZE_649496473)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_649496473),
        .DIV(_MP_DIV_649496473),
        .TOP(_MP_TOP_649496473),
        .UP(_MP_UP_649496473)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1712432775 = 3'h4;
    localparam _MP_LEADING_ZEROS_1712432775 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1712432775),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1712432775)
    ) decimal_renderer (
