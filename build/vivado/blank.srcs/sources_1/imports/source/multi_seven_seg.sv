...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_761366612 = DIGIT_BITS;
    localparam _MP_DIV_761366612 = DIV;
    localparam _MP_TOP_761366612 = DIGITS - 1'h1;
    localparam _MP_UP_761366612 = 1'h1;
    logic [(_MP_SIZE_761366612)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_761366612),
        .DIV(_MP_DIV_761366612),
        .TOP(_MP_TOP_761366612),
        .UP(_MP_UP_761366612)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1612568266 = 3'h4;
    localparam _MP_LEADING_ZEROS_1612568266 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1612568266),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1612568266)
    ) decimal_renderer (
