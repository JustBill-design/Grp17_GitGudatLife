...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_202675590 = DIGIT_BITS;
    localparam _MP_DIV_202675590 = DIV;
    localparam _MP_TOP_202675590 = DIGITS - 1'h1;
    localparam _MP_UP_202675590 = 1'h1;
    logic [(_MP_SIZE_202675590)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_202675590),
        .DIV(_MP_DIV_202675590),
        .TOP(_MP_TOP_202675590),
        .UP(_MP_UP_202675590)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_31907058 = 3'h4;
    localparam _MP_LEADING_ZEROS_31907058 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_31907058),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_31907058)
    ) decimal_renderer (
