...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_252333514 = DIGIT_BITS;
    localparam _MP_DIV_252333514 = DIV;
    localparam _MP_TOP_252333514 = DIGITS - 1'h1;
    localparam _MP_UP_252333514 = 1'h1;
    logic [(_MP_SIZE_252333514)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_252333514),
        .DIV(_MP_DIV_252333514),
        .TOP(_MP_TOP_252333514),
        .UP(_MP_UP_252333514)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_784397310 = 3'h4;
    localparam _MP_LEADING_ZEROS_784397310 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_784397310),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_784397310)
    ) decimal_renderer (
