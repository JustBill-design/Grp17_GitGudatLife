...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_284983644 = DIGIT_BITS;
    localparam _MP_DIV_284983644 = DIV;
    localparam _MP_TOP_284983644 = DIGITS - 1'h1;
    localparam _MP_UP_284983644 = 1'h1;
    logic [(_MP_SIZE_284983644)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_284983644),
        .DIV(_MP_DIV_284983644),
        .TOP(_MP_TOP_284983644),
        .UP(_MP_UP_284983644)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_628728181 = 3'h4;
    localparam _MP_LEADING_ZEROS_628728181 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_628728181),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_628728181)
    ) decimal_renderer (
