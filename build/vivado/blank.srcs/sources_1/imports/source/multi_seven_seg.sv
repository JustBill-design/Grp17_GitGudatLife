...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_563163278 = DIGIT_BITS;
    localparam _MP_DIV_563163278 = DIV;
    localparam _MP_TOP_563163278 = DIGITS - 1'h1;
    localparam _MP_UP_563163278 = 1'h1;
    logic [(_MP_SIZE_563163278)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_563163278),
        .DIV(_MP_DIV_563163278),
        .TOP(_MP_TOP_563163278),
        .UP(_MP_UP_563163278)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1551569360 = 3'h4;
    localparam _MP_LEADING_ZEROS_1551569360 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1551569360),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1551569360)
    ) decimal_renderer (
