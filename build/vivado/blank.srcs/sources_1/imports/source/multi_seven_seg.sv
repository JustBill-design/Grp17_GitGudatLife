...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_442256524 = DIGIT_BITS;
    localparam _MP_DIV_442256524 = DIV;
    localparam _MP_TOP_442256524 = DIGITS - 1'h1;
    localparam _MP_UP_442256524 = 1'h1;
    logic [(_MP_SIZE_442256524)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_442256524),
        .DIV(_MP_DIV_442256524),
        .TOP(_MP_TOP_442256524),
        .UP(_MP_UP_442256524)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_536496759 = 3'h4;
    localparam _MP_LEADING_ZEROS_536496759 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_536496759),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_536496759)
    ) decimal_renderer (
