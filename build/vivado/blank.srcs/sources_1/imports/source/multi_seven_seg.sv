...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_178711623 = DIGIT_BITS;
    localparam _MP_DIV_178711623 = DIV;
    localparam _MP_TOP_178711623 = DIGITS - 1'h1;
    localparam _MP_UP_178711623 = 1'h1;
    logic [(_MP_SIZE_178711623)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_178711623),
        .DIV(_MP_DIV_178711623),
        .TOP(_MP_TOP_178711623),
        .UP(_MP_UP_178711623)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_594897850 = 3'h4;
    localparam _MP_LEADING_ZEROS_594897850 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_594897850),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_594897850)
    ) decimal_renderer (
