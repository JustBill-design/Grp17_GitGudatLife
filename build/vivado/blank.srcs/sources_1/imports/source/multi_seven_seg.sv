...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_724668653 = DIGIT_BITS;
    localparam _MP_DIV_724668653 = DIV;
    localparam _MP_TOP_724668653 = DIGITS - 1'h1;
    localparam _MP_UP_724668653 = 1'h1;
    logic [(_MP_SIZE_724668653)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_724668653),
        .DIV(_MP_DIV_724668653),
        .TOP(_MP_TOP_724668653),
        .UP(_MP_UP_724668653)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_718654524 = 3'h4;
    localparam _MP_LEADING_ZEROS_718654524 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_718654524),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_718654524)
    ) decimal_renderer (
