...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_950710343 = DIGIT_BITS;
    localparam _MP_DIV_950710343 = DIV;
    localparam _MP_TOP_950710343 = DIGITS - 1'h1;
    localparam _MP_UP_950710343 = 1'h1;
    logic [(_MP_SIZE_950710343)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_950710343),
        .DIV(_MP_DIV_950710343),
        .TOP(_MP_TOP_950710343),
        .UP(_MP_UP_950710343)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_2043753693 = 3'h4;
    localparam _MP_LEADING_ZEROS_2043753693 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_2043753693),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_2043753693)
    ) decimal_renderer (
