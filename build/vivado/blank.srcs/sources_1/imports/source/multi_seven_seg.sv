...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_663768791 = DIGIT_BITS;
    localparam _MP_DIV_663768791 = DIV;
    localparam _MP_TOP_663768791 = DIGITS - 1'h1;
    localparam _MP_UP_663768791 = 1'h1;
    logic [(_MP_SIZE_663768791)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_663768791),
        .DIV(_MP_DIV_663768791),
        .TOP(_MP_TOP_663768791),
        .UP(_MP_UP_663768791)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1469328644 = 3'h4;
    localparam _MP_LEADING_ZEROS_1469328644 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1469328644),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1469328644)
    ) decimal_renderer (
