...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_714341080 = DIGIT_BITS;
    localparam _MP_DIV_714341080 = DIV;
    localparam _MP_TOP_714341080 = DIGITS - 1'h1;
    localparam _MP_UP_714341080 = 1'h1;
    logic [(_MP_SIZE_714341080)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_714341080),
        .DIV(_MP_DIV_714341080),
        .TOP(_MP_TOP_714341080),
        .UP(_MP_UP_714341080)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1798171474 = 3'h4;
    localparam _MP_LEADING_ZEROS_1798171474 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1798171474),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1798171474)
    ) decimal_renderer (
