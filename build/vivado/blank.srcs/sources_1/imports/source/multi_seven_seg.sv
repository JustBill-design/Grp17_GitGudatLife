...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_865127905 = DIGIT_BITS;
    localparam _MP_DIV_865127905 = DIV;
    localparam _MP_TOP_865127905 = DIGITS - 1'h1;
    localparam _MP_UP_865127905 = 1'h1;
    logic [(_MP_SIZE_865127905)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_865127905),
        .DIV(_MP_DIV_865127905),
        .TOP(_MP_TOP_865127905),
        .UP(_MP_UP_865127905)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_701711875 = 3'h4;
    localparam _MP_LEADING_ZEROS_701711875 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_701711875),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_701711875)
    ) decimal_renderer (
