...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_492580250 = DIGIT_BITS;
    localparam _MP_DIV_492580250 = DIV;
    localparam _MP_TOP_492580250 = DIGITS - 1'h1;
    localparam _MP_UP_492580250 = 1'h1;
    logic [(_MP_SIZE_492580250)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_492580250),
        .DIV(_MP_DIV_492580250),
        .TOP(_MP_TOP_492580250),
        .UP(_MP_UP_492580250)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1682860144 = 3'h4;
    localparam _MP_LEADING_ZEROS_1682860144 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1682860144),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1682860144)
    ) decimal_renderer (
