...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_205217757 = DIGIT_BITS;
    localparam _MP_DIV_205217757 = DIV;
    localparam _MP_TOP_205217757 = DIGITS - 1'h1;
    localparam _MP_UP_205217757 = 1'h1;
    logic [(_MP_SIZE_205217757)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_205217757),
        .DIV(_MP_DIV_205217757),
        .TOP(_MP_TOP_205217757),
        .UP(_MP_UP_205217757)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1064156435 = 3'h4;
    localparam _MP_LEADING_ZEROS_1064156435 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1064156435),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1064156435)
    ) decimal_renderer (
