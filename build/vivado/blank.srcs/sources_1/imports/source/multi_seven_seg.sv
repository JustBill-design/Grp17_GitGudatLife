...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_755851009 = DIGIT_BITS;
    localparam _MP_DIV_755851009 = DIV;
    localparam _MP_TOP_755851009 = DIGITS - 1'h1;
    localparam _MP_UP_755851009 = 1'h1;
    logic [(_MP_SIZE_755851009)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_755851009),
        .DIV(_MP_DIV_755851009),
        .TOP(_MP_TOP_755851009),
        .UP(_MP_UP_755851009)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_372141295 = 3'h4;
    localparam _MP_LEADING_ZEROS_372141295 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_372141295),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_372141295)
    ) decimal_renderer (
