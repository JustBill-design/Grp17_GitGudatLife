...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_258122577 = DIGIT_BITS;
    localparam _MP_DIV_258122577 = DIV;
    localparam _MP_TOP_258122577 = DIGITS - 1'h1;
    localparam _MP_UP_258122577 = 1'h1;
    logic [(_MP_SIZE_258122577)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_258122577),
        .DIV(_MP_DIV_258122577),
        .TOP(_MP_TOP_258122577),
        .UP(_MP_UP_258122577)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1859051384 = 3'h4;
    localparam _MP_LEADING_ZEROS_1859051384 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1859051384),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1859051384)
    ) decimal_renderer (
