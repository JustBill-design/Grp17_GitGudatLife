...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_392464302 = DIGIT_BITS;
    localparam _MP_DIV_392464302 = DIV;
    localparam _MP_TOP_392464302 = DIGITS - 1'h1;
    localparam _MP_UP_392464302 = 1'h1;
    logic [(_MP_SIZE_392464302)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_392464302),
        .DIV(_MP_DIV_392464302),
        .TOP(_MP_TOP_392464302),
        .UP(_MP_UP_392464302)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_41034950 = 3'h4;
    localparam _MP_LEADING_ZEROS_41034950 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_41034950),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_41034950)
    ) decimal_renderer (
