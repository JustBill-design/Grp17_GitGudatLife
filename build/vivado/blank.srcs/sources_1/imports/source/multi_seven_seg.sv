...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_369960262 = DIGIT_BITS;
    localparam _MP_DIV_369960262 = DIV;
    localparam _MP_TOP_369960262 = DIGITS - 1'h1;
    localparam _MP_UP_369960262 = 1'h1;
    logic [(_MP_SIZE_369960262)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_369960262),
        .DIV(_MP_DIV_369960262),
        .TOP(_MP_TOP_369960262),
        .UP(_MP_UP_369960262)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_811012280 = 3'h4;
    localparam _MP_LEADING_ZEROS_811012280 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_811012280),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_811012280)
    ) decimal_renderer (
