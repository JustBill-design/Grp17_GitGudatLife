...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_808457776 = DIGIT_BITS;
    localparam _MP_DIV_808457776 = DIV;
    localparam _MP_TOP_808457776 = DIGITS - 1'h1;
    localparam _MP_UP_808457776 = 1'h1;
    logic [(_MP_SIZE_808457776)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_808457776),
        .DIV(_MP_DIV_808457776),
        .TOP(_MP_TOP_808457776),
        .UP(_MP_UP_808457776)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1972933361 = 3'h4;
    localparam _MP_LEADING_ZEROS_1972933361 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1972933361),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1972933361)
    ) decimal_renderer (
