...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_380736686 = DIGIT_BITS;
    localparam _MP_DIV_380736686 = DIV;
    localparam _MP_TOP_380736686 = DIGITS - 1'h1;
    localparam _MP_UP_380736686 = 1'h1;
    logic [(_MP_SIZE_380736686)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_380736686),
        .DIV(_MP_DIV_380736686),
        .TOP(_MP_TOP_380736686),
        .UP(_MP_UP_380736686)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1922370895 = 3'h4;
    localparam _MP_LEADING_ZEROS_1922370895 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1922370895),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1922370895)
    ) decimal_renderer (
