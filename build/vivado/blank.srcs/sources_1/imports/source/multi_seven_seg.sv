...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_603573238 = DIGIT_BITS;
    localparam _MP_DIV_603573238 = DIV;
    localparam _MP_TOP_603573238 = DIGITS - 1'h1;
    localparam _MP_UP_603573238 = 1'h1;
    logic [(_MP_SIZE_603573238)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_603573238),
        .DIV(_MP_DIV_603573238),
        .TOP(_MP_TOP_603573238),
        .UP(_MP_UP_603573238)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_2064301002 = 3'h4;
    localparam _MP_LEADING_ZEROS_2064301002 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_2064301002),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_2064301002)
    ) decimal_renderer (
