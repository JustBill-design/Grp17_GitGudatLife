...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_51809124 = DIGIT_BITS;
    localparam _MP_DIV_51809124 = DIV;
    localparam _MP_TOP_51809124 = DIGITS - 1'h1;
    localparam _MP_UP_51809124 = 1'h1;
    logic [(_MP_SIZE_51809124)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_51809124),
        .DIV(_MP_DIV_51809124),
        .TOP(_MP_TOP_51809124),
        .UP(_MP_UP_51809124)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1498923107 = 3'h4;
    localparam _MP_LEADING_ZEROS_1498923107 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1498923107),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1498923107)
    ) decimal_renderer (
