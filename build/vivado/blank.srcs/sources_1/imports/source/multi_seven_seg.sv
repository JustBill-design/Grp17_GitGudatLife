...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_538765955 = DIGIT_BITS;
    localparam _MP_DIV_538765955 = DIV;
    localparam _MP_TOP_538765955 = DIGITS - 1'h1;
    localparam _MP_UP_538765955 = 1'h1;
    logic [(_MP_SIZE_538765955)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_538765955),
        .DIV(_MP_DIV_538765955),
        .TOP(_MP_TOP_538765955),
        .UP(_MP_UP_538765955)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_142517990 = 3'h4;
    localparam _MP_LEADING_ZEROS_142517990 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_142517990),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_142517990)
    ) decimal_renderer (
