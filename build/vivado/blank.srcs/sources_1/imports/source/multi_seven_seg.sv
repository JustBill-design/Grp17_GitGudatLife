...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_699673785 = DIGIT_BITS;
    localparam _MP_DIV_699673785 = DIV;
    localparam _MP_TOP_699673785 = DIGITS - 1'h1;
    localparam _MP_UP_699673785 = 1'h1;
    logic [(_MP_SIZE_699673785)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_699673785),
        .DIV(_MP_DIV_699673785),
        .TOP(_MP_TOP_699673785),
        .UP(_MP_UP_699673785)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_772627393 = 3'h4;
    localparam _MP_LEADING_ZEROS_772627393 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_772627393),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_772627393)
    ) decimal_renderer (
