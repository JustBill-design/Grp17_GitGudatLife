...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_461265859 = DIGIT_BITS;
    localparam _MP_DIV_461265859 = DIV;
    localparam _MP_TOP_461265859 = DIGITS - 1'h1;
    localparam _MP_UP_461265859 = 1'h1;
    logic [(_MP_SIZE_461265859)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_461265859),
        .DIV(_MP_DIV_461265859),
        .TOP(_MP_TOP_461265859),
        .UP(_MP_UP_461265859)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1578858317 = 3'h4;
    localparam _MP_LEADING_ZEROS_1578858317 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1578858317),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1578858317)
    ) decimal_renderer (
