...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_921072377 = DIGIT_BITS;
    localparam _MP_DIV_921072377 = DIV;
    localparam _MP_TOP_921072377 = DIGITS - 1'h1;
    localparam _MP_UP_921072377 = 1'h1;
    logic [(_MP_SIZE_921072377)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_921072377),
        .DIV(_MP_DIV_921072377),
        .TOP(_MP_TOP_921072377),
        .UP(_MP_UP_921072377)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_343220429 = 3'h4;
    localparam _MP_LEADING_ZEROS_343220429 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_343220429),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_343220429)
    ) decimal_renderer (
