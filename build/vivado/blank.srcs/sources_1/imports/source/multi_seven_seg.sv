...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_712906788 = DIGIT_BITS;
    localparam _MP_DIV_712906788 = DIV;
    localparam _MP_TOP_712906788 = DIGITS - 1'h1;
    localparam _MP_UP_712906788 = 1'h1;
    logic [(_MP_SIZE_712906788)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_712906788),
        .DIV(_MP_DIV_712906788),
        .TOP(_MP_TOP_712906788),
        .UP(_MP_UP_712906788)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1976438883 = 3'h4;
    localparam _MP_LEADING_ZEROS_1976438883 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1976438883),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1976438883)
    ) decimal_renderer (
