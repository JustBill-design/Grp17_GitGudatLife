...
module bram #(
    ...
    localparam _MP_WIDTH_1948340278 = WIDTH;
    localparam _MP_ENTRIES_1948340278 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1948340278)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1948340278-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1948340278-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1948340278),
        .ENTRIES(_MP_ENTRIES_1948340278)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_247160132 = WIDTH;
    localparam _MP_ENTRIES_247160132 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_247160132)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_247160132-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_247160132-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_247160132),
        .ENTRIES(_MP_ENTRIES_247160132)
    ) bram2 (
        .clk(clk),
