...
module bram #(
    ...
    localparam _MP_WIDTH_1054324627 = WIDTH;
    localparam _MP_ENTRIES_1054324627 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1054324627)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1054324627-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1054324627-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1054324627),
        .ENTRIES(_MP_ENTRIES_1054324627)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_2078422912 = WIDTH;
    localparam _MP_ENTRIES_2078422912 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_2078422912)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_2078422912-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_2078422912-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_2078422912),
        .ENTRIES(_MP_ENTRIES_2078422912)
    ) bram2 (
        .clk(clk),
