...
module bram #(
    ...
    localparam _MP_WIDTH_1709548387 = WIDTH;
    localparam _MP_ENTRIES_1709548387 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1709548387)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1709548387-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1709548387-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1709548387),
        .ENTRIES(_MP_ENTRIES_1709548387)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_283619498 = WIDTH;
    localparam _MP_ENTRIES_283619498 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_283619498)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_283619498-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_283619498-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_283619498),
        .ENTRIES(_MP_ENTRIES_283619498)
    ) bram2 (
        .clk(clk),
