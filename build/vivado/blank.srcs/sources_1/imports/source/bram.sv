...
module bram #(
    ...
    localparam _MP_WIDTH_1092154012 = WIDTH;
    localparam _MP_ENTRIES_1092154012 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1092154012)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1092154012-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1092154012-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1092154012),
        .ENTRIES(_MP_ENTRIES_1092154012)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1892248131 = WIDTH;
    localparam _MP_ENTRIES_1892248131 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1892248131)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1892248131-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1892248131-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1892248131),
        .ENTRIES(_MP_ENTRIES_1892248131)
    ) bram2 (
        .clk(clk),
