...
module bram #(
    ...
    localparam _MP_WIDTH_955434500 = WIDTH;
    localparam _MP_ENTRIES_955434500 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_955434500)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_955434500-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_955434500-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_955434500),
        .ENTRIES(_MP_ENTRIES_955434500)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1754659353 = WIDTH;
    localparam _MP_ENTRIES_1754659353 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1754659353)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1754659353-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1754659353-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1754659353),
        .ENTRIES(_MP_ENTRIES_1754659353)
    ) bram2 (
        .clk(clk),
