...
module bram #(
    ...
    localparam _MP_WIDTH_1775085262 = WIDTH;
    localparam _MP_ENTRIES_1775085262 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1775085262)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1775085262-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1775085262-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1775085262),
        .ENTRIES(_MP_ENTRIES_1775085262)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1075744007 = WIDTH;
    localparam _MP_ENTRIES_1075744007 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1075744007)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1075744007-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1075744007-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1075744007),
        .ENTRIES(_MP_ENTRIES_1075744007)
    ) bram2 (
        .clk(clk),
