...
module bram #(
    ...
    localparam _MP_WIDTH_1119237709 = WIDTH;
    localparam _MP_ENTRIES_1119237709 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1119237709)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1119237709-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1119237709-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1119237709),
        .ENTRIES(_MP_ENTRIES_1119237709)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_743708287 = WIDTH;
    localparam _MP_ENTRIES_743708287 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_743708287)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_743708287-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_743708287-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_743708287),
        .ENTRIES(_MP_ENTRIES_743708287)
    ) bram2 (
        .clk(clk),
