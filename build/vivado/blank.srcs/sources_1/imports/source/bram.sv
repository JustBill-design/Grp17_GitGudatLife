...
module bram #(
    ...
    localparam _MP_WIDTH_646049047 = WIDTH;
    localparam _MP_ENTRIES_646049047 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_646049047)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_646049047-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_646049047-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_646049047),
        .ENTRIES(_MP_ENTRIES_646049047)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1001255972 = WIDTH;
    localparam _MP_ENTRIES_1001255972 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1001255972)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1001255972-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1001255972-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1001255972),
        .ENTRIES(_MP_ENTRIES_1001255972)
    ) bram2 (
        .clk(clk),
