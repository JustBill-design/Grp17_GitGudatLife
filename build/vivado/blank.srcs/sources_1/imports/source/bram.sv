...
module bram #(
    ...
    localparam _MP_WIDTH_29767258 = WIDTH;
    localparam _MP_ENTRIES_29767258 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_29767258)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_29767258-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_29767258-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_29767258),
        .ENTRIES(_MP_ENTRIES_29767258)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_2061434371 = WIDTH;
    localparam _MP_ENTRIES_2061434371 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_2061434371)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_2061434371-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_2061434371-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_2061434371),
        .ENTRIES(_MP_ENTRIES_2061434371)
    ) bram2 (
        .clk(clk),
