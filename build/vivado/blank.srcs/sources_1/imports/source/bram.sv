...
module bram #(
    ...
    localparam _MP_WIDTH_392704653 = WIDTH;
    localparam _MP_ENTRIES_392704653 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_392704653)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_392704653-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_392704653-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_392704653),
        .ENTRIES(_MP_ENTRIES_392704653)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_612043015 = WIDTH;
    localparam _MP_ENTRIES_612043015 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_612043015)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_612043015-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_612043015-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_612043015),
        .ENTRIES(_MP_ENTRIES_612043015)
    ) bram2 (
        .clk(clk),
