...
module bram #(
    ...
    localparam _MP_WIDTH_882870349 = WIDTH;
    localparam _MP_ENTRIES_882870349 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_882870349)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_882870349-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_882870349-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_882870349),
        .ENTRIES(_MP_ENTRIES_882870349)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1614283654 = WIDTH;
    localparam _MP_ENTRIES_1614283654 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1614283654)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1614283654-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1614283654-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1614283654),
        .ENTRIES(_MP_ENTRIES_1614283654)
    ) bram2 (
        .clk(clk),
