...
module bram #(
    ...
    localparam _MP_WIDTH_2052793857 = WIDTH;
    localparam _MP_ENTRIES_2052793857 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_2052793857)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_2052793857-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_2052793857-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_2052793857),
        .ENTRIES(_MP_ENTRIES_2052793857)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_826802409 = WIDTH;
    localparam _MP_ENTRIES_826802409 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_826802409)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_826802409-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_826802409-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_826802409),
        .ENTRIES(_MP_ENTRIES_826802409)
    ) bram2 (
        .clk(clk),
