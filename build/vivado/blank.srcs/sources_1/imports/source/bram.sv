...
module bram #(
    ...
    localparam _MP_WIDTH_1020742256 = WIDTH;
    localparam _MP_ENTRIES_1020742256 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1020742256)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1020742256-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1020742256-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1020742256),
        .ENTRIES(_MP_ENTRIES_1020742256)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_657506914 = WIDTH;
    localparam _MP_ENTRIES_657506914 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_657506914)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_657506914-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_657506914-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_657506914),
        .ENTRIES(_MP_ENTRIES_657506914)
    ) bram2 (
        .clk(clk),
