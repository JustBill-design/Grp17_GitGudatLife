...
module bram #(
    ...
    localparam _MP_WIDTH_660319618 = WIDTH;
    localparam _MP_ENTRIES_660319618 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_660319618)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_660319618-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_660319618-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_660319618),
        .ENTRIES(_MP_ENTRIES_660319618)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1118550574 = WIDTH;
    localparam _MP_ENTRIES_1118550574 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1118550574)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1118550574-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1118550574-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1118550574),
        .ENTRIES(_MP_ENTRIES_1118550574)
    ) bram2 (
        .clk(clk),
