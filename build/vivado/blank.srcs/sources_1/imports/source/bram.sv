...
module bram #(
    ...
    localparam _MP_WIDTH_1471086748 = WIDTH;
    localparam _MP_ENTRIES_1471086748 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1471086748)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1471086748-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1471086748-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1471086748),
        .ENTRIES(_MP_ENTRIES_1471086748)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_676454695 = WIDTH;
    localparam _MP_ENTRIES_676454695 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_676454695)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_676454695-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_676454695-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_676454695),
        .ENTRIES(_MP_ENTRIES_676454695)
    ) bram2 (
        .clk(clk),
