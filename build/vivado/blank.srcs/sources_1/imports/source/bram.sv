...
module bram #(
    ...
    localparam _MP_WIDTH_278150662 = WIDTH;
    localparam _MP_ENTRIES_278150662 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_278150662)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_278150662-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_278150662-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_278150662),
        .ENTRIES(_MP_ENTRIES_278150662)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_54906947 = WIDTH;
    localparam _MP_ENTRIES_54906947 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_54906947)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_54906947-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_54906947-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_54906947),
        .ENTRIES(_MP_ENTRIES_54906947)
    ) bram2 (
        .clk(clk),
