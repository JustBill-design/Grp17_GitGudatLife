...
module bram #(
    ...
    localparam _MP_WIDTH_1484805900 = WIDTH;
    localparam _MP_ENTRIES_1484805900 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1484805900)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1484805900-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1484805900-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1484805900),
        .ENTRIES(_MP_ENTRIES_1484805900)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_739499425 = WIDTH;
    localparam _MP_ENTRIES_739499425 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_739499425)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_739499425-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_739499425-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_739499425),
        .ENTRIES(_MP_ENTRIES_739499425)
    ) bram2 (
        .clk(clk),
