...
module bram #(
    ...
    localparam _MP_WIDTH_1187335142 = WIDTH;
    localparam _MP_ENTRIES_1187335142 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1187335142)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1187335142-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1187335142-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1187335142),
        .ENTRIES(_MP_ENTRIES_1187335142)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1389425683 = WIDTH;
    localparam _MP_ENTRIES_1389425683 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1389425683)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1389425683-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1389425683-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1389425683),
        .ENTRIES(_MP_ENTRIES_1389425683)
    ) bram2 (
        .clk(clk),
