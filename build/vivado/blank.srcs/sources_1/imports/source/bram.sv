...
module bram #(
    ...
    localparam _MP_WIDTH_1380421480 = WIDTH;
    localparam _MP_ENTRIES_1380421480 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1380421480)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1380421480-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1380421480-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1380421480),
        .ENTRIES(_MP_ENTRIES_1380421480)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1107437029 = WIDTH;
    localparam _MP_ENTRIES_1107437029 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1107437029)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1107437029-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1107437029-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1107437029),
        .ENTRIES(_MP_ENTRIES_1107437029)
    ) bram2 (
        .clk(clk),
