...
module bram #(
    ...
    localparam _MP_WIDTH_251156360 = WIDTH;
    localparam _MP_ENTRIES_251156360 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_251156360)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_251156360-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_251156360-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_251156360),
        .ENTRIES(_MP_ENTRIES_251156360)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1081509619 = WIDTH;
    localparam _MP_ENTRIES_1081509619 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1081509619)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1081509619-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1081509619-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1081509619),
        .ENTRIES(_MP_ENTRIES_1081509619)
    ) bram2 (
        .clk(clk),
