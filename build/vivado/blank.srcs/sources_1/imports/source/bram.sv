...
module bram #(
    ...
    localparam _MP_WIDTH_1122088191 = WIDTH;
    localparam _MP_ENTRIES_1122088191 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1122088191)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1122088191-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1122088191-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1122088191),
        .ENTRIES(_MP_ENTRIES_1122088191)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1917751071 = WIDTH;
    localparam _MP_ENTRIES_1917751071 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1917751071)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1917751071-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1917751071-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1917751071),
        .ENTRIES(_MP_ENTRIES_1917751071)
    ) bram2 (
        .clk(clk),
