...
module bram #(
    ...
    localparam _MP_WIDTH_1957510507 = WIDTH;
    localparam _MP_ENTRIES_1957510507 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1957510507)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1957510507-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1957510507-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1957510507),
        .ENTRIES(_MP_ENTRIES_1957510507)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1080726958 = WIDTH;
    localparam _MP_ENTRIES_1080726958 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1080726958)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1080726958-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1080726958-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1080726958),
        .ENTRIES(_MP_ENTRIES_1080726958)
    ) bram2 (
        .clk(clk),
