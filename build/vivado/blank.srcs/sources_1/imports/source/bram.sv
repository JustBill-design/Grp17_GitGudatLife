...
module bram #(
    ...
    localparam _MP_WIDTH_1147583390 = WIDTH;
    localparam _MP_ENTRIES_1147583390 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1147583390)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1147583390-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1147583390-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1147583390),
        .ENTRIES(_MP_ENTRIES_1147583390)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1882369613 = WIDTH;
    localparam _MP_ENTRIES_1882369613 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1882369613)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1882369613-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1882369613-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1882369613),
        .ENTRIES(_MP_ENTRIES_1882369613)
    ) bram2 (
        .clk(clk),
