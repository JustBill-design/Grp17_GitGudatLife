...
module bram #(
    ...
    localparam _MP_WIDTH_1202731189 = WIDTH;
    localparam _MP_ENTRIES_1202731189 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1202731189)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1202731189-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1202731189-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1202731189),
        .ENTRIES(_MP_ENTRIES_1202731189)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_573920925 = WIDTH;
    localparam _MP_ENTRIES_573920925 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_573920925)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_573920925-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_573920925-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_573920925),
        .ENTRIES(_MP_ENTRIES_573920925)
    ) bram2 (
        .clk(clk),
