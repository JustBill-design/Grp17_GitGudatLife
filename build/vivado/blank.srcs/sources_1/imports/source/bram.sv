...
module bram #(
    ...
    localparam _MP_WIDTH_436458737 = WIDTH;
    localparam _MP_ENTRIES_436458737 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_436458737)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_436458737-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_436458737-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_436458737),
        .ENTRIES(_MP_ENTRIES_436458737)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_469742939 = WIDTH;
    localparam _MP_ENTRIES_469742939 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_469742939)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_469742939-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_469742939-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_469742939),
        .ENTRIES(_MP_ENTRIES_469742939)
    ) bram2 (
        .clk(clk),
