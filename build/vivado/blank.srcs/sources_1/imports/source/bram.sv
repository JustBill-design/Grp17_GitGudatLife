...
module bram #(
    ...
    localparam _MP_WIDTH_756951664 = WIDTH;
    localparam _MP_ENTRIES_756951664 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_756951664)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_756951664-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_756951664-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_756951664),
        .ENTRIES(_MP_ENTRIES_756951664)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_336699115 = WIDTH;
    localparam _MP_ENTRIES_336699115 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_336699115)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_336699115-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_336699115-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_336699115),
        .ENTRIES(_MP_ENTRIES_336699115)
    ) bram2 (
        .clk(clk),
