...
module bram #(
    ...
    localparam _MP_WIDTH_909132053 = WIDTH;
    localparam _MP_ENTRIES_909132053 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_909132053)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_909132053-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_909132053-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_909132053),
        .ENTRIES(_MP_ENTRIES_909132053)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_2049314109 = WIDTH;
    localparam _MP_ENTRIES_2049314109 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_2049314109)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_2049314109-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_2049314109-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_2049314109),
        .ENTRIES(_MP_ENTRIES_2049314109)
    ) bram2 (
        .clk(clk),
