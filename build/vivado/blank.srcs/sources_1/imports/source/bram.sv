...
module bram #(
    ...
    localparam _MP_WIDTH_829926878 = WIDTH;
    localparam _MP_ENTRIES_829926878 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_829926878)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_829926878-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_829926878-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_829926878),
        .ENTRIES(_MP_ENTRIES_829926878)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_510189959 = WIDTH;
    localparam _MP_ENTRIES_510189959 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_510189959)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_510189959-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_510189959-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_510189959),
        .ENTRIES(_MP_ENTRIES_510189959)
    ) bram2 (
        .clk(clk),
