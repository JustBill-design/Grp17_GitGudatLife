...
module bram #(
    ...
    localparam _MP_WIDTH_916888733 = WIDTH;
    localparam _MP_ENTRIES_916888733 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_916888733)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_916888733-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_916888733-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_916888733),
        .ENTRIES(_MP_ENTRIES_916888733)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_858475734 = WIDTH;
    localparam _MP_ENTRIES_858475734 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_858475734)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_858475734-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_858475734-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_858475734),
        .ENTRIES(_MP_ENTRIES_858475734)
    ) bram2 (
        .clk(clk),
