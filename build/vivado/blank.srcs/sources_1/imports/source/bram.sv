...
module bram #(
    ...
    localparam _MP_WIDTH_1323712377 = WIDTH;
    localparam _MP_ENTRIES_1323712377 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1323712377)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1323712377-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1323712377-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1323712377),
        .ENTRIES(_MP_ENTRIES_1323712377)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1769529248 = WIDTH;
    localparam _MP_ENTRIES_1769529248 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1769529248)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1769529248-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1769529248-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1769529248),
        .ENTRIES(_MP_ENTRIES_1769529248)
    ) bram2 (
        .clk(clk),
