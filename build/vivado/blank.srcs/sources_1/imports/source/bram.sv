...
module bram #(
    ...
    localparam _MP_WIDTH_1832986598 = WIDTH;
    localparam _MP_ENTRIES_1832986598 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1832986598)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1832986598-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1832986598-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1832986598),
        .ENTRIES(_MP_ENTRIES_1832986598)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1865096952 = WIDTH;
    localparam _MP_ENTRIES_1865096952 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1865096952)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1865096952-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1865096952-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1865096952),
        .ENTRIES(_MP_ENTRIES_1865096952)
    ) bram2 (
        .clk(clk),
