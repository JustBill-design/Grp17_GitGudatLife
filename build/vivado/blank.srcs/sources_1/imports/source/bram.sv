...
module bram #(
    ...
    localparam _MP_WIDTH_1429941548 = WIDTH;
    localparam _MP_ENTRIES_1429941548 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1429941548)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1429941548-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1429941548-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1429941548),
        .ENTRIES(_MP_ENTRIES_1429941548)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_220842016 = WIDTH;
    localparam _MP_ENTRIES_220842016 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_220842016)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_220842016-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_220842016-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_220842016),
        .ENTRIES(_MP_ENTRIES_220842016)
    ) bram2 (
        .clk(clk),
