...
module bram #(
    ...
    localparam _MP_WIDTH_1749720003 = WIDTH;
    localparam _MP_ENTRIES_1749720003 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1749720003)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1749720003-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1749720003-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1749720003),
        .ENTRIES(_MP_ENTRIES_1749720003)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1611111206 = WIDTH;
    localparam _MP_ENTRIES_1611111206 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1611111206)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1611111206-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1611111206-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1611111206),
        .ENTRIES(_MP_ENTRIES_1611111206)
    ) bram2 (
        .clk(clk),
