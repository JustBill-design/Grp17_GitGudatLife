...
module bram #(
    ...
    localparam _MP_WIDTH_2131838588 = WIDTH;
    localparam _MP_ENTRIES_2131838588 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_2131838588)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_2131838588-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_2131838588-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_2131838588),
        .ENTRIES(_MP_ENTRIES_2131838588)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1017945363 = WIDTH;
    localparam _MP_ENTRIES_1017945363 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1017945363)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1017945363-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1017945363-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1017945363),
        .ENTRIES(_MP_ENTRIES_1017945363)
    ) bram2 (
        .clk(clk),
