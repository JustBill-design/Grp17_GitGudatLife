...
module bram #(
    ...
    localparam _MP_WIDTH_547758599 = WIDTH;
    localparam _MP_ENTRIES_547758599 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_547758599)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_547758599-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_547758599-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_547758599),
        .ENTRIES(_MP_ENTRIES_547758599)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1468248721 = WIDTH;
    localparam _MP_ENTRIES_1468248721 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1468248721)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1468248721-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1468248721-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1468248721),
        .ENTRIES(_MP_ENTRIES_1468248721)
    ) bram2 (
        .clk(clk),
