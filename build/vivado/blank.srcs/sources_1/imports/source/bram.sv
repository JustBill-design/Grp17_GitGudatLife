...
module bram #(
    ...
    localparam _MP_WIDTH_1429705795 = WIDTH;
    localparam _MP_ENTRIES_1429705795 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1429705795)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1429705795-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1429705795-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1429705795),
        .ENTRIES(_MP_ENTRIES_1429705795)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_256200786 = WIDTH;
    localparam _MP_ENTRIES_256200786 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_256200786)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_256200786-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_256200786-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_256200786),
        .ENTRIES(_MP_ENTRIES_256200786)
    ) bram2 (
        .clk(clk),
