...
module bram #(
    ...
    localparam _MP_WIDTH_358987025 = WIDTH;
    localparam _MP_ENTRIES_358987025 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_358987025)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_358987025-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_358987025-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_358987025),
        .ENTRIES(_MP_ENTRIES_358987025)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1044918181 = WIDTH;
    localparam _MP_ENTRIES_1044918181 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1044918181)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1044918181-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1044918181-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1044918181),
        .ENTRIES(_MP_ENTRIES_1044918181)
    ) bram2 (
        .clk(clk),
