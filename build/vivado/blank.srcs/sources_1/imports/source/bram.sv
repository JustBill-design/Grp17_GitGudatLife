...
module bram #(
    ...
    localparam _MP_WIDTH_1032074941 = WIDTH;
    localparam _MP_ENTRIES_1032074941 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1032074941)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1032074941-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1032074941-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1032074941),
        .ENTRIES(_MP_ENTRIES_1032074941)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_346705634 = WIDTH;
    localparam _MP_ENTRIES_346705634 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_346705634)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_346705634-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_346705634-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_346705634),
        .ENTRIES(_MP_ENTRIES_346705634)
    ) bram2 (
        .clk(clk),
