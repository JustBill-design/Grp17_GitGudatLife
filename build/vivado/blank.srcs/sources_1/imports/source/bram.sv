...
module bram #(
    ...
    localparam _MP_WIDTH_783765684 = WIDTH;
    localparam _MP_ENTRIES_783765684 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_783765684)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_783765684-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_783765684-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_783765684),
        .ENTRIES(_MP_ENTRIES_783765684)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_814256033 = WIDTH;
    localparam _MP_ENTRIES_814256033 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_814256033)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_814256033-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_814256033-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_814256033),
        .ENTRIES(_MP_ENTRIES_814256033)
    ) bram2 (
        .clk(clk),
