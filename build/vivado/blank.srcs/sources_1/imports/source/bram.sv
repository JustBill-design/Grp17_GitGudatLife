...
module bram #(
    ...
    localparam _MP_WIDTH_1695785602 = WIDTH;
    localparam _MP_ENTRIES_1695785602 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1695785602)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1695785602-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1695785602-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1695785602),
        .ENTRIES(_MP_ENTRIES_1695785602)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_11403827 = WIDTH;
    localparam _MP_ENTRIES_11403827 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_11403827)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_11403827-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_11403827-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_11403827),
        .ENTRIES(_MP_ENTRIES_11403827)
    ) bram2 (
        .clk(clk),
