...
module bram #(
    ...
    localparam _MP_WIDTH_1731997624 = WIDTH;
    localparam _MP_ENTRIES_1731997624 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1731997624)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1731997624-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1731997624-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1731997624),
        .ENTRIES(_MP_ENTRIES_1731997624)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_755245512 = WIDTH;
    localparam _MP_ENTRIES_755245512 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_755245512)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_755245512-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_755245512-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_755245512),
        .ENTRIES(_MP_ENTRIES_755245512)
    ) bram2 (
        .clk(clk),
