...
module alchitry_top (
    ...
    localparam _MP_SIZE_1774991524 = 4'hd;
    logic [12:0] M_alum_a;
    logic [12:0] M_alum_b;
    ...
    logic rst;
    logic fifo_rst;
    localparam _MP_STAGES_414557597 = 3'h4;
    logic M_reset_cond_in;
    logic M_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_414557597)
    ) reset_cond (
        .clk(clk),
        .in(M_reset_cond_in),
    ...
    localparam logic [3:0][26:0] _MP_CLK_FREQ_1454956618 = {{27'hbebc20, 27'hbebc20, 27'hbebc20, 27'hbebc20}};
    localparam _MP_MIN_DELAY_1454956618 = 5'h14;
    localparam _MP_NUM_SYNC_1454956618 = 2'h2;
    logic [3:0] M_cond_butt_dirs_in;
    logic [3:0] M_cond_butt_dirs_out;
    
    genvar idx_0_1454956618;
    
    generate
        for (idx_0_1454956618 = 0; idx_0_1454956618 < 4; idx_0_1454956618 = idx_0_1454956618 + 1) begin: forLoop_idx_0_1454956618
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_1454956618[idx_0_1454956618]),
                .MIN_DELAY(_MP_MIN_DELAY_1454956618),
                .NUM_SYNC(_MP_NUM_SYNC_1454956618)
            ) cond_butt_dirs (
                .clk(clk),
                .in(M_cond_butt_dirs_in[idx_0_1454956618]),
                .out(M_cond_butt_dirs_out[idx_0_1454956618])
            );
        end
    endgenerate
    
    
    localparam logic [1:0][26:0] _MP_CLK_FREQ_446652085 = {{27'hbebc20, 27'hbebc20}};
    localparam _MP_MIN_DELAY_446652085 = 5'h14;
    localparam _MP_NUM_SYNC_446652085 = 2'h2;
    logic [1:0] M_cond_butt_sel_desel_in;
    logic [1:0] M_cond_butt_sel_desel_out;
    
    genvar idx_0_446652085;
    
    generate
        for (idx_0_446652085 = 0; idx_0_446652085 < 2; idx_0_446652085 = idx_0_446652085 + 1) begin: forLoop_idx_0_446652085
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_446652085[idx_0_446652085]),
                .MIN_DELAY(_MP_MIN_DELAY_446652085),
                .NUM_SYNC(_MP_NUM_SYNC_446652085)
            ) cond_butt_sel_desel (
                .clk(clk),
                .in(M_cond_butt_sel_desel_in[idx_0_446652085]),
                .out(M_cond_butt_sel_desel_out[idx_0_446652085])
            );
        end
    endgenerate
    
    
    localparam _MP_CLK_FREQ_1218869538 = 27'hbebc20;
    localparam _MP_MIN_DELAY_1218869538 = 5'h14;
    localparam _MP_NUM_SYNC_1218869538 = 2'h2;
    logic M_cond_butt_next_play_in;
    logic M_cond_butt_next_play_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_1218869538),
        .MIN_DELAY(_MP_MIN_DELAY_1218869538),
        .NUM_SYNC(_MP_NUM_SYNC_1218869538)
    ) cond_butt_next_play (
        .clk(clk),
    ...
    localparam _MP_RISE_1437922655 = 1'h1;
    localparam _MP_FALL_1437922655 = 1'h0;
    logic M_edge_next_play_in;
    logic M_edge_next_play_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1437922655),
        .FALL(_MP_FALL_1437922655)
    ) edge_next_play (
        .clk(clk),
    ...
    localparam _MP_RISE_1649012475 = 1'h1;
    localparam _MP_FALL_1649012475 = 1'h0;
    logic M_timerclk_in;
    logic M_timerclk_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1649012475),
        .FALL(_MP_FALL_1649012475)
    ) timerclk (
        .clk(clk),
        .in(M_timerclk_in),
        .out(M_timerclk_out)
    ...
    localparam _MP_RISE_1062721652 = 1'h1;
    localparam _MP_FALL_1062721652 = 1'h0;
    logic M_gameclk_in;
    logic M_gameclk_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1062721652),
        .FALL(_MP_FALL_1062721652)
    ) gameclk (
        .clk(clk),
        .in(M_gameclk_in),
        .out(M_gameclk_out)
    ...
    localparam _MP_RISE_298967854 = 1'h1;
    localparam _MP_FALL_298967854 = 1'h0;
    logic M_med_inputclk_in;
    logic M_med_inputclk_out;
    
    edge_detector #(
        .RISE(_MP_RISE_298967854),
        .FALL(_MP_FALL_298967854)
    ) med_inputclk (
        .clk(clk),
    ...
    localparam _MP_RISE_440795311 = 1'h1;
    localparam _MP_FALL_440795311 = 1'h0;
    logic M_edge_up_in;
    logic M_edge_up_out;
    
    edge_detector #(
        .RISE(_MP_RISE_440795311),
        .FALL(_MP_FALL_440795311)
    ) edge_up (
        .clk(clk),
        .in(M_edge_up_in),
        .out(M_edge_up_out)
    ...
    localparam _MP_WIDTH_599536486 = 2'h2;
    localparam _MP_ENTRIES_599536486 = 13'h1080;
    ...
    bram #(
        .WIDTH(_MP_WIDTH_599536486),
        .ENTRIES(_MP_ENTRIES_599536486)
    ) brams (
        .clk(clk),
    ...
    localparam _MP_ADDRESS_SIZE_468082349 = 3'h5;
    localparam _MP_MATRIX_WIDTH_468082349 = 7'h40;
    localparam _MP_CLK_FREQ_468082349 = 27'hbebc20;
    ...
    display_driver #(
        .ADDRESS_SIZE(_MP_ADDRESS_SIZE_468082349),
        .MATRIX_WIDTH(_MP_MATRIX_WIDTH_468082349),
        .CLK_FREQ(_MP_CLK_FREQ_468082349)
    ) display (
        .clk(clk),
        .rst(rst),
        .data(M_display_data),
    ...
    localparam _MP_WIDTH_1422092193 = 4'hd;
    localparam _MP_ENTRIES_1422092193 = 4'h8;
    logic [2:0] M_reg_ra1;
    logic [2:0] M_reg_ra2;
    ...
    regfile #(
        .WIDTH(_MP_WIDTH_1422092193),
        .ENTRIES(_MP_ENTRIES_1422092193)
    ) L_reg (
        .clk(clk),
        .rst(rst),
        .ra1(M_reg_ra1),
    ...
    localparam _MP_DIGITS_1878881173 = 3'h4;
    localparam _MP_DIV_1878881173 = 5'h10;
    logic [13:0] M_aseg_driver_value;
    logic [11:0] M_aseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_1878881173),
        .DIV(_MP_DIV_1878881173)
    ) aseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_189741560 = 3'h4;
    localparam _MP_DIV_189741560 = 5'h10;
    logic [13:0] M_bseg_driver_value;
    logic [11:0] M_bseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_189741560),
        .DIV(_MP_DIV_189741560)
    ) bseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_178931687 = 3'h4;
    localparam _MP_DIV_178931687 = 5'h10;
    logic [13:0] M_timerseg_driver_value;
    logic [11:0] M_timerseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_178931687),
        .DIV(_MP_DIV_178931687)
    ) timerseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_WIDTH_455783000 = 2'h2;
    localparam _MP_ENTRIES_455783000 = 3'h4;
    logic [1:0] M_sr1_din;
    logic M_sr1_wput;
    ...
    shift_register #(
        .WIDTH(_MP_WIDTH_455783000),
        .ENTRIES(_MP_ENTRIES_455783000)
    ) sr1 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr1_din),
    ...
    localparam _MP_WIDTH_84572504 = 2'h2;
    localparam _MP_ENTRIES_84572504 = 3'h4;
    logic [1:0] M_sr2_din;
    logic M_sr2_wput;
    ...
    shift_register #(
        .WIDTH(_MP_WIDTH_84572504),
        .ENTRIES(_MP_ENTRIES_84572504)
    ) sr2 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr2_din),
    ...
    localparam _MP_WIDTH_1948636085 = 2'h2;
    localparam _MP_ENTRIES_1948636085 = 3'h4;
    logic [1:0] M_sr3_din;
    logic M_sr3_wput;
    ...
    shift_register #(
        .WIDTH(_MP_WIDTH_1948636085),
        .ENTRIES(_MP_ENTRIES_1948636085)
    ) sr3 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr3_din),
