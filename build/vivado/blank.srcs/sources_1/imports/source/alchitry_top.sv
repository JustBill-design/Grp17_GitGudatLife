...
module alchitry_top (
    ...
    localparam _MP_SIZE_27265695 = 6'h20;
    logic [31:0] M_amod_a;
    logic [31:0] M_amod_b;
    ...
    logic rst;
    localparam _MP_ADDRESS_SIZE_1241921668 = 3'h5;
    localparam _MP_MATRIX_WIDTH_1241921668 = 7'h40;
    ...
    display_driver #(
        .ADDRESS_SIZE(_MP_ADDRESS_SIZE_1241921668),
        .MATRIX_WIDTH(_MP_MATRIX_WIDTH_1241921668)
    ) display (
        .clk(clk),
        .rst(rst),
        .data(M_display_data),
    ...
    localparam _MP_STAGES_1414562985 = 3'h4;
    logic M_reset_cond_in;
    logic M_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_1414562985)
    ) reset_cond (
        .clk(clk),
        .in(M_reset_cond_in),
    ...
    localparam _MP_CLK_FREQ_578411188 = 27'h5f5e100;
    localparam _MP_MIN_DELAY_578411188 = 5'h14;
    localparam _MP_NUM_SYNC_578411188 = 2'h2;
    logic M_butt_cond_in;
    logic M_butt_cond_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_578411188),
        .MIN_DELAY(_MP_MIN_DELAY_578411188),
        .NUM_SYNC(_MP_NUM_SYNC_578411188)
    ) butt_cond (
        .clk(clk),
        .in(M_butt_cond_in),
        .out(M_butt_cond_out)
