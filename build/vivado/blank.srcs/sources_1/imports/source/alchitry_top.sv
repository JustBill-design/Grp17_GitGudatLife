...
module alchitry_top (
    ...
    localparam _MP_SIZE_1625448220 = 6'h20;
    logic [31:0] M_alum_a;
    logic [31:0] M_alum_b;
    ...
    logic rst;
    logic fifo_rst;
    localparam _MP_STAGES_1230773789 = 3'h4;
    logic M_reset_cond_in;
    logic M_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_1230773789)
    ) reset_cond (
        .clk(clk),
        .in(M_reset_cond_in),
    ...
    localparam _MP_STAGES_1044822424 = 3'h4;
    logic M_fifo_reset_cond_in;
    logic M_fifo_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_1044822424)
    ) fifo_reset_cond (
        .clk(clk),
    ...
    localparam logic [3:0][23:0] _MP_CLK_FREQ_109970772 = {{24'h895440, 24'h895440, 24'h895440, 24'h895440}};
    localparam _MP_MIN_DELAY_109970772 = 5'h14;
    localparam _MP_NUM_SYNC_109970772 = 2'h2;
    logic [3:0] M_cond_butt_dirs_in;
    logic [3:0] M_cond_butt_dirs_out;
    
    genvar idx_0_109970772;
    
    generate
        for (idx_0_109970772 = 0; idx_0_109970772 < 4; idx_0_109970772 = idx_0_109970772 + 1) begin: forLoop_idx_0_109970772
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_109970772[idx_0_109970772]),
                .MIN_DELAY(_MP_MIN_DELAY_109970772),
                .NUM_SYNC(_MP_NUM_SYNC_109970772)
            ) cond_butt_dirs (
                .clk(clk),
                .in(M_cond_butt_dirs_in[idx_0_109970772]),
                .out(M_cond_butt_dirs_out[idx_0_109970772])
            );
        end
    endgenerate
    
    
    localparam logic [1:0][23:0] _MP_CLK_FREQ_506767560 = {{24'h895440, 24'h895440}};
    localparam _MP_MIN_DELAY_506767560 = 5'h14;
    localparam _MP_NUM_SYNC_506767560 = 2'h2;
    logic [1:0] M_cond_butt_sel_desel_in;
    logic [1:0] M_cond_butt_sel_desel_out;
    
    genvar idx_0_506767560;
    
    generate
        for (idx_0_506767560 = 0; idx_0_506767560 < 2; idx_0_506767560 = idx_0_506767560 + 1) begin: forLoop_idx_0_506767560
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_506767560[idx_0_506767560]),
                .MIN_DELAY(_MP_MIN_DELAY_506767560),
                .NUM_SYNC(_MP_NUM_SYNC_506767560)
            ) cond_butt_sel_desel (
                .clk(clk),
                .in(M_cond_butt_sel_desel_in[idx_0_506767560]),
                .out(M_cond_butt_sel_desel_out[idx_0_506767560])
            );
        end
    endgenerate
    
    
    localparam _MP_CLK_FREQ_761161654 = 24'h895440;
    localparam _MP_MIN_DELAY_761161654 = 5'h14;
    localparam _MP_NUM_SYNC_761161654 = 2'h2;
    logic M_cond_butt_next_play_in;
    logic M_cond_butt_next_play_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_761161654),
        .MIN_DELAY(_MP_MIN_DELAY_761161654),
        .NUM_SYNC(_MP_NUM_SYNC_761161654)
    ) cond_butt_next_play (
        .clk(clk),
    ...
    localparam _MP_CLK_FREQ_1697768363 = 24'h895440;
    localparam _MP_MIN_DELAY_1697768363 = 5'h14;
    localparam _MP_NUM_SYNC_1697768363 = 2'h2;
    logic M_butt_cond_in;
    logic M_butt_cond_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_1697768363),
        .MIN_DELAY(_MP_MIN_DELAY_1697768363),
        .NUM_SYNC(_MP_NUM_SYNC_1697768363)
    ) butt_cond (
        .clk(clk),
        .in(M_butt_cond_in),
        .out(M_butt_cond_out)
    ...
    localparam _MP_RISE_1335424947 = 1'h1;
    localparam _MP_FALL_1335424947 = 1'h0;
    logic M_edge_next_play_in;
    logic M_edge_next_play_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1335424947),
        .FALL(_MP_FALL_1335424947)
    ) edge_next_play (
        .clk(clk),
    ...
    localparam _MP_RISE_217355056 = 1'h0;
    localparam _MP_FALL_217355056 = 1'h1;
    logic M_timerclk_in;
    logic M_timerclk_out;
    
    edge_detector #(
        .RISE(_MP_RISE_217355056),
        .FALL(_MP_FALL_217355056)
    ) timerclk (
        .clk(clk),
        .in(M_timerclk_in),
        .out(M_timerclk_out)
    ...
    localparam _MP_RISE_887539943 = 1'h1;
    localparam _MP_FALL_887539943 = 1'h0;
    logic M_gameclk_in;
    logic M_gameclk_out;
    
    edge_detector #(
        .RISE(_MP_RISE_887539943),
        .FALL(_MP_FALL_887539943)
    ) gameclk (
        .clk(clk),
        .in(M_gameclk_in),
        .out(M_gameclk_out)
    ...
    localparam _MP_RISE_180999094 = 1'h1;
    localparam _MP_FALL_180999094 = 1'h0;
    logic M_med_inputclk_in;
    logic M_med_inputclk_out;
    
    edge_detector #(
        .RISE(_MP_RISE_180999094),
        .FALL(_MP_FALL_180999094)
    ) med_inputclk (
        .clk(clk),
    ...
    localparam _MP_ADDRESS_SIZE_1840525664 = 3'h5;
    localparam _MP_MATRIX_WIDTH_1840525664 = 7'h40;
    localparam _MP_CLK_FREQ_1840525664 = 24'h895440;
    ...
    display_driver #(
        .ADDRESS_SIZE(_MP_ADDRESS_SIZE_1840525664),
        .MATRIX_WIDTH(_MP_MATRIX_WIDTH_1840525664),
        .CLK_FREQ(_MP_CLK_FREQ_1840525664)
    ) display (
        .clk(clk),
        .rst(rst),
        .data(M_display_data),
    ...
    localparam _MP_SIZE_1379568307 = 5'h18;
    localparam _MP_DIV_1379568307 = 1'h0;
    localparam _MP_TOP_1379568307 = 24'h895440;
    localparam _MP_UP_1379568307 = 1'h1;
    logic [23:0] M_gamecounter_value;
    
    counter #(
        .SIZE(_MP_SIZE_1379568307),
        .DIV(_MP_DIV_1379568307),
        .TOP(_MP_TOP_1379568307),
        .UP(_MP_UP_1379568307)
    ) gamecounter (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_WIDTH_1572011252 = 2'h2;
    localparam _MP_ENTRIES_1572011252 = 13'h1080;
    ...
    bram #(
        .WIDTH(_MP_WIDTH_1572011252),
        .ENTRIES(_MP_ENTRIES_1572011252)
    ) brams (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_WIDTH_1031967621 = 6'h20;
    localparam _MP_ENTRIES_1031967621 = 4'h8;
    logic [2:0] M_reg_ra1;
    logic [2:0] M_reg_ra2;
    ...
    regfile #(
        .WIDTH(_MP_WIDTH_1031967621),
        .ENTRIES(_MP_ENTRIES_1031967621)
    ) L_reg (
        .clk(clk),
        .rst(rst),
        .ra1(M_reg_ra1),
    ...
    localparam _MP_DIGITS_2037271342 = 3'h4;
    localparam _MP_DIV_2037271342 = 5'h10;
    logic [13:0] M_aseg_driver_value;
    logic [11:0] M_aseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_2037271342),
        .DIV(_MP_DIV_2037271342)
    ) aseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1777666200 = 3'h4;
    localparam _MP_DIV_1777666200 = 5'h10;
    logic [13:0] M_bseg_driver_value;
    logic [11:0] M_bseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_1777666200),
        .DIV(_MP_DIV_1777666200)
    ) bseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1926444116 = 3'h4;
    localparam _MP_DIV_1926444116 = 5'h10;
    logic [13:0] M_timerseg_driver_value;
    logic [11:0] M_timerseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_1926444116),
        .DIV(_MP_DIV_1926444116)
    ) timerseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_SIZE_1461503592 = 4'hd;
    localparam _MP_DIV_1461503592 = 1'h0;
    localparam _MP_TOP_1461503592 = 13'h107f;
    localparam _MP_UP_1461503592 = 1'h1;
    logic [12:0] M_bramtest_value;
    
    counter #(
        .SIZE(_MP_SIZE_1461503592),
        .DIV(_MP_DIV_1461503592),
        .TOP(_MP_TOP_1461503592),
        .UP(_MP_UP_1461503592)
    ) bramtest (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_WIDTH_1198381689 = 2'h2;
    localparam _MP_ENTRIES_1198381689 = 3'h4;
    logic [1:0] M_sr1_din;
    logic M_sr1_wput;
    logic M_sr1_full;
    ...
    fifo #(
        .WIDTH(_MP_WIDTH_1198381689),
        .ENTRIES(_MP_ENTRIES_1198381689)
    ) sr1 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr1_din),
    ...
    localparam _MP_WIDTH_1500180828 = 2'h2;
    localparam _MP_ENTRIES_1500180828 = 3'h4;
    logic [1:0] M_sr2_din;
    logic M_sr2_wput;
    logic M_sr2_full;
    ...
    fifo #(
        .WIDTH(_MP_WIDTH_1500180828),
        .ENTRIES(_MP_ENTRIES_1500180828)
    ) sr2 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr2_din),
    ...
    localparam _MP_WIDTH_39581723 = 2'h2;
    localparam _MP_ENTRIES_39581723 = 3'h4;
    logic [1:0] M_sr3_din;
    logic M_sr3_wput;
    logic M_sr3_full;
    ...
    fifo #(
        .WIDTH(_MP_WIDTH_39581723),
        .ENTRIES(_MP_ENTRIES_39581723)
    ) sr3 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr3_din),
