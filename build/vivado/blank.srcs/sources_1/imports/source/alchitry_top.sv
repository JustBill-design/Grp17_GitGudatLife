...
module alchitry_top (
    ...
    localparam _MP_SIZE_1527207489 = 6'h20;
    logic [31:0] M_amod_a;
    logic [31:0] M_amod_b;
    ...
    localparam _MP_ADDRESS_SIZE_1476836207 = 3'h5;
    localparam _MP_MATRIX_WIDTH_1476836207 = 7'h40;
    ...
    display_driver #(
        .ADDRESS_SIZE(_MP_ADDRESS_SIZE_1476836207),
        .MATRIX_WIDTH(_MP_MATRIX_WIDTH_1476836207)
    ) display (
        .clk(clk),
        .rst(rst),
        .data(M_display_data),
    ...
    localparam _MP_STAGES_334298392 = 3'h4;
    logic M_reset_cond_in;
    logic M_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_334298392)
    ) reset_cond (
        .clk(clk),
        .in(M_reset_cond_in),
    ...
    always @* begin
        ...
        led = 8'h0;
        usb_tx = usb_rx;
        if (M_display_addr == 13'h40) begin
            D_pixeldata_d = 2'h1;
        end else begin
