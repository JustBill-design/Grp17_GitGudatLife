...
module alchitry_top (
    ...
    localparam _MP_SIZE_1691421004 = 6'h20;
    logic [31:0] M_amod_a;
    logic [31:0] M_amod_b;
    ...
    localparam _MP_ADDRESS_SIZE_1556791261 = 3'h5;
    localparam _MP_MATRIX_WIDTH_1556791261 = 7'h40;
    ...
    display_driver #(
        .ADDRESS_SIZE(_MP_ADDRESS_SIZE_1556791261),
        .MATRIX_WIDTH(_MP_MATRIX_WIDTH_1556791261)
    ) display (
        .clk(clk),
        .rst(rst),
        .data(M_display_data),
    ...
    localparam _MP_STAGES_1299744833 = 3'h4;
    logic M_reset_cond_in;
    logic M_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_1299744833)
    ) reset_cond (
        .clk(clk),
        .in(M_reset_cond_in),
