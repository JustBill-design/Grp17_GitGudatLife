...
module alchitry_top (
    ...
    localparam _MP_SIZE_692098705 = 6'h20;
    logic [31:0] M_alum_a;
    logic [31:0] M_alum_b;
    ...
    logic rst;
    logic fifo_rst;
    localparam _MP_STAGES_647516449 = 3'h4;
    logic M_reset_cond_in;
    logic M_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_647516449)
    ) reset_cond (
        .clk(clk),
        .in(M_reset_cond_in),
    ...
    localparam _MP_STAGES_1698056263 = 3'h4;
    logic M_fifo_reset_cond_in;
    logic M_fifo_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_1698056263)
    ) fifo_reset_cond (
        .clk(clk),
    ...
    localparam logic [3:0][23:0] _MP_CLK_FREQ_1288049964 = {{24'h895440, 24'h895440, 24'h895440, 24'h895440}};
    localparam _MP_MIN_DELAY_1288049964 = 5'h14;
    localparam _MP_NUM_SYNC_1288049964 = 2'h2;
    logic [3:0] M_cond_butt_dirs_in;
    logic [3:0] M_cond_butt_dirs_out;
    
    genvar idx_0_1288049964;
    
    generate
        for (idx_0_1288049964 = 0; idx_0_1288049964 < 4; idx_0_1288049964 = idx_0_1288049964 + 1) begin: forLoop_idx_0_1288049964
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_1288049964[idx_0_1288049964]),
                .MIN_DELAY(_MP_MIN_DELAY_1288049964),
                .NUM_SYNC(_MP_NUM_SYNC_1288049964)
            ) cond_butt_dirs (
                .clk(clk),
                .in(M_cond_butt_dirs_in[idx_0_1288049964]),
                .out(M_cond_butt_dirs_out[idx_0_1288049964])
            );
        end
    endgenerate
    
    
    localparam logic [1:0][23:0] _MP_CLK_FREQ_2058123141 = {{24'h895440, 24'h895440}};
    localparam _MP_MIN_DELAY_2058123141 = 5'h14;
    localparam _MP_NUM_SYNC_2058123141 = 2'h2;
    logic [1:0] M_cond_butt_sel_desel_in;
    logic [1:0] M_cond_butt_sel_desel_out;
    
    genvar idx_0_2058123141;
    
    generate
        for (idx_0_2058123141 = 0; idx_0_2058123141 < 2; idx_0_2058123141 = idx_0_2058123141 + 1) begin: forLoop_idx_0_2058123141
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_2058123141[idx_0_2058123141]),
                .MIN_DELAY(_MP_MIN_DELAY_2058123141),
                .NUM_SYNC(_MP_NUM_SYNC_2058123141)
            ) cond_butt_sel_desel (
                .clk(clk),
                .in(M_cond_butt_sel_desel_in[idx_0_2058123141]),
                .out(M_cond_butt_sel_desel_out[idx_0_2058123141])
            );
        end
    endgenerate
    
    
    localparam _MP_CLK_FREQ_547591006 = 24'h895440;
    localparam _MP_MIN_DELAY_547591006 = 5'h14;
    localparam _MP_NUM_SYNC_547591006 = 2'h2;
    logic M_cond_butt_next_play_in;
    logic M_cond_butt_next_play_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_547591006),
        .MIN_DELAY(_MP_MIN_DELAY_547591006),
        .NUM_SYNC(_MP_NUM_SYNC_547591006)
    ) cond_butt_next_play (
        .clk(clk),
    ...
    localparam _MP_CLK_FREQ_1240279935 = 24'h895440;
    localparam _MP_MIN_DELAY_1240279935 = 5'h14;
    localparam _MP_NUM_SYNC_1240279935 = 2'h2;
    logic M_butt_cond_in;
    logic M_butt_cond_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_1240279935),
        .MIN_DELAY(_MP_MIN_DELAY_1240279935),
        .NUM_SYNC(_MP_NUM_SYNC_1240279935)
    ) butt_cond (
        .clk(clk),
        .in(M_butt_cond_in),
        .out(M_butt_cond_out)
    ...
    localparam _MP_RISE_1501371837 = 1'h1;
    localparam _MP_FALL_1501371837 = 1'h0;
    logic M_edge_next_play_in;
    logic M_edge_next_play_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1501371837),
        .FALL(_MP_FALL_1501371837)
    ) edge_next_play (
        .clk(clk),
    ...
    localparam _MP_RISE_969053392 = 1'h0;
    localparam _MP_FALL_969053392 = 1'h1;
    logic M_timerclk_in;
    logic M_timerclk_out;
    
    edge_detector #(
        .RISE(_MP_RISE_969053392),
        .FALL(_MP_FALL_969053392)
    ) timerclk (
        .clk(clk),
        .in(M_timerclk_in),
        .out(M_timerclk_out)
    ...
    localparam _MP_RISE_1772379399 = 1'h1;
    localparam _MP_FALL_1772379399 = 1'h0;
    logic M_gameclk_in;
    logic M_gameclk_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1772379399),
        .FALL(_MP_FALL_1772379399)
    ) gameclk (
        .clk(clk),
        .in(M_gameclk_in),
        .out(M_gameclk_out)
    ...
    localparam _MP_ADDRESS_SIZE_2004454276 = 3'h5;
    localparam _MP_MATRIX_WIDTH_2004454276 = 7'h40;
    localparam _MP_CLK_FREQ_2004454276 = 24'h895440;
    ...
    display_driver #(
        .ADDRESS_SIZE(_MP_ADDRESS_SIZE_2004454276),
        .MATRIX_WIDTH(_MP_MATRIX_WIDTH_2004454276),
        .CLK_FREQ(_MP_CLK_FREQ_2004454276)
    ) display (
        .clk(clk),
        .rst(rst),
        .data(M_display_data),
    ...
    localparam _MP_SIZE_1512040882 = 5'h18;
    localparam _MP_DIV_1512040882 = 1'h0;
    localparam _MP_TOP_1512040882 = 24'h895440;
    localparam _MP_UP_1512040882 = 1'h1;
    logic [23:0] M_gamecounter_value;
    
    counter #(
        .SIZE(_MP_SIZE_1512040882),
        .DIV(_MP_DIV_1512040882),
        .TOP(_MP_TOP_1512040882),
        .UP(_MP_UP_1512040882)
    ) gamecounter (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_WIDTH_460303716 = 2'h2;
    localparam _MP_ENTRIES_460303716 = 13'h1080;
    ...
    bram #(
        .WIDTH(_MP_WIDTH_460303716),
        .ENTRIES(_MP_ENTRIES_460303716)
    ) brams (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_WIDTH_1008253024 = 6'h20;
    localparam _MP_ENTRIES_1008253024 = 4'h8;
    logic [2:0] M_reg_ra1;
    logic [2:0] M_reg_ra2;
    ...
    regfile #(
        .WIDTH(_MP_WIDTH_1008253024),
        .ENTRIES(_MP_ENTRIES_1008253024)
    ) L_reg (
        .clk(clk),
        .rst(rst),
        .ra1(M_reg_ra1),
    ...
    localparam _MP_DIGITS_926065783 = 3'h4;
    localparam _MP_DIV_926065783 = 5'h10;
    logic [13:0] M_aseg_driver_value;
    logic [11:0] M_aseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_926065783),
        .DIV(_MP_DIV_926065783)
    ) aseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1967736411 = 3'h4;
    localparam _MP_DIV_1967736411 = 5'h10;
    logic [13:0] M_bseg_driver_value;
    logic [11:0] M_bseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_1967736411),
        .DIV(_MP_DIV_1967736411)
    ) bseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_942080318 = 3'h4;
    localparam _MP_DIV_942080318 = 5'h10;
    logic [13:0] M_timerseg_driver_value;
    logic [11:0] M_timerseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_942080318),
        .DIV(_MP_DIV_942080318)
    ) timerseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_SIZE_2010643172 = 4'hd;
    localparam _MP_DIV_2010643172 = 1'h0;
    localparam _MP_TOP_2010643172 = 13'h107f;
    localparam _MP_UP_2010643172 = 1'h1;
    logic [12:0] M_bramtest_value;
    
    counter #(
        .SIZE(_MP_SIZE_2010643172),
        .DIV(_MP_DIV_2010643172),
        .TOP(_MP_TOP_2010643172),
        .UP(_MP_UP_2010643172)
    ) bramtest (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_WIDTH_484242418 = 2'h2;
    localparam _MP_ENTRIES_484242418 = 3'h4;
    logic [1:0] M_sr1_din;
    logic M_sr1_wput;
    logic M_sr1_full;
    ...
    fifo #(
        .WIDTH(_MP_WIDTH_484242418),
        .ENTRIES(_MP_ENTRIES_484242418)
    ) sr1 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr1_din),
    ...
    localparam _MP_WIDTH_2050688245 = 2'h2;
    localparam _MP_ENTRIES_2050688245 = 3'h4;
    logic [1:0] M_sr2_din;
    logic M_sr2_wput;
    logic M_sr2_full;
    ...
    fifo #(
        .WIDTH(_MP_WIDTH_2050688245),
        .ENTRIES(_MP_ENTRIES_2050688245)
    ) sr2 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr2_din),
    ...
    localparam _MP_WIDTH_1666662697 = 2'h2;
    localparam _MP_ENTRIES_1666662697 = 3'h4;
    logic [1:0] M_sr3_din;
    logic M_sr3_wput;
    logic M_sr3_full;
    ...
    fifo #(
        .WIDTH(_MP_WIDTH_1666662697),
        .ENTRIES(_MP_ENTRIES_1666662697)
    ) sr3 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr3_din),
