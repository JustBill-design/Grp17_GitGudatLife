...
module alchitry_top (
    ...
    localparam _MP_SIZE_1375929147 = 6'h20;
    logic [31:0] M_alum_a;
    logic [31:0] M_alum_b;
    ...
    logic rst;
    logic fifo_rst;
    localparam _MP_STAGES_390475788 = 3'h4;
    logic M_reset_cond_in;
    logic M_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_390475788)
    ) reset_cond (
        .clk(clk),
        .in(M_reset_cond_in),
    ...
    localparam _MP_STAGES_2097606202 = 3'h4;
    logic M_fifo_reset_cond_in;
    logic M_fifo_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_2097606202)
    ) fifo_reset_cond (
        .clk(clk),
    ...
    localparam logic [3:0][23:0] _MP_CLK_FREQ_172739418 = {{24'h989680, 24'h989680, 24'h989680, 24'h989680}};
    localparam logic [3:0][7:0] _MP_MIN_DELAY_172739418 = {{8'hc8, 8'hc8, 8'hc8, 8'hc8}};
    localparam logic [3:0][1:0] _MP_NUM_SYNC_172739418 = {{2'h3, 2'h3, 2'h3, 2'h3}};
    logic [3:0] M_cond_butt_dirs_in;
    logic [3:0] M_cond_butt_dirs_out;
    
    genvar idx_0_172739418;
    
    generate
        for (idx_0_172739418 = 0; idx_0_172739418 < 4; idx_0_172739418 = idx_0_172739418 + 1) begin: forLoop_idx_0_172739418
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_172739418[idx_0_172739418]),
                .MIN_DELAY(_MP_MIN_DELAY_172739418[idx_0_172739418]),
                .NUM_SYNC(_MP_NUM_SYNC_172739418[idx_0_172739418])
            ) cond_butt_dirs (
                .clk(clk),
                .in(M_cond_butt_dirs_in[idx_0_172739418]),
                .out(M_cond_butt_dirs_out[idx_0_172739418])
            );
        end
    endgenerate
    
    
    localparam logic [1:0][23:0] _MP_CLK_FREQ_1986720527 = {{24'h989680, 24'h989680}};
    localparam logic [1:0][7:0] _MP_MIN_DELAY_1986720527 = {{8'hc8, 8'hc8}};
    localparam logic [1:0][1:0] _MP_NUM_SYNC_1986720527 = {{2'h3, 2'h3}};
    logic [1:0] M_cond_butt_sel_desel_in;
    logic [1:0] M_cond_butt_sel_desel_out;
    
    genvar idx_0_1986720527;
    
    generate
        for (idx_0_1986720527 = 0; idx_0_1986720527 < 2; idx_0_1986720527 = idx_0_1986720527 + 1) begin: forLoop_idx_0_1986720527
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_1986720527[idx_0_1986720527]),
                .MIN_DELAY(_MP_MIN_DELAY_1986720527[idx_0_1986720527]),
                .NUM_SYNC(_MP_NUM_SYNC_1986720527[idx_0_1986720527])
            ) cond_butt_sel_desel (
                .clk(clk),
                .in(M_cond_butt_sel_desel_in[idx_0_1986720527]),
                .out(M_cond_butt_sel_desel_out[idx_0_1986720527])
            );
        end
    endgenerate
    
    
    localparam _MP_CLK_FREQ_1658394244 = 24'h989680;
    localparam _MP_MIN_DELAY_1658394244 = 8'hc8;
    localparam _MP_NUM_SYNC_1658394244 = 2'h3;
    logic M_cond_butt_next_play_in;
    logic M_cond_butt_next_play_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_1658394244),
        .MIN_DELAY(_MP_MIN_DELAY_1658394244),
        .NUM_SYNC(_MP_NUM_SYNC_1658394244)
    ) cond_butt_next_play (
        .clk(clk),
    ...
    localparam _MP_CLK_FREQ_1133146971 = 24'h989680;
    localparam _MP_MIN_DELAY_1133146971 = 5'h14;
    localparam _MP_NUM_SYNC_1133146971 = 2'h2;
    logic M_butt_cond_in;
    logic M_butt_cond_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_1133146971),
        .MIN_DELAY(_MP_MIN_DELAY_1133146971),
        .NUM_SYNC(_MP_NUM_SYNC_1133146971)
    ) butt_cond (
        .clk(clk),
        .in(M_butt_cond_in),
        .out(M_butt_cond_out)
    ...
    localparam _MP_RISE_987575959 = 1'h1;
    localparam _MP_FALL_987575959 = 1'h0;
    logic M_edge_next_play_in;
    logic M_edge_next_play_out;
    
    edge_detector #(
        .RISE(_MP_RISE_987575959),
        .FALL(_MP_FALL_987575959)
    ) edge_next_play (
        .clk(clk),
    ...
    localparam _MP_RISE_411589060 = 1'h0;
    localparam _MP_FALL_411589060 = 1'h1;
    logic M_timerclk_in;
    logic M_timerclk_out;
    
    edge_detector #(
        .RISE(_MP_RISE_411589060),
        .FALL(_MP_FALL_411589060)
    ) timerclk (
        .clk(clk),
        .in(M_timerclk_in),
        .out(M_timerclk_out)
    ...
    localparam _MP_RISE_18058198 = 1'h1;
    localparam _MP_FALL_18058198 = 1'h0;
    logic M_gameclk_in;
    logic M_gameclk_out;
    
    edge_detector #(
        .RISE(_MP_RISE_18058198),
        .FALL(_MP_FALL_18058198)
    ) gameclk (
        .clk(clk),
        .in(M_gameclk_in),
        .out(M_gameclk_out)
    ...
    localparam _MP_RISE_21399192 = 1'h1;
    localparam _MP_FALL_21399192 = 1'h0;
    logic M_med_inputclk_in;
    logic M_med_inputclk_out;
    
    edge_detector #(
        .RISE(_MP_RISE_21399192),
        .FALL(_MP_FALL_21399192)
    ) med_inputclk (
        .clk(clk),
    ...
    localparam _MP_ADDRESS_SIZE_2127989135 = 3'h5;
    localparam _MP_MATRIX_WIDTH_2127989135 = 7'h40;
    localparam _MP_CLK_FREQ_2127989135 = 24'h989680;
    ...
    display_driver #(
        .ADDRESS_SIZE(_MP_ADDRESS_SIZE_2127989135),
        .MATRIX_WIDTH(_MP_MATRIX_WIDTH_2127989135),
        .CLK_FREQ(_MP_CLK_FREQ_2127989135)
    ) display (
        .clk(clk),
        .rst(rst),
        .data(M_display_data),
    ...
    localparam _MP_SIZE_1357588931 = 5'h18;
    localparam _MP_DIV_1357588931 = 1'h0;
    localparam _MP_TOP_1357588931 = 24'h989680;
    localparam _MP_UP_1357588931 = 1'h1;
    logic [23:0] M_gamecounter_value;
    
    counter #(
        .SIZE(_MP_SIZE_1357588931),
        .DIV(_MP_DIV_1357588931),
        .TOP(_MP_TOP_1357588931),
        .UP(_MP_UP_1357588931)
    ) gamecounter (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_WIDTH_1754964382 = 2'h2;
    localparam _MP_ENTRIES_1754964382 = 13'h1080;
    ...
    bram #(
        .WIDTH(_MP_WIDTH_1754964382),
        .ENTRIES(_MP_ENTRIES_1754964382)
    ) brams (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_WIDTH_1721371203 = 6'h20;
    localparam _MP_ENTRIES_1721371203 = 4'h8;
    logic [2:0] M_reg_ra1;
    logic [2:0] M_reg_ra2;
    ...
    regfile #(
        .WIDTH(_MP_WIDTH_1721371203),
        .ENTRIES(_MP_ENTRIES_1721371203)
    ) L_reg (
        .clk(clk),
        .rst(rst),
        .ra1(M_reg_ra1),
    ...
    localparam _MP_DIGITS_1609955086 = 3'h4;
    localparam _MP_DIV_1609955086 = 5'h10;
    logic [13:0] M_aseg_driver_value;
    logic [11:0] M_aseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_1609955086),
        .DIV(_MP_DIV_1609955086)
    ) aseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_328695032 = 3'h4;
    localparam _MP_DIV_328695032 = 5'h10;
    logic [13:0] M_bseg_driver_value;
    logic [11:0] M_bseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_328695032),
        .DIV(_MP_DIV_328695032)
    ) bseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1805816281 = 3'h4;
    localparam _MP_DIV_1805816281 = 5'h10;
    logic [13:0] M_timerseg_driver_value;
    logic [11:0] M_timerseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_1805816281),
        .DIV(_MP_DIV_1805816281)
    ) timerseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_SIZE_1475640569 = 4'hd;
    localparam _MP_DIV_1475640569 = 1'h0;
    localparam _MP_TOP_1475640569 = 13'h107f;
    localparam _MP_UP_1475640569 = 1'h1;
    logic [12:0] M_bramtest_value;
    
    counter #(
        .SIZE(_MP_SIZE_1475640569),
        .DIV(_MP_DIV_1475640569),
        .TOP(_MP_TOP_1475640569),
        .UP(_MP_UP_1475640569)
    ) bramtest (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_WIDTH_496368269 = 2'h2;
    localparam _MP_ENTRIES_496368269 = 3'h4;
    logic [1:0] M_sr1_din;
    logic M_sr1_wput;
    logic M_sr1_full;
    ...
    fifo #(
        .WIDTH(_MP_WIDTH_496368269),
        .ENTRIES(_MP_ENTRIES_496368269)
    ) sr1 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr1_din),
    ...
    localparam _MP_WIDTH_989700330 = 2'h2;
    localparam _MP_ENTRIES_989700330 = 3'h4;
    logic [1:0] M_sr2_din;
    logic M_sr2_wput;
    logic M_sr2_full;
    ...
    fifo #(
        .WIDTH(_MP_WIDTH_989700330),
        .ENTRIES(_MP_ENTRIES_989700330)
    ) sr2 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr2_din),
    ...
    localparam _MP_WIDTH_165963505 = 2'h2;
    localparam _MP_ENTRIES_165963505 = 3'h4;
    logic [1:0] M_sr3_din;
    logic M_sr3_wput;
    logic M_sr3_full;
    ...
    fifo #(
        .WIDTH(_MP_WIDTH_165963505),
        .ENTRIES(_MP_ENTRIES_165963505)
    ) sr3 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr3_din),
