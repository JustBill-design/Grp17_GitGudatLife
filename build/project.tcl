...
set verilogSources [list "./source/alchitry_top.sv" "./source/reset_conditioner.sv" "./source/pipeline.sv" "./source/button_conditioner.sv" "./source/simple_dual_port_ram.v.sv" "./source/edge_detector.sv" "./source/bin_to_dec.sv" "./source/fifo.sv" "./source/simple_ram.v.sv" "./source/display_driver.sv" "./source/fsm.sv" "./source/bram.sv" "./source/alu.sv" "./source/alu_adder.sv" "./source/alu_adder_rca.sv" "./source/alu_adder_rca_fa.sv" "./source/alu_boolean.sv" "./source/alu_compare.sv" "./source/alu_divider.sv" "./source/alu_multiplier.sv" "./source/alu_shifter.sv" "./source/alu_shifter_left.sv" "./source/alu_shifter_mux2.sv" "./source/alu_shifter_right.sv" "./source/alu_shifter_right_ari.sv" "./source/lucid_globals.sv" ]
