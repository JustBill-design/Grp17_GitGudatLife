...
set_property PACKAGE_PIN P5 [get_ports {mataddr[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {mataddr[0]}]

set_property PACKAGE_PIN M5 [get_ports {mataddr[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {mataddr[1]}]

set_property PACKAGE_PIN L4 [get_ports {mataddr[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {mataddr[2]}]

set_property PACKAGE_PIN P4 [get_ports {mataddr[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {mataddr[3]}]

set_property PACKAGE_PIN N3 [get_ports {mataddr[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {mataddr[4]}]

set_property PACKAGE_PIN T3 [get_ports {mattop[0]}]
...
set_property PACKAGE_PIN L5 [get_ports {mattop[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {mattop[2]}]

set_property PACKAGE_PIN T2 [get_ports {matbot[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {matbot[0]}]

set_property PACKAGE_PIN R3 [get_ports {matbot[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {matbot[1]}]

set_property PACKAGE_PIN N4 [get_ports {matbot[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {matbot[2]}]

set_property PACKAGE_PIN R1 [get_ports {matclk}]
set_property IOSTANDARD LVCMOS33 [get_ports {matclk}]

set_property PACKAGE_PIN R2 [get_ports {matoe}]
set_property IOSTANDARD LVCMOS33 [get_ports {matoe}]

set_property PACKAGE_PIN M4 [get_ports {matlat}]
