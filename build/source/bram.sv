...
module bram #(
    ...
    localparam _MP_WIDTH_1149717453 = WIDTH;
    localparam _MP_ENTRIES_1149717453 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1149717453)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1149717453-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1149717453-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1149717453),
        .ENTRIES(_MP_ENTRIES_1149717453)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_772291624 = WIDTH;
    localparam _MP_ENTRIES_772291624 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_772291624)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_772291624-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_772291624-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_772291624),
        .ENTRIES(_MP_ENTRIES_772291624)
    ) bram2 (
        .clk(clk),
