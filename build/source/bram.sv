...
module bram #(
    ...
    localparam _MP_WIDTH_1489862713 = WIDTH;
    localparam _MP_ENTRIES_1489862713 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1489862713)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1489862713-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1489862713-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1489862713),
        .ENTRIES(_MP_ENTRIES_1489862713)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_405032040 = WIDTH;
    localparam _MP_ENTRIES_405032040 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_405032040)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_405032040-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_405032040-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_405032040),
        .ENTRIES(_MP_ENTRIES_405032040)
    ) bram2 (
        .clk(clk),
