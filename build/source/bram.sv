...
module bram #(
    ...
    localparam _MP_WIDTH_1763116411 = WIDTH;
    localparam _MP_ENTRIES_1763116411 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1763116411)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1763116411-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1763116411-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1763116411),
        .ENTRIES(_MP_ENTRIES_1763116411)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1117006636 = WIDTH;
    localparam _MP_ENTRIES_1117006636 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1117006636)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1117006636-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1117006636-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1117006636),
        .ENTRIES(_MP_ENTRIES_1117006636)
    ) bram2 (
        .clk(clk),
