...
module bram #(
    ...
    localparam _MP_WIDTH_1248116927 = WIDTH;
    localparam _MP_ENTRIES_1248116927 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1248116927)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1248116927-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1248116927-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1248116927),
        .ENTRIES(_MP_ENTRIES_1248116927)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_157994376 = WIDTH;
    localparam _MP_ENTRIES_157994376 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_157994376)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_157994376-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_157994376-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_157994376),
        .ENTRIES(_MP_ENTRIES_157994376)
    ) bram2 (
        .clk(clk),
