...
module bram #(
    ...
    localparam _MP_WIDTH_1441139547 = WIDTH;
    localparam _MP_ENTRIES_1441139547 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1441139547)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1441139547-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1441139547-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1441139547),
        .ENTRIES(_MP_ENTRIES_1441139547)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_363904724 = WIDTH;
    localparam _MP_ENTRIES_363904724 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_363904724)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_363904724-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_363904724-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_363904724),
        .ENTRIES(_MP_ENTRIES_363904724)
    ) bram2 (
        .clk(clk),
