...
module bram #(
    ...
    localparam _MP_WIDTH_1390471518 = WIDTH;
    localparam _MP_ENTRIES_1390471518 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1390471518)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1390471518-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1390471518-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1390471518),
        .ENTRIES(_MP_ENTRIES_1390471518)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_340014094 = WIDTH;
    localparam _MP_ENTRIES_340014094 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_340014094)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_340014094-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_340014094-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_340014094),
        .ENTRIES(_MP_ENTRIES_340014094)
    ) bram2 (
        .clk(clk),
