...
module bram #(
    ...
    localparam _MP_WIDTH_2065851363 = WIDTH;
    localparam _MP_ENTRIES_2065851363 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_2065851363)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_2065851363-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_2065851363-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_2065851363),
        .ENTRIES(_MP_ENTRIES_2065851363)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_438728395 = WIDTH;
    localparam _MP_ENTRIES_438728395 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_438728395)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_438728395-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_438728395-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_438728395),
        .ENTRIES(_MP_ENTRIES_438728395)
    ) bram2 (
        .clk(clk),
