...
module bram #(
    ...
    localparam _MP_WIDTH_518478023 = WIDTH;
    localparam _MP_ENTRIES_518478023 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_518478023)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_518478023-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_518478023-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_518478023),
        .ENTRIES(_MP_ENTRIES_518478023)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_436432187 = WIDTH;
    localparam _MP_ENTRIES_436432187 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_436432187)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_436432187-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_436432187-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_436432187),
        .ENTRIES(_MP_ENTRIES_436432187)
    ) bram2 (
        .clk(clk),
