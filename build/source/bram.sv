...
module bram #(
    ...
    localparam _MP_WIDTH_1672810451 = WIDTH;
    localparam _MP_ENTRIES_1672810451 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1672810451)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1672810451-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1672810451-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1672810451),
        .ENTRIES(_MP_ENTRIES_1672810451)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1121525759 = WIDTH;
    localparam _MP_ENTRIES_1121525759 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1121525759)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1121525759-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1121525759-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1121525759),
        .ENTRIES(_MP_ENTRIES_1121525759)
    ) bram2 (
        .clk(clk),
