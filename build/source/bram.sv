...
module bram #(
    ...
    localparam _MP_WIDTH_2124305479 = WIDTH;
    localparam _MP_ENTRIES_2124305479 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_2124305479)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_2124305479-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_2124305479-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_2124305479),
        .ENTRIES(_MP_ENTRIES_2124305479)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_238119004 = WIDTH;
    localparam _MP_ENTRIES_238119004 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_238119004)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_238119004-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_238119004-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_238119004),
        .ENTRIES(_MP_ENTRIES_238119004)
    ) bram2 (
        .clk(clk),
