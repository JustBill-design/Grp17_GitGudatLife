...
module bram #(
    ...
    localparam _MP_WIDTH_1245656750 = WIDTH;
    localparam _MP_ENTRIES_1245656750 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1245656750)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1245656750-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1245656750-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1245656750),
        .ENTRIES(_MP_ENTRIES_1245656750)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_932706241 = WIDTH;
    localparam _MP_ENTRIES_932706241 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_932706241)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_932706241-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_932706241-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_932706241),
        .ENTRIES(_MP_ENTRIES_932706241)
    ) bram2 (
        .clk(clk),
