...
module bram #(
    ...
    localparam _MP_WIDTH_1827495179 = WIDTH;
    localparam _MP_ENTRIES_1827495179 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1827495179)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1827495179-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1827495179-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1827495179),
        .ENTRIES(_MP_ENTRIES_1827495179)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_108282354 = WIDTH;
    localparam _MP_ENTRIES_108282354 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_108282354)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_108282354-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_108282354-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_108282354),
        .ENTRIES(_MP_ENTRIES_108282354)
    ) bram2 (
        .clk(clk),
