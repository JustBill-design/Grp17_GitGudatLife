...
module bram #(
    ...
    localparam _MP_WIDTH_1621474691 = WIDTH;
    localparam _MP_ENTRIES_1621474691 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1621474691)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1621474691-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1621474691-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1621474691),
        .ENTRIES(_MP_ENTRIES_1621474691)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_393281892 = WIDTH;
    localparam _MP_ENTRIES_393281892 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_393281892)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_393281892-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_393281892-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_393281892),
        .ENTRIES(_MP_ENTRIES_393281892)
    ) bram2 (
        .clk(clk),
