...
module bram #(
    ...
    localparam _MP_WIDTH_36523345 = WIDTH;
    localparam _MP_ENTRIES_36523345 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_36523345)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_36523345-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_36523345-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_36523345),
        .ENTRIES(_MP_ENTRIES_36523345)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_2125732394 = WIDTH;
    localparam _MP_ENTRIES_2125732394 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_2125732394)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_2125732394-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_2125732394-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_2125732394),
        .ENTRIES(_MP_ENTRIES_2125732394)
    ) bram2 (
        .clk(clk),
