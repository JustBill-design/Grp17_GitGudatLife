...
module bram #(
    ...
    localparam _MP_WIDTH_648517473 = WIDTH;
    localparam _MP_ENTRIES_648517473 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_648517473)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_648517473-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_648517473-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_648517473),
        .ENTRIES(_MP_ENTRIES_648517473)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_2011082635 = WIDTH;
    localparam _MP_ENTRIES_2011082635 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_2011082635)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_2011082635-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_2011082635-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_2011082635),
        .ENTRIES(_MP_ENTRIES_2011082635)
    ) bram2 (
        .clk(clk),
