...
module bram #(
    ...
    localparam _MP_WIDTH_824844471 = WIDTH;
    localparam _MP_ENTRIES_824844471 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_824844471)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_824844471-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_824844471-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_824844471),
        .ENTRIES(_MP_ENTRIES_824844471)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1112499707 = WIDTH;
    localparam _MP_ENTRIES_1112499707 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1112499707)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1112499707-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1112499707-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1112499707),
        .ENTRIES(_MP_ENTRIES_1112499707)
    ) bram2 (
        .clk(clk),
