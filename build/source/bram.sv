...
module bram #(
    ...
    localparam _MP_WIDTH_788791697 = WIDTH;
    localparam _MP_ENTRIES_788791697 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_788791697)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_788791697-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_788791697-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_788791697),
        .ENTRIES(_MP_ENTRIES_788791697)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_64917121 = WIDTH;
    localparam _MP_ENTRIES_64917121 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_64917121)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_64917121-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_64917121-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_64917121),
        .ENTRIES(_MP_ENTRIES_64917121)
    ) bram2 (
        .clk(clk),
