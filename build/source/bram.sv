...
module bram #(
    ...
    localparam _MP_WIDTH_2124357432 = WIDTH;
    localparam _MP_ENTRIES_2124357432 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_2124357432)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_2124357432-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_2124357432-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_2124357432),
        .ENTRIES(_MP_ENTRIES_2124357432)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1027951727 = WIDTH;
    localparam _MP_ENTRIES_1027951727 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1027951727)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1027951727-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1027951727-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1027951727),
        .ENTRIES(_MP_ENTRIES_1027951727)
    ) bram2 (
        .clk(clk),
