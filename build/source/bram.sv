...
module bram #(
    ...
    localparam _MP_WIDTH_1289093350 = WIDTH;
    localparam _MP_ENTRIES_1289093350 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1289093350)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1289093350-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1289093350-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1289093350),
        .ENTRIES(_MP_ENTRIES_1289093350)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_982100368 = WIDTH;
    localparam _MP_ENTRIES_982100368 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_982100368)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_982100368-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_982100368-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_982100368),
        .ENTRIES(_MP_ENTRIES_982100368)
    ) bram2 (
        .clk(clk),
