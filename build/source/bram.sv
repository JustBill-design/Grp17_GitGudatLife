...
module bram #(
    ...
    localparam _MP_WIDTH_46572315 = WIDTH;
    localparam _MP_ENTRIES_46572315 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_46572315)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_46572315-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_46572315-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_46572315),
        .ENTRIES(_MP_ENTRIES_46572315)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_65430603 = WIDTH;
    localparam _MP_ENTRIES_65430603 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_65430603)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_65430603-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_65430603-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_65430603),
        .ENTRIES(_MP_ENTRIES_65430603)
    ) bram2 (
        .clk(clk),
