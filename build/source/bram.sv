...
module bram #(
    ...
    localparam _MP_WIDTH_1347619081 = WIDTH;
    localparam _MP_ENTRIES_1347619081 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1347619081)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1347619081-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1347619081-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1347619081),
        .ENTRIES(_MP_ENTRIES_1347619081)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1562827296 = WIDTH;
    localparam _MP_ENTRIES_1562827296 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1562827296)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1562827296-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1562827296-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1562827296),
        .ENTRIES(_MP_ENTRIES_1562827296)
    ) bram2 (
        .clk(clk),
