...
module bram #(
    ...
    localparam _MP_WIDTH_1903595157 = WIDTH;
    localparam _MP_ENTRIES_1903595157 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1903595157)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1903595157-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1903595157-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1903595157),
        .ENTRIES(_MP_ENTRIES_1903595157)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_750357588 = WIDTH;
    localparam _MP_ENTRIES_750357588 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_750357588)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_750357588-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_750357588-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_750357588),
        .ENTRIES(_MP_ENTRIES_750357588)
    ) bram2 (
        .clk(clk),
