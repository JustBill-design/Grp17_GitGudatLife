...
module bram #(
    ...
    localparam _MP_WIDTH_693421072 = WIDTH;
    localparam _MP_ENTRIES_693421072 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_693421072)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_693421072-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_693421072-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_693421072),
        .ENTRIES(_MP_ENTRIES_693421072)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1710871800 = WIDTH;
    localparam _MP_ENTRIES_1710871800 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1710871800)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1710871800-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1710871800-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1710871800),
        .ENTRIES(_MP_ENTRIES_1710871800)
    ) bram2 (
        .clk(clk),
