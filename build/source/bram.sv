...
module bram #(
    ...
    localparam _MP_WIDTH_990458047 = WIDTH;
    localparam _MP_ENTRIES_990458047 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_990458047)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_990458047-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_990458047-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_990458047),
        .ENTRIES(_MP_ENTRIES_990458047)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1518654726 = WIDTH;
    localparam _MP_ENTRIES_1518654726 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1518654726)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1518654726-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1518654726-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1518654726),
        .ENTRIES(_MP_ENTRIES_1518654726)
    ) bram2 (
        .clk(clk),
