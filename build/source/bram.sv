...
module bram #(
    ...
    localparam _MP_WIDTH_1872146127 = WIDTH;
    localparam _MP_ENTRIES_1872146127 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1872146127)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1872146127-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1872146127-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1872146127),
        .ENTRIES(_MP_ENTRIES_1872146127)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_225849229 = WIDTH;
    localparam _MP_ENTRIES_225849229 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_225849229)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_225849229-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_225849229-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_225849229),
        .ENTRIES(_MP_ENTRIES_225849229)
    ) bram2 (
        .clk(clk),
