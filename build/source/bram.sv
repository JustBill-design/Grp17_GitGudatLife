...
module bram #(
    ...
    localparam _MP_WIDTH_1982377158 = WIDTH;
    localparam _MP_ENTRIES_1982377158 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1982377158)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1982377158-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1982377158-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1982377158),
        .ENTRIES(_MP_ENTRIES_1982377158)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1488386174 = WIDTH;
    localparam _MP_ENTRIES_1488386174 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1488386174)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1488386174-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1488386174-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1488386174),
        .ENTRIES(_MP_ENTRIES_1488386174)
    ) bram2 (
        .clk(clk),
