...
module bram #(
    ...
    localparam _MP_WIDTH_821457868 = WIDTH;
    localparam _MP_ENTRIES_821457868 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_821457868)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_821457868-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_821457868-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_821457868),
        .ENTRIES(_MP_ENTRIES_821457868)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_2047233901 = WIDTH;
    localparam _MP_ENTRIES_2047233901 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_2047233901)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_2047233901-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_2047233901-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_2047233901),
        .ENTRIES(_MP_ENTRIES_2047233901)
    ) bram2 (
        .clk(clk),
