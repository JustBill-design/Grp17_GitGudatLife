...
module bram #(
    ...
    localparam _MP_WIDTH_2126372680 = WIDTH;
    localparam _MP_ENTRIES_2126372680 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_2126372680)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_2126372680-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_2126372680-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_2126372680),
        .ENTRIES(_MP_ENTRIES_2126372680)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_8325041 = WIDTH;
    localparam _MP_ENTRIES_8325041 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_8325041)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_8325041-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_8325041-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_8325041),
        .ENTRIES(_MP_ENTRIES_8325041)
    ) bram2 (
        .clk(clk),
