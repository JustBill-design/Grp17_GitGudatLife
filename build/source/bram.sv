...
module bram #(
    ...
    localparam _MP_WIDTH_190068353 = WIDTH;
    localparam _MP_ENTRIES_190068353 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_190068353)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_190068353-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_190068353-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_190068353),
        .ENTRIES(_MP_ENTRIES_190068353)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_996439562 = WIDTH;
    localparam _MP_ENTRIES_996439562 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_996439562)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_996439562-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_996439562-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_996439562),
        .ENTRIES(_MP_ENTRIES_996439562)
    ) bram2 (
        .clk(clk),
