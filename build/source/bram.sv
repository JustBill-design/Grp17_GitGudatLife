...
module bram #(
    ...
    localparam _MP_WIDTH_612702284 = WIDTH;
    localparam _MP_ENTRIES_612702284 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_612702284)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_612702284-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_612702284-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_612702284),
        .ENTRIES(_MP_ENTRIES_612702284)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1824507687 = WIDTH;
    localparam _MP_ENTRIES_1824507687 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1824507687)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1824507687-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1824507687-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1824507687),
        .ENTRIES(_MP_ENTRIES_1824507687)
    ) bram2 (
        .clk(clk),
