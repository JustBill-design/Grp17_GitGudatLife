...
module bram #(
    ...
    localparam _MP_WIDTH_2061500669 = WIDTH;
    localparam _MP_ENTRIES_2061500669 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_2061500669)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_2061500669-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_2061500669-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_2061500669),
        .ENTRIES(_MP_ENTRIES_2061500669)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_600249480 = WIDTH;
    localparam _MP_ENTRIES_600249480 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_600249480)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_600249480-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_600249480-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_600249480),
        .ENTRIES(_MP_ENTRIES_600249480)
    ) bram2 (
        .clk(clk),
