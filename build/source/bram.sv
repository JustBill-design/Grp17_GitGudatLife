...
module bram #(
    ...
    localparam _MP_WIDTH_497030737 = WIDTH;
    localparam _MP_ENTRIES_497030737 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_497030737)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_497030737-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_497030737-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_497030737),
        .ENTRIES(_MP_ENTRIES_497030737)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1406625821 = WIDTH;
    localparam _MP_ENTRIES_1406625821 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1406625821)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1406625821-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1406625821-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1406625821),
        .ENTRIES(_MP_ENTRIES_1406625821)
    ) bram2 (
        .clk(clk),
