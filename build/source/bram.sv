...
module bram #(
    ...
    localparam _MP_WIDTH_150203317 = WIDTH;
    localparam _MP_ENTRIES_150203317 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_150203317)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_150203317-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_150203317-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_150203317),
        .ENTRIES(_MP_ENTRIES_150203317)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_866909996 = WIDTH;
    localparam _MP_ENTRIES_866909996 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_866909996)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_866909996-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_866909996-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_866909996),
        .ENTRIES(_MP_ENTRIES_866909996)
    ) bram2 (
        .clk(clk),
