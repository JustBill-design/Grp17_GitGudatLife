...
module bram #(
    ...
    localparam _MP_WIDTH_918179690 = WIDTH;
    localparam _MP_ENTRIES_918179690 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_918179690)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_918179690-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_918179690-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_918179690),
        .ENTRIES(_MP_ENTRIES_918179690)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_263933821 = WIDTH;
    localparam _MP_ENTRIES_263933821 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_263933821)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_263933821-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_263933821-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_263933821),
        .ENTRIES(_MP_ENTRIES_263933821)
    ) bram2 (
        .clk(clk),
