...
module bram #(
    ...
    localparam _MP_WIDTH_1021784197 = WIDTH;
    localparam _MP_ENTRIES_1021784197 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1021784197)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1021784197-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1021784197-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1021784197),
        .ENTRIES(_MP_ENTRIES_1021784197)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1918333973 = WIDTH;
    localparam _MP_ENTRIES_1918333973 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1918333973)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1918333973-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1918333973-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1918333973),
        .ENTRIES(_MP_ENTRIES_1918333973)
    ) bram2 (
        .clk(clk),
