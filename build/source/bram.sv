...
module bram #(
    ...
    localparam _MP_WIDTH_1567246950 = WIDTH;
    localparam _MP_ENTRIES_1567246950 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1567246950)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1567246950-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1567246950-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1567246950),
        .ENTRIES(_MP_ENTRIES_1567246950)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_759062048 = WIDTH;
    localparam _MP_ENTRIES_759062048 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_759062048)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_759062048-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_759062048-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_759062048),
        .ENTRIES(_MP_ENTRIES_759062048)
    ) bram2 (
        .clk(clk),
