...
module bram #(
    ...
    localparam _MP_WIDTH_1859633442 = WIDTH;
    localparam _MP_ENTRIES_1859633442 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1859633442)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1859633442-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1859633442-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1859633442),
        .ENTRIES(_MP_ENTRIES_1859633442)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_844556504 = WIDTH;
    localparam _MP_ENTRIES_844556504 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_844556504)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_844556504-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_844556504-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_844556504),
        .ENTRIES(_MP_ENTRIES_844556504)
    ) bram2 (
        .clk(clk),
