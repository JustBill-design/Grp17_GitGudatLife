...
module bram #(
    ...
    localparam _MP_WIDTH_685446166 = WIDTH;
    localparam _MP_ENTRIES_685446166 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_685446166)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_685446166-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_685446166-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_685446166),
        .ENTRIES(_MP_ENTRIES_685446166)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_140416862 = WIDTH;
    localparam _MP_ENTRIES_140416862 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_140416862)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_140416862-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_140416862-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_140416862),
        .ENTRIES(_MP_ENTRIES_140416862)
    ) bram2 (
        .clk(clk),
