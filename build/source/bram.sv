...
module bram #(
    ...
    localparam _MP_WIDTH_1574483217 = WIDTH;
    localparam _MP_ENTRIES_1574483217 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1574483217)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1574483217-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1574483217-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1574483217),
        .ENTRIES(_MP_ENTRIES_1574483217)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1561570581 = WIDTH;
    localparam _MP_ENTRIES_1561570581 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1561570581)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1561570581-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1561570581-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1561570581),
        .ENTRIES(_MP_ENTRIES_1561570581)
    ) bram2 (
        .clk(clk),
