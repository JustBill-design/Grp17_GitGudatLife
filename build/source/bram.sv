...
module bram #(
    ...
    localparam _MP_WIDTH_986024737 = WIDTH;
    localparam _MP_ENTRIES_986024737 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_986024737)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_986024737-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_986024737-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_986024737),
        .ENTRIES(_MP_ENTRIES_986024737)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_675566193 = WIDTH;
    localparam _MP_ENTRIES_675566193 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_675566193)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_675566193-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_675566193-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_675566193),
        .ENTRIES(_MP_ENTRIES_675566193)
    ) bram2 (
        .clk(clk),
