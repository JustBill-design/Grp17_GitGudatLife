...
module bram #(
    ...
    localparam _MP_WIDTH_1550543895 = WIDTH;
    localparam _MP_ENTRIES_1550543895 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1550543895)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1550543895-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1550543895-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1550543895),
        .ENTRIES(_MP_ENTRIES_1550543895)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1408888996 = WIDTH;
    localparam _MP_ENTRIES_1408888996 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1408888996)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1408888996-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1408888996-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1408888996),
        .ENTRIES(_MP_ENTRIES_1408888996)
    ) bram2 (
        .clk(clk),
