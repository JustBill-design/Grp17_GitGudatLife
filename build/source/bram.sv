...
module bram #(
    ...
    localparam _MP_WIDTH_1946737011 = WIDTH;
    localparam _MP_ENTRIES_1946737011 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1946737011)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1946737011-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1946737011-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1946737011),
        .ENTRIES(_MP_ENTRIES_1946737011)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_708181219 = WIDTH;
    localparam _MP_ENTRIES_708181219 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_708181219)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_708181219-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_708181219-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_708181219),
        .ENTRIES(_MP_ENTRIES_708181219)
    ) bram2 (
        .clk(clk),
