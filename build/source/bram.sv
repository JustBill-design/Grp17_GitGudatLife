...
module bram #(
    ...
    localparam _MP_WIDTH_1204247006 = WIDTH;
    localparam _MP_ENTRIES_1204247006 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1204247006)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1204247006-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1204247006-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1204247006),
        .ENTRIES(_MP_ENTRIES_1204247006)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_315578658 = WIDTH;
    localparam _MP_ENTRIES_315578658 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_315578658)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_315578658-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_315578658-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_315578658),
        .ENTRIES(_MP_ENTRIES_315578658)
    ) bram2 (
        .clk(clk),
