...
module bram #(
    ...
    localparam _MP_WIDTH_1227980796 = WIDTH;
    localparam _MP_ENTRIES_1227980796 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1227980796)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1227980796-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1227980796-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1227980796),
        .ENTRIES(_MP_ENTRIES_1227980796)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1229771122 = WIDTH;
    localparam _MP_ENTRIES_1229771122 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1229771122)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1229771122-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1229771122-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1229771122),
        .ENTRIES(_MP_ENTRIES_1229771122)
    ) bram2 (
        .clk(clk),
