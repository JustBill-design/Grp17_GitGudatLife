...
module alu_adder_rca #(
    ...
    genvar idx_0_574537474;
    
    generate
        for (idx_0_574537474 = 0; idx_0_574537474 < SIZE; idx_0_574537474 = idx_0_574537474 + 1) begin: forLoop_idx_0_574537474
            alu_adder_rca_fa fa (
                .a(M_fa_a[idx_0_574537474]),
                .b(M_fa_b[idx_0_574537474]),
                .cin(M_fa_cin[idx_0_574537474]),
                .s(M_fa_s[idx_0_574537474]),
                .cout(M_fa_cout[idx_0_574537474])
            );
        end
    endgenerate
