...
module alu_adder_rca #(
    ...
    genvar idx_0_781396516;
    
    generate
        for (idx_0_781396516 = 0; idx_0_781396516 < SIZE; idx_0_781396516 = idx_0_781396516 + 1) begin: forLoop_idx_0_781396516
            alu_adder_rca_fa fa (
                .a(M_fa_a[idx_0_781396516]),
                .b(M_fa_b[idx_0_781396516]),
                .cin(M_fa_cin[idx_0_781396516]),
                .s(M_fa_s[idx_0_781396516]),
                .cout(M_fa_cout[idx_0_781396516])
            );
        end
    endgenerate
