...
module display_driver #(
    ...
    logic [6:0] D_sclk_counter_d, D_sclk_counter_q = 0;
                ...
                if (D_sclk_counter_q == 2'h2 && D_state_q == 2'h1) begin
                    ...
                    if (D_sclk_counter_q == 2'h3 && D_state_q == 2'h1) begin
                        ...
                        if (D_sclk_counter_q == 6'h3f && D_state_q == 2'h1) begin
                            ...
                            if (D_sclk_counter_q == 7'h7f && D_state_q == 2'h1 && D_pixel_idx_q[$clog2(MATRIX_WIDTH) - 1'h1:1'h0] == {$clog2(MATRIX_WIDTH){1'h1}}) begin
                                D_state_d = 2'h2;
                                D_latch_blank_d = 2'h3;
                                D_sclk_d = 1'h0;
                            end else begin
                                if (D_sclk_counter_q == 7'h7f && D_state_q == 2'h2) begin
