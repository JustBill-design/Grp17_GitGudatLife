...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_614389609 = DIGIT_BITS;
    localparam _MP_DIV_614389609 = DIV;
    localparam _MP_TOP_614389609 = DIGITS - 1'h1;
    localparam _MP_UP_614389609 = 1'h1;
    logic [(_MP_SIZE_614389609)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_614389609),
        .DIV(_MP_DIV_614389609),
        .TOP(_MP_TOP_614389609),
        .UP(_MP_UP_614389609)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_862535902 = 3'h4;
    localparam _MP_LEADING_ZEROS_862535902 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_862535902),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_862535902)
    ) decimal_renderer (
