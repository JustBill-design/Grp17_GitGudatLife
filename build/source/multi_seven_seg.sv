...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_576177143 = DIGIT_BITS;
    localparam _MP_DIV_576177143 = DIV;
    localparam _MP_TOP_576177143 = DIGITS - 1'h1;
    localparam _MP_UP_576177143 = 1'h1;
    logic [(_MP_SIZE_576177143)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_576177143),
        .DIV(_MP_DIV_576177143),
        .TOP(_MP_TOP_576177143),
        .UP(_MP_UP_576177143)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_129686878 = 3'h4;
    localparam _MP_LEADING_ZEROS_129686878 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_129686878),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_129686878)
    ) decimal_renderer (
