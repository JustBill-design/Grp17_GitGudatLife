...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_313530244 = DIGIT_BITS;
    localparam _MP_DIV_313530244 = DIV;
    localparam _MP_TOP_313530244 = DIGITS - 1'h1;
    localparam _MP_UP_313530244 = 1'h1;
    logic [(_MP_SIZE_313530244)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_313530244),
        .DIV(_MP_DIV_313530244),
        .TOP(_MP_TOP_313530244),
        .UP(_MP_UP_313530244)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1681032771 = 3'h4;
    localparam _MP_LEADING_ZEROS_1681032771 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1681032771),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1681032771)
    ) decimal_renderer (
