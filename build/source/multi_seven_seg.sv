...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_91429610 = DIGIT_BITS;
    localparam _MP_DIV_91429610 = DIV;
    localparam _MP_TOP_91429610 = DIGITS - 1'h1;
    localparam _MP_UP_91429610 = 1'h1;
    logic [(_MP_SIZE_91429610)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_91429610),
        .DIV(_MP_DIV_91429610),
        .TOP(_MP_TOP_91429610),
        .UP(_MP_UP_91429610)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1207090000 = 3'h4;
    localparam _MP_LEADING_ZEROS_1207090000 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1207090000),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1207090000)
    ) decimal_renderer (
