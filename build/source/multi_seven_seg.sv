...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_178245595 = DIGIT_BITS;
    localparam _MP_DIV_178245595 = DIV;
    localparam _MP_TOP_178245595 = DIGITS - 1'h1;
    localparam _MP_UP_178245595 = 1'h1;
    logic [(_MP_SIZE_178245595)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_178245595),
        .DIV(_MP_DIV_178245595),
        .TOP(_MP_TOP_178245595),
        .UP(_MP_UP_178245595)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_141990599 = 3'h4;
    localparam _MP_LEADING_ZEROS_141990599 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_141990599),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_141990599)
    ) decimal_renderer (
