...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_485186534 = DIGIT_BITS;
    localparam _MP_DIV_485186534 = DIV;
    localparam _MP_TOP_485186534 = DIGITS - 1'h1;
    localparam _MP_UP_485186534 = 1'h1;
    logic [(_MP_SIZE_485186534)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_485186534),
        .DIV(_MP_DIV_485186534),
        .TOP(_MP_TOP_485186534),
        .UP(_MP_UP_485186534)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1123325158 = 3'h4;
    localparam _MP_LEADING_ZEROS_1123325158 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1123325158),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1123325158)
    ) decimal_renderer (
