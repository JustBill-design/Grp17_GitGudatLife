...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_975104435 = DIGIT_BITS;
    localparam _MP_DIV_975104435 = DIV;
    localparam _MP_TOP_975104435 = DIGITS - 1'h1;
    localparam _MP_UP_975104435 = 1'h1;
    logic [(_MP_SIZE_975104435)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_975104435),
        .DIV(_MP_DIV_975104435),
        .TOP(_MP_TOP_975104435),
        .UP(_MP_UP_975104435)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1377322508 = 3'h4;
    localparam _MP_LEADING_ZEROS_1377322508 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1377322508),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1377322508)
    ) decimal_renderer (
