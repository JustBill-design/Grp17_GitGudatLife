...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_331740982 = DIGIT_BITS;
    localparam _MP_DIV_331740982 = DIV;
    localparam _MP_TOP_331740982 = DIGITS - 1'h1;
    localparam _MP_UP_331740982 = 1'h1;
    logic [(_MP_SIZE_331740982)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_331740982),
        .DIV(_MP_DIV_331740982),
        .TOP(_MP_TOP_331740982),
        .UP(_MP_UP_331740982)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1502917274 = 3'h4;
    localparam _MP_LEADING_ZEROS_1502917274 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1502917274),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1502917274)
    ) decimal_renderer (
