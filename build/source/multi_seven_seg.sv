...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_100986808 = DIGIT_BITS;
    localparam _MP_DIV_100986808 = DIV;
    localparam _MP_TOP_100986808 = DIGITS - 1'h1;
    localparam _MP_UP_100986808 = 1'h1;
    logic [(_MP_SIZE_100986808)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_100986808),
        .DIV(_MP_DIV_100986808),
        .TOP(_MP_TOP_100986808),
        .UP(_MP_UP_100986808)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_287032852 = 3'h4;
    localparam _MP_LEADING_ZEROS_287032852 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_287032852),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_287032852)
    ) decimal_renderer (
