...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_383743257 = DIGIT_BITS;
    localparam _MP_DIV_383743257 = DIV;
    localparam _MP_TOP_383743257 = DIGITS - 1'h1;
    localparam _MP_UP_383743257 = 1'h1;
    logic [(_MP_SIZE_383743257)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_383743257),
        .DIV(_MP_DIV_383743257),
        .TOP(_MP_TOP_383743257),
        .UP(_MP_UP_383743257)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1109409367 = 3'h4;
    localparam _MP_LEADING_ZEROS_1109409367 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1109409367),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1109409367)
    ) decimal_renderer (
