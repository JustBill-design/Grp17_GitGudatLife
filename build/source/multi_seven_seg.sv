...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_732007802 = DIGIT_BITS;
    localparam _MP_DIV_732007802 = DIV;
    localparam _MP_TOP_732007802 = DIGITS - 1'h1;
    localparam _MP_UP_732007802 = 1'h1;
    logic [(_MP_SIZE_732007802)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_732007802),
        .DIV(_MP_DIV_732007802),
        .TOP(_MP_TOP_732007802),
        .UP(_MP_UP_732007802)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1947420274 = 3'h4;
    localparam _MP_LEADING_ZEROS_1947420274 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1947420274),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1947420274)
    ) decimal_renderer (
