...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_453130186 = DIGIT_BITS;
    localparam _MP_DIV_453130186 = DIV;
    localparam _MP_TOP_453130186 = DIGITS - 1'h1;
    localparam _MP_UP_453130186 = 1'h1;
    logic [(_MP_SIZE_453130186)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_453130186),
        .DIV(_MP_DIV_453130186),
        .TOP(_MP_TOP_453130186),
        .UP(_MP_UP_453130186)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1389589639 = 3'h4;
    localparam _MP_LEADING_ZEROS_1389589639 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1389589639),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1389589639)
    ) decimal_renderer (
