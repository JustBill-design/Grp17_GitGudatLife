...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_251984893 = DIGIT_BITS;
    localparam _MP_DIV_251984893 = DIV;
    localparam _MP_TOP_251984893 = DIGITS - 1'h1;
    localparam _MP_UP_251984893 = 1'h1;
    logic [(_MP_SIZE_251984893)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_251984893),
        .DIV(_MP_DIV_251984893),
        .TOP(_MP_TOP_251984893),
        .UP(_MP_UP_251984893)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1936821314 = 3'h4;
    localparam _MP_LEADING_ZEROS_1936821314 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1936821314),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1936821314)
    ) decimal_renderer (
