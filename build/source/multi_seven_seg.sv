...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_376886311 = DIGIT_BITS;
    localparam _MP_DIV_376886311 = DIV;
    localparam _MP_TOP_376886311 = DIGITS - 1'h1;
    localparam _MP_UP_376886311 = 1'h1;
    logic [(_MP_SIZE_376886311)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_376886311),
        .DIV(_MP_DIV_376886311),
        .TOP(_MP_TOP_376886311),
        .UP(_MP_UP_376886311)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_656246271 = 3'h4;
    localparam _MP_LEADING_ZEROS_656246271 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_656246271),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_656246271)
    ) decimal_renderer (
