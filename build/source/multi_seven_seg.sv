...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_185699029 = DIGIT_BITS;
    localparam _MP_DIV_185699029 = DIV;
    localparam _MP_TOP_185699029 = DIGITS - 1'h1;
    localparam _MP_UP_185699029 = 1'h1;
    logic [(_MP_SIZE_185699029)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_185699029),
        .DIV(_MP_DIV_185699029),
        .TOP(_MP_TOP_185699029),
        .UP(_MP_UP_185699029)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_222927234 = 3'h4;
    localparam _MP_LEADING_ZEROS_222927234 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_222927234),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_222927234)
    ) decimal_renderer (
