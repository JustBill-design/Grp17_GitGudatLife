...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_505967611 = DIGIT_BITS;
    localparam _MP_DIV_505967611 = DIV;
    localparam _MP_TOP_505967611 = DIGITS - 1'h1;
    localparam _MP_UP_505967611 = 1'h1;
    logic [(_MP_SIZE_505967611)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_505967611),
        .DIV(_MP_DIV_505967611),
        .TOP(_MP_TOP_505967611),
        .UP(_MP_UP_505967611)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1459439843 = 3'h4;
    localparam _MP_LEADING_ZEROS_1459439843 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1459439843),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1459439843)
    ) decimal_renderer (
