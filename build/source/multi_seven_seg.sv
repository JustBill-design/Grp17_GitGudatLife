...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_127344128 = DIGIT_BITS;
    localparam _MP_DIV_127344128 = DIV;
    localparam _MP_TOP_127344128 = DIGITS - 1'h1;
    localparam _MP_UP_127344128 = 1'h1;
    logic [(_MP_SIZE_127344128)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_127344128),
        .DIV(_MP_DIV_127344128),
        .TOP(_MP_TOP_127344128),
        .UP(_MP_UP_127344128)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1371350726 = 3'h4;
    localparam _MP_LEADING_ZEROS_1371350726 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1371350726),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1371350726)
    ) decimal_renderer (
