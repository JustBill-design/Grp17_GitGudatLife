...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_598783846 = DIGIT_BITS;
    localparam _MP_DIV_598783846 = DIV;
    localparam _MP_TOP_598783846 = DIGITS - 1'h1;
    localparam _MP_UP_598783846 = 1'h1;
    logic [(_MP_SIZE_598783846)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_598783846),
        .DIV(_MP_DIV_598783846),
        .TOP(_MP_TOP_598783846),
        .UP(_MP_UP_598783846)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1621948852 = 3'h4;
    localparam _MP_LEADING_ZEROS_1621948852 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1621948852),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1621948852)
    ) decimal_renderer (
