...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_597995474 = DIGIT_BITS;
    localparam _MP_DIV_597995474 = DIV;
    localparam _MP_TOP_597995474 = DIGITS - 1'h1;
    localparam _MP_UP_597995474 = 1'h1;
    logic [(_MP_SIZE_597995474)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_597995474),
        .DIV(_MP_DIV_597995474),
        .TOP(_MP_TOP_597995474),
        .UP(_MP_UP_597995474)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_921611602 = 3'h4;
    localparam _MP_LEADING_ZEROS_921611602 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_921611602),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_921611602)
    ) decimal_renderer (
