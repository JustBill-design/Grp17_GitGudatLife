...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_620388068 = DIGIT_BITS;
    localparam _MP_DIV_620388068 = DIV;
    localparam _MP_TOP_620388068 = DIGITS - 1'h1;
    localparam _MP_UP_620388068 = 1'h1;
    logic [(_MP_SIZE_620388068)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_620388068),
        .DIV(_MP_DIV_620388068),
        .TOP(_MP_TOP_620388068),
        .UP(_MP_UP_620388068)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_387638834 = 3'h4;
    localparam _MP_LEADING_ZEROS_387638834 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_387638834),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_387638834)
    ) decimal_renderer (
