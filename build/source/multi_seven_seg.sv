...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_510267789 = DIGIT_BITS;
    localparam _MP_DIV_510267789 = DIV;
    localparam _MP_TOP_510267789 = DIGITS - 1'h1;
    localparam _MP_UP_510267789 = 1'h1;
    logic [(_MP_SIZE_510267789)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_510267789),
        .DIV(_MP_DIV_510267789),
        .TOP(_MP_TOP_510267789),
        .UP(_MP_UP_510267789)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_300435337 = 3'h4;
    localparam _MP_LEADING_ZEROS_300435337 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_300435337),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_300435337)
    ) decimal_renderer (
