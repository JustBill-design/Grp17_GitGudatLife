...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_27746621 = DIGIT_BITS;
    localparam _MP_DIV_27746621 = DIV;
    localparam _MP_TOP_27746621 = DIGITS - 1'h1;
    localparam _MP_UP_27746621 = 1'h1;
    logic [(_MP_SIZE_27746621)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_27746621),
        .DIV(_MP_DIV_27746621),
        .TOP(_MP_TOP_27746621),
        .UP(_MP_UP_27746621)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_736743027 = 3'h4;
    localparam _MP_LEADING_ZEROS_736743027 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_736743027),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_736743027)
    ) decimal_renderer (
