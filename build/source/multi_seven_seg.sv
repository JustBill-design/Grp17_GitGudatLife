...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_251353694 = DIGIT_BITS;
    localparam _MP_DIV_251353694 = DIV;
    localparam _MP_TOP_251353694 = DIGITS - 1'h1;
    localparam _MP_UP_251353694 = 1'h1;
    logic [(_MP_SIZE_251353694)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_251353694),
        .DIV(_MP_DIV_251353694),
        .TOP(_MP_TOP_251353694),
        .UP(_MP_UP_251353694)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1906958958 = 3'h4;
    localparam _MP_LEADING_ZEROS_1906958958 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1906958958),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1906958958)
    ) decimal_renderer (
