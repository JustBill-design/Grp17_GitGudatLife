...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_862278409 = DIGIT_BITS;
    localparam _MP_DIV_862278409 = DIV;
    localparam _MP_TOP_862278409 = DIGITS - 1'h1;
    localparam _MP_UP_862278409 = 1'h1;
    logic [(_MP_SIZE_862278409)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_862278409),
        .DIV(_MP_DIV_862278409),
        .TOP(_MP_TOP_862278409),
        .UP(_MP_UP_862278409)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_857448635 = 3'h4;
    localparam _MP_LEADING_ZEROS_857448635 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_857448635),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_857448635)
    ) decimal_renderer (
