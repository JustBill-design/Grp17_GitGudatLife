...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_298916926 = DIGIT_BITS;
    localparam _MP_DIV_298916926 = DIV;
    localparam _MP_TOP_298916926 = DIGITS - 1'h1;
    localparam _MP_UP_298916926 = 1'h1;
    logic [(_MP_SIZE_298916926)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_298916926),
        .DIV(_MP_DIV_298916926),
        .TOP(_MP_TOP_298916926),
        .UP(_MP_UP_298916926)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1636216580 = 3'h4;
    localparam _MP_LEADING_ZEROS_1636216580 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1636216580),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1636216580)
    ) decimal_renderer (
