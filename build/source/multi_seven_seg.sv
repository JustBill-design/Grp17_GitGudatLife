...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_108093426 = DIGIT_BITS;
    localparam _MP_DIV_108093426 = DIV;
    localparam _MP_TOP_108093426 = DIGITS - 1'h1;
    localparam _MP_UP_108093426 = 1'h1;
    logic [(_MP_SIZE_108093426)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_108093426),
        .DIV(_MP_DIV_108093426),
        .TOP(_MP_TOP_108093426),
        .UP(_MP_UP_108093426)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_506740720 = 3'h4;
    localparam _MP_LEADING_ZEROS_506740720 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_506740720),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_506740720)
    ) decimal_renderer (
