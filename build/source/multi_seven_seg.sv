...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_462361596 = DIGIT_BITS;
    localparam _MP_DIV_462361596 = DIV;
    localparam _MP_TOP_462361596 = DIGITS - 1'h1;
    localparam _MP_UP_462361596 = 1'h1;
    logic [(_MP_SIZE_462361596)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_462361596),
        .DIV(_MP_DIV_462361596),
        .TOP(_MP_TOP_462361596),
        .UP(_MP_UP_462361596)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1358484610 = 3'h4;
    localparam _MP_LEADING_ZEROS_1358484610 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1358484610),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1358484610)
    ) decimal_renderer (
