...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_537317501 = DIGIT_BITS;
    localparam _MP_DIV_537317501 = DIV;
    localparam _MP_TOP_537317501 = DIGITS - 1'h1;
    localparam _MP_UP_537317501 = 1'h1;
    logic [(_MP_SIZE_537317501)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_537317501),
        .DIV(_MP_DIV_537317501),
        .TOP(_MP_TOP_537317501),
        .UP(_MP_UP_537317501)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1976618972 = 3'h4;
    localparam _MP_LEADING_ZEROS_1976618972 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1976618972),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1976618972)
    ) decimal_renderer (
