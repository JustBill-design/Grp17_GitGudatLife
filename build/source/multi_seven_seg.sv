...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_860705871 = DIGIT_BITS;
    localparam _MP_DIV_860705871 = DIV;
    localparam _MP_TOP_860705871 = DIGITS - 1'h1;
    localparam _MP_UP_860705871 = 1'h1;
    logic [(_MP_SIZE_860705871)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_860705871),
        .DIV(_MP_DIV_860705871),
        .TOP(_MP_TOP_860705871),
        .UP(_MP_UP_860705871)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1052305190 = 3'h4;
    localparam _MP_LEADING_ZEROS_1052305190 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1052305190),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1052305190)
    ) decimal_renderer (
