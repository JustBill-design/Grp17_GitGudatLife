...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_783931129 = DIGIT_BITS;
    localparam _MP_DIV_783931129 = DIV;
    localparam _MP_TOP_783931129 = DIGITS - 1'h1;
    localparam _MP_UP_783931129 = 1'h1;
    logic [(_MP_SIZE_783931129)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_783931129),
        .DIV(_MP_DIV_783931129),
        .TOP(_MP_TOP_783931129),
        .UP(_MP_UP_783931129)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_526960647 = 3'h4;
    localparam _MP_LEADING_ZEROS_526960647 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_526960647),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_526960647)
    ) decimal_renderer (
