...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_834347939 = DIGIT_BITS;
    localparam _MP_DIV_834347939 = DIV;
    localparam _MP_TOP_834347939 = DIGITS - 1'h1;
    localparam _MP_UP_834347939 = 1'h1;
    logic [(_MP_SIZE_834347939)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_834347939),
        .DIV(_MP_DIV_834347939),
        .TOP(_MP_TOP_834347939),
        .UP(_MP_UP_834347939)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1482089978 = 3'h4;
    localparam _MP_LEADING_ZEROS_1482089978 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1482089978),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1482089978)
    ) decimal_renderer (
