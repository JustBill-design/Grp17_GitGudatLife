...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_552931707 = DIGIT_BITS;
    localparam _MP_DIV_552931707 = DIV;
    localparam _MP_TOP_552931707 = DIGITS - 1'h1;
    localparam _MP_UP_552931707 = 1'h1;
    logic [(_MP_SIZE_552931707)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_552931707),
        .DIV(_MP_DIV_552931707),
        .TOP(_MP_TOP_552931707),
        .UP(_MP_UP_552931707)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_157563450 = 3'h4;
    localparam _MP_LEADING_ZEROS_157563450 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_157563450),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_157563450)
    ) decimal_renderer (
