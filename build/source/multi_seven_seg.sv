...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_212317956 = DIGIT_BITS;
    localparam _MP_DIV_212317956 = DIV;
    localparam _MP_TOP_212317956 = DIGITS - 1'h1;
    localparam _MP_UP_212317956 = 1'h1;
    logic [(_MP_SIZE_212317956)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_212317956),
        .DIV(_MP_DIV_212317956),
        .TOP(_MP_TOP_212317956),
        .UP(_MP_UP_212317956)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1449445412 = 3'h4;
    localparam _MP_LEADING_ZEROS_1449445412 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1449445412),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1449445412)
    ) decimal_renderer (
