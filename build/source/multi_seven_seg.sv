...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_88166057 = DIGIT_BITS;
    localparam _MP_DIV_88166057 = DIV;
    localparam _MP_TOP_88166057 = DIGITS - 1'h1;
    localparam _MP_UP_88166057 = 1'h1;
    logic [(_MP_SIZE_88166057)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_88166057),
        .DIV(_MP_DIV_88166057),
        .TOP(_MP_TOP_88166057),
        .UP(_MP_UP_88166057)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_437506247 = 3'h4;
    localparam _MP_LEADING_ZEROS_437506247 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_437506247),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_437506247)
    ) decimal_renderer (
