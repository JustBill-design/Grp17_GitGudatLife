...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_743645181 = DIGIT_BITS;
    localparam _MP_DIV_743645181 = DIV;
    localparam _MP_TOP_743645181 = DIGITS - 1'h1;
    localparam _MP_UP_743645181 = 1'h1;
    logic [(_MP_SIZE_743645181)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_743645181),
        .DIV(_MP_DIV_743645181),
        .TOP(_MP_TOP_743645181),
        .UP(_MP_UP_743645181)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_250771778 = 3'h4;
    localparam _MP_LEADING_ZEROS_250771778 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_250771778),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_250771778)
    ) decimal_renderer (
