...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_800725282 = DIGIT_BITS;
    localparam _MP_DIV_800725282 = DIV;
    localparam _MP_TOP_800725282 = DIGITS - 1'h1;
    localparam _MP_UP_800725282 = 1'h1;
    logic [(_MP_SIZE_800725282)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_800725282),
        .DIV(_MP_DIV_800725282),
        .TOP(_MP_TOP_800725282),
        .UP(_MP_UP_800725282)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_715951434 = 3'h4;
    localparam _MP_LEADING_ZEROS_715951434 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_715951434),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_715951434)
    ) decimal_renderer (
