...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_205268979 = DIGIT_BITS;
    localparam _MP_DIV_205268979 = DIV;
    localparam _MP_TOP_205268979 = DIGITS - 1'h1;
    localparam _MP_UP_205268979 = 1'h1;
    logic [(_MP_SIZE_205268979)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_205268979),
        .DIV(_MP_DIV_205268979),
        .TOP(_MP_TOP_205268979),
        .UP(_MP_UP_205268979)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1462382954 = 3'h4;
    localparam _MP_LEADING_ZEROS_1462382954 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1462382954),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1462382954)
    ) decimal_renderer (
