...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_636240733 = DIGIT_BITS;
    localparam _MP_DIV_636240733 = DIV;
    localparam _MP_TOP_636240733 = DIGITS - 1'h1;
    localparam _MP_UP_636240733 = 1'h1;
    logic [(_MP_SIZE_636240733)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_636240733),
        .DIV(_MP_DIV_636240733),
        .TOP(_MP_TOP_636240733),
        .UP(_MP_UP_636240733)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_653108280 = 3'h4;
    localparam _MP_LEADING_ZEROS_653108280 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_653108280),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_653108280)
    ) decimal_renderer (
