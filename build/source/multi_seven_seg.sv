...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_405774829 = DIGIT_BITS;
    localparam _MP_DIV_405774829 = DIV;
    localparam _MP_TOP_405774829 = DIGITS - 1'h1;
    localparam _MP_UP_405774829 = 1'h1;
    logic [(_MP_SIZE_405774829)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_405774829),
        .DIV(_MP_DIV_405774829),
        .TOP(_MP_TOP_405774829),
        .UP(_MP_UP_405774829)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1496915012 = 3'h4;
    localparam _MP_LEADING_ZEROS_1496915012 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1496915012),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1496915012)
    ) decimal_renderer (
