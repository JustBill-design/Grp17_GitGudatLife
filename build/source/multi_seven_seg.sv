...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_477105307 = DIGIT_BITS;
    localparam _MP_DIV_477105307 = DIV;
    localparam _MP_TOP_477105307 = DIGITS - 1'h1;
    localparam _MP_UP_477105307 = 1'h1;
    logic [(_MP_SIZE_477105307)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_477105307),
        .DIV(_MP_DIV_477105307),
        .TOP(_MP_TOP_477105307),
        .UP(_MP_UP_477105307)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_218457632 = 3'h4;
    localparam _MP_LEADING_ZEROS_218457632 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_218457632),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_218457632)
    ) decimal_renderer (
