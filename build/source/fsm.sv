...
module fsm (
    ...
    localparam _MP_RISE_1047112416 = 1'h1;
    localparam _MP_FALL_1047112416 = 1'h0;
    logic M_accel_edge_in;
    logic M_accel_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1047112416),
        .FALL(_MP_FALL_1047112416)
    ) accel_edge (
        .clk(clk),
        .in(M_accel_edge_in),
    ...
    always @* begin
        ...
        case (D_states_q)
            ...
            8'h91: begin
                ...
                case ({rd1[2'h3:1'h0], rd2[2'h3:1'h0]})
                    8'h0: begin
                        D_states_d = 8'ha0;
                    end
                    8'h11: begin
