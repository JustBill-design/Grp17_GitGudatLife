...
module fsm (
    ...
    localparam _MP_RISE_1289401221 = 1'h1;
    localparam _MP_FALL_1289401221 = 1'h0;
    logic M_accel_edge_in;
    logic M_accel_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1289401221),
        .FALL(_MP_FALL_1289401221)
    ) accel_edge (
        .clk(clk),
        .in(M_accel_edge_in),
    ...
    logic [7:0] D_states_d, D_states_q = 8'ha5;
