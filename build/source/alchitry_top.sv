...
module alchitry_top (
    ...
    localparam _MP_SIZE_1526764257 = 6'h20;
    logic [31:0] M_alum_a;
    logic [31:0] M_alum_b;
    ...
    logic rst;
    logic fifo_rst;
    localparam _MP_STAGES_658362979 = 3'h4;
    logic M_reset_cond_in;
    logic M_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_658362979)
    ) reset_cond (
        .clk(clk),
        .in(M_reset_cond_in),
    ...
    localparam _MP_STAGES_515322746 = 3'h4;
    logic M_fifo_reset_cond_in;
    logic M_fifo_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_515322746)
    ) fifo_reset_cond (
        .clk(clk),
    ...
    localparam logic [3:0][23:0] _MP_CLK_FREQ_1058834669 = {{24'h895440, 24'h895440, 24'h895440, 24'h895440}};
    localparam _MP_MIN_DELAY_1058834669 = 5'h14;
    localparam _MP_NUM_SYNC_1058834669 = 2'h2;
    logic [3:0] M_cond_butt_dirs_in;
    logic [3:0] M_cond_butt_dirs_out;
    
    genvar idx_0_1058834669;
    
    generate
        for (idx_0_1058834669 = 0; idx_0_1058834669 < 4; idx_0_1058834669 = idx_0_1058834669 + 1) begin: forLoop_idx_0_1058834669
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_1058834669[idx_0_1058834669]),
                .MIN_DELAY(_MP_MIN_DELAY_1058834669),
                .NUM_SYNC(_MP_NUM_SYNC_1058834669)
            ) cond_butt_dirs (
                .clk(clk),
                .in(M_cond_butt_dirs_in[idx_0_1058834669]),
                .out(M_cond_butt_dirs_out[idx_0_1058834669])
            );
        end
    endgenerate
    
    
    localparam logic [1:0][23:0] _MP_CLK_FREQ_1578304138 = {{24'h895440, 24'h895440}};
    localparam _MP_MIN_DELAY_1578304138 = 5'h14;
    localparam _MP_NUM_SYNC_1578304138 = 2'h2;
    logic [1:0] M_cond_butt_sel_desel_in;
    logic [1:0] M_cond_butt_sel_desel_out;
    
    genvar idx_0_1578304138;
    
    generate
        for (idx_0_1578304138 = 0; idx_0_1578304138 < 2; idx_0_1578304138 = idx_0_1578304138 + 1) begin: forLoop_idx_0_1578304138
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_1578304138[idx_0_1578304138]),
                .MIN_DELAY(_MP_MIN_DELAY_1578304138),
                .NUM_SYNC(_MP_NUM_SYNC_1578304138)
            ) cond_butt_sel_desel (
                .clk(clk),
                .in(M_cond_butt_sel_desel_in[idx_0_1578304138]),
                .out(M_cond_butt_sel_desel_out[idx_0_1578304138])
            );
        end
    endgenerate
    
    
    localparam _MP_CLK_FREQ_1487178316 = 24'h895440;
    localparam _MP_MIN_DELAY_1487178316 = 5'h14;
    localparam _MP_NUM_SYNC_1487178316 = 2'h2;
    logic M_cond_butt_next_play_in;
    logic M_cond_butt_next_play_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_1487178316),
        .MIN_DELAY(_MP_MIN_DELAY_1487178316),
        .NUM_SYNC(_MP_NUM_SYNC_1487178316)
    ) cond_butt_next_play (
        .clk(clk),
    ...
    localparam _MP_CLK_FREQ_669394781 = 24'h895440;
    localparam _MP_MIN_DELAY_669394781 = 5'h14;
    localparam _MP_NUM_SYNC_669394781 = 2'h2;
    logic M_butt_cond_in;
    logic M_butt_cond_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_669394781),
        .MIN_DELAY(_MP_MIN_DELAY_669394781),
        .NUM_SYNC(_MP_NUM_SYNC_669394781)
    ) butt_cond (
        .clk(clk),
        .in(M_butt_cond_in),
        .out(M_butt_cond_out)
    ...
    localparam _MP_RISE_1131600603 = 1'h1;
    localparam _MP_FALL_1131600603 = 1'h0;
    logic M_edge_next_play_in;
    logic M_edge_next_play_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1131600603),
        .FALL(_MP_FALL_1131600603)
    ) edge_next_play (
        .clk(clk),
    ...
    localparam _MP_RISE_1605441385 = 1'h0;
    localparam _MP_FALL_1605441385 = 1'h1;
    logic M_timerclk_in;
    logic M_timerclk_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1605441385),
        .FALL(_MP_FALL_1605441385)
    ) timerclk (
        .clk(clk),
        .in(M_timerclk_in),
        .out(M_timerclk_out)
    ...
    localparam _MP_RISE_802630718 = 1'h1;
    localparam _MP_FALL_802630718 = 1'h0;
    logic M_gameclk_in;
    logic M_gameclk_out;
    
    edge_detector #(
        .RISE(_MP_RISE_802630718),
        .FALL(_MP_FALL_802630718)
    ) gameclk (
        .clk(clk),
        .in(M_gameclk_in),
        .out(M_gameclk_out)
    ...
    localparam _MP_ADDRESS_SIZE_1833654842 = 3'h5;
    localparam _MP_MATRIX_WIDTH_1833654842 = 7'h40;
    localparam _MP_CLK_FREQ_1833654842 = 24'h895440;
    ...
    display_driver #(
        .ADDRESS_SIZE(_MP_ADDRESS_SIZE_1833654842),
        .MATRIX_WIDTH(_MP_MATRIX_WIDTH_1833654842),
        .CLK_FREQ(_MP_CLK_FREQ_1833654842)
    ) display (
        .clk(clk),
        .rst(rst),
        .data(M_display_data),
    ...
    localparam _MP_SIZE_1226797283 = 5'h18;
    localparam _MP_DIV_1226797283 = 1'h0;
    localparam _MP_TOP_1226797283 = 24'h895440;
    localparam _MP_UP_1226797283 = 1'h1;
    logic [23:0] M_gamecounter_value;
    
    counter #(
        .SIZE(_MP_SIZE_1226797283),
        .DIV(_MP_DIV_1226797283),
        .TOP(_MP_TOP_1226797283),
        .UP(_MP_UP_1226797283)
    ) gamecounter (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_WIDTH_463864030 = 2'h2;
    localparam _MP_ENTRIES_463864030 = 13'h1080;
    ...
    bram #(
        .WIDTH(_MP_WIDTH_463864030),
        .ENTRIES(_MP_ENTRIES_463864030)
    ) brams (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_WIDTH_799714917 = 6'h20;
    localparam _MP_ENTRIES_799714917 = 4'h8;
    logic [2:0] M_reg_ra1;
    logic [2:0] M_reg_ra2;
    ...
    regfile #(
        .WIDTH(_MP_WIDTH_799714917),
        .ENTRIES(_MP_ENTRIES_799714917)
    ) L_reg (
        .clk(clk),
        .rst(rst),
        .ra1(M_reg_ra1),
    ...
    localparam _MP_DIGITS_246047647 = 3'h4;
    localparam _MP_DIV_246047647 = 5'h10;
    logic [13:0] M_aseg_driver_value;
    logic [11:0] M_aseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_246047647),
        .DIV(_MP_DIV_246047647)
    ) aseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_594182137 = 3'h4;
    localparam _MP_DIV_594182137 = 5'h10;
    logic [13:0] M_bseg_driver_value;
    logic [11:0] M_bseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_594182137),
        .DIV(_MP_DIV_594182137)
    ) bseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1790977809 = 3'h4;
    localparam _MP_DIV_1790977809 = 5'h10;
    logic [13:0] M_timerseg_driver_value;
    logic [11:0] M_timerseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_1790977809),
        .DIV(_MP_DIV_1790977809)
    ) timerseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_SIZE_2129828516 = 4'hd;
    localparam _MP_DIV_2129828516 = 1'h0;
    localparam _MP_TOP_2129828516 = 13'h107f;
    localparam _MP_UP_2129828516 = 1'h1;
    logic [12:0] M_bramtest_value;
    
    counter #(
        .SIZE(_MP_SIZE_2129828516),
        .DIV(_MP_DIV_2129828516),
        .TOP(_MP_TOP_2129828516),
        .UP(_MP_UP_2129828516)
    ) bramtest (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_WIDTH_1966493749 = 2'h2;
    localparam _MP_ENTRIES_1966493749 = 3'h4;
    logic [1:0] M_sr1_din;
    logic M_sr1_wput;
    logic M_sr1_full;
    ...
    fifo #(
        .WIDTH(_MP_WIDTH_1966493749),
        .ENTRIES(_MP_ENTRIES_1966493749)
    ) sr1 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr1_din),
    ...
    localparam _MP_WIDTH_1269477108 = 2'h2;
    localparam _MP_ENTRIES_1269477108 = 3'h4;
    logic [1:0] M_sr2_din;
    logic M_sr2_wput;
    logic M_sr2_full;
    ...
    fifo #(
        .WIDTH(_MP_WIDTH_1269477108),
        .ENTRIES(_MP_ENTRIES_1269477108)
    ) sr2 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr2_din),
    ...
    localparam _MP_WIDTH_789574827 = 2'h2;
    localparam _MP_ENTRIES_789574827 = 3'h4;
    logic [1:0] M_sr3_din;
    logic M_sr3_wput;
    logic M_sr3_full;
    ...
    fifo #(
        .WIDTH(_MP_WIDTH_789574827),
        .ENTRIES(_MP_ENTRIES_789574827)
    ) sr3 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr3_din),
    ...
    always @* begin
        ...
        if (M_display_reading) begin
            D_buff1_d = {M_display_addr[1'h0], M_butt_cond_out};
        end
