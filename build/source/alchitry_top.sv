...
module alchitry_top (
    ...
    localparam _MP_SIZE_1301676726 = 6'h20;
    logic [31:0] M_alum_a;
    logic [31:0] M_alum_b;
    ...
    logic rst;
    logic fifo_rst;
    localparam _MP_STAGES_1476355154 = 3'h4;
    logic M_reset_cond_in;
    logic M_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_1476355154)
    ) reset_cond (
        .clk(clk),
        .in(M_reset_cond_in),
    ...
    localparam _MP_STAGES_1132371941 = 3'h4;
    logic M_fifo_reset_cond_in;
    logic M_fifo_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_1132371941)
    ) fifo_reset_cond (
        .clk(clk),
    ...
    localparam logic [3:0][23:0] _MP_CLK_FREQ_1100997091 = {{24'h989680, 24'h989680, 24'h989680, 24'h989680}};
    localparam _MP_MIN_DELAY_1100997091 = 5'h14;
    localparam _MP_NUM_SYNC_1100997091 = 2'h2;
    logic [3:0] M_cond_butt_dirs_in;
    logic [3:0] M_cond_butt_dirs_out;
    
    genvar idx_0_1100997091;
    
    generate
        for (idx_0_1100997091 = 0; idx_0_1100997091 < 4; idx_0_1100997091 = idx_0_1100997091 + 1) begin: forLoop_idx_0_1100997091
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_1100997091[idx_0_1100997091]),
                .MIN_DELAY(_MP_MIN_DELAY_1100997091),
                .NUM_SYNC(_MP_NUM_SYNC_1100997091)
            ) cond_butt_dirs (
                .clk(clk),
                .in(M_cond_butt_dirs_in[idx_0_1100997091]),
                .out(M_cond_butt_dirs_out[idx_0_1100997091])
            );
        end
    endgenerate
    
    
    localparam logic [1:0][23:0] _MP_CLK_FREQ_915341047 = {{24'h989680, 24'h989680}};
    localparam _MP_MIN_DELAY_915341047 = 5'h14;
    localparam _MP_NUM_SYNC_915341047 = 2'h2;
    logic [1:0] M_cond_butt_sel_desel_in;
    logic [1:0] M_cond_butt_sel_desel_out;
    
    genvar idx_0_915341047;
    
    generate
        for (idx_0_915341047 = 0; idx_0_915341047 < 2; idx_0_915341047 = idx_0_915341047 + 1) begin: forLoop_idx_0_915341047
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_915341047[idx_0_915341047]),
                .MIN_DELAY(_MP_MIN_DELAY_915341047),
                .NUM_SYNC(_MP_NUM_SYNC_915341047)
            ) cond_butt_sel_desel (
                .clk(clk),
                .in(M_cond_butt_sel_desel_in[idx_0_915341047]),
                .out(M_cond_butt_sel_desel_out[idx_0_915341047])
            );
        end
    endgenerate
    
    
    localparam _MP_CLK_FREQ_1271995464 = 24'h989680;
    localparam _MP_MIN_DELAY_1271995464 = 5'h14;
    localparam _MP_NUM_SYNC_1271995464 = 2'h2;
    logic M_cond_butt_next_play_in;
    logic M_cond_butt_next_play_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_1271995464),
        .MIN_DELAY(_MP_MIN_DELAY_1271995464),
        .NUM_SYNC(_MP_NUM_SYNC_1271995464)
    ) cond_butt_next_play (
        .clk(clk),
    ...
    localparam _MP_CLK_FREQ_2013554966 = 24'h989680;
    localparam _MP_MIN_DELAY_2013554966 = 5'h14;
    localparam _MP_NUM_SYNC_2013554966 = 2'h2;
    logic M_butt_cond_in;
    logic M_butt_cond_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_2013554966),
        .MIN_DELAY(_MP_MIN_DELAY_2013554966),
        .NUM_SYNC(_MP_NUM_SYNC_2013554966)
    ) butt_cond (
        .clk(clk),
        .in(M_butt_cond_in),
        .out(M_butt_cond_out)
    ...
    localparam _MP_RISE_671218115 = 1'h1;
    localparam _MP_FALL_671218115 = 1'h0;
    logic M_edge_next_play_in;
    logic M_edge_next_play_out;
    
    edge_detector #(
        .RISE(_MP_RISE_671218115),
        .FALL(_MP_FALL_671218115)
    ) edge_next_play (
        .clk(clk),
    ...
    localparam _MP_RISE_336567584 = 1'h0;
    localparam _MP_FALL_336567584 = 1'h1;
    logic M_timerclk_in;
    logic M_timerclk_out;
    
    edge_detector #(
        .RISE(_MP_RISE_336567584),
        .FALL(_MP_FALL_336567584)
    ) timerclk (
        .clk(clk),
        .in(M_timerclk_in),
        .out(M_timerclk_out)
    ...
    localparam _MP_RISE_569968265 = 1'h1;
    localparam _MP_FALL_569968265 = 1'h0;
    logic M_gameclk_in;
    logic M_gameclk_out;
    
    edge_detector #(
        .RISE(_MP_RISE_569968265),
        .FALL(_MP_FALL_569968265)
    ) gameclk (
        .clk(clk),
        .in(M_gameclk_in),
        .out(M_gameclk_out)
    ...
    localparam _MP_RISE_477940802 = 1'h1;
    localparam _MP_FALL_477940802 = 1'h0;
    logic M_med_inputclk_in;
    logic M_med_inputclk_out;
    
    edge_detector #(
        .RISE(_MP_RISE_477940802),
        .FALL(_MP_FALL_477940802)
    ) med_inputclk (
        .clk(clk),
    ...
    localparam _MP_ADDRESS_SIZE_1567872138 = 3'h5;
    localparam _MP_MATRIX_WIDTH_1567872138 = 7'h40;
    localparam _MP_CLK_FREQ_1567872138 = 24'h989680;
    ...
    display_driver #(
        .ADDRESS_SIZE(_MP_ADDRESS_SIZE_1567872138),
        .MATRIX_WIDTH(_MP_MATRIX_WIDTH_1567872138),
        .CLK_FREQ(_MP_CLK_FREQ_1567872138)
    ) display (
        .clk(clk),
        .rst(rst),
        .data(M_display_data),
    ...
    localparam _MP_SIZE_1942159260 = 5'h18;
    localparam _MP_DIV_1942159260 = 1'h0;
    localparam _MP_TOP_1942159260 = 24'h989680;
    localparam _MP_UP_1942159260 = 1'h1;
    logic [23:0] M_gamecounter_value;
    
    counter #(
        .SIZE(_MP_SIZE_1942159260),
        .DIV(_MP_DIV_1942159260),
        .TOP(_MP_TOP_1942159260),
        .UP(_MP_UP_1942159260)
    ) gamecounter (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_WIDTH_605375377 = 2'h2;
    localparam _MP_ENTRIES_605375377 = 13'h1080;
    ...
    bram #(
        .WIDTH(_MP_WIDTH_605375377),
        .ENTRIES(_MP_ENTRIES_605375377)
    ) brams (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_WIDTH_347865120 = 6'h20;
    localparam _MP_ENTRIES_347865120 = 4'h8;
    logic [2:0] M_reg_ra1;
    logic [2:0] M_reg_ra2;
    ...
    regfile #(
        .WIDTH(_MP_WIDTH_347865120),
        .ENTRIES(_MP_ENTRIES_347865120)
    ) L_reg (
        .clk(clk),
        .rst(rst),
        .ra1(M_reg_ra1),
    ...
    localparam _MP_DIGITS_545352542 = 3'h4;
    localparam _MP_DIV_545352542 = 5'h10;
    logic [13:0] M_aseg_driver_value;
    logic [11:0] M_aseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_545352542),
        .DIV(_MP_DIV_545352542)
    ) aseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1428237881 = 3'h4;
    localparam _MP_DIV_1428237881 = 5'h10;
    logic [13:0] M_bseg_driver_value;
    logic [11:0] M_bseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_1428237881),
        .DIV(_MP_DIV_1428237881)
    ) bseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_224922590 = 3'h4;
    localparam _MP_DIV_224922590 = 5'h10;
    logic [13:0] M_timerseg_driver_value;
    logic [11:0] M_timerseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_224922590),
        .DIV(_MP_DIV_224922590)
    ) timerseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_SIZE_1737043159 = 4'hd;
    localparam _MP_DIV_1737043159 = 1'h0;
    localparam _MP_TOP_1737043159 = 13'h107f;
    localparam _MP_UP_1737043159 = 1'h1;
    logic [12:0] M_bramtest_value;
    
    counter #(
        .SIZE(_MP_SIZE_1737043159),
        .DIV(_MP_DIV_1737043159),
        .TOP(_MP_TOP_1737043159),
        .UP(_MP_UP_1737043159)
    ) bramtest (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_WIDTH_1617260672 = 2'h2;
    localparam _MP_ENTRIES_1617260672 = 3'h4;
    logic [1:0] M_sr1_din;
    logic M_sr1_wput;
    logic M_sr1_full;
    ...
    fifo #(
        .WIDTH(_MP_WIDTH_1617260672),
        .ENTRIES(_MP_ENTRIES_1617260672)
    ) sr1 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr1_din),
    ...
    localparam _MP_WIDTH_76830724 = 2'h2;
    localparam _MP_ENTRIES_76830724 = 3'h4;
    logic [1:0] M_sr2_din;
    logic M_sr2_wput;
    logic M_sr2_full;
    ...
    fifo #(
        .WIDTH(_MP_WIDTH_76830724),
        .ENTRIES(_MP_ENTRIES_76830724)
    ) sr2 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr2_din),
    ...
    localparam _MP_WIDTH_260113586 = 2'h2;
    localparam _MP_ENTRIES_260113586 = 3'h4;
    logic [1:0] M_sr3_din;
    logic M_sr3_wput;
    logic M_sr3_full;
    ...
    fifo #(
        .WIDTH(_MP_WIDTH_260113586),
        .ENTRIES(_MP_ENTRIES_260113586)
    ) sr3 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr3_din),
