...
module alchitry_top (
    ...
    localparam _MP_SIZE_1213186449 = 6'h20;
    logic [31:0] M_alum_a;
    logic [31:0] M_alum_b;
    ...
    logic rst;
    logic fifo_rst;
    localparam _MP_STAGES_1112861653 = 3'h4;
    logic M_reset_cond_in;
    logic M_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_1112861653)
    ) reset_cond (
        .clk(clk),
        .in(M_reset_cond_in),
    ...
    localparam _MP_STAGES_1215600748 = 3'h4;
    logic M_fifo_reset_cond_in;
    logic M_fifo_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_1215600748)
    ) fifo_reset_cond (
        .clk(clk),
    ...
    localparam logic [3:0][23:0] _MP_CLK_FREQ_957141115 = {{24'h895440, 24'h895440, 24'h895440, 24'h895440}};
    localparam _MP_MIN_DELAY_957141115 = 5'h14;
    localparam _MP_NUM_SYNC_957141115 = 2'h2;
    logic [3:0] M_cond_butt_dirs_in;
    logic [3:0] M_cond_butt_dirs_out;
    
    genvar idx_0_957141115;
    
    generate
        for (idx_0_957141115 = 0; idx_0_957141115 < 4; idx_0_957141115 = idx_0_957141115 + 1) begin: forLoop_idx_0_957141115
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_957141115[idx_0_957141115]),
                .MIN_DELAY(_MP_MIN_DELAY_957141115),
                .NUM_SYNC(_MP_NUM_SYNC_957141115)
            ) cond_butt_dirs (
                .clk(clk),
                .in(M_cond_butt_dirs_in[idx_0_957141115]),
                .out(M_cond_butt_dirs_out[idx_0_957141115])
            );
        end
    endgenerate
    
    
    localparam logic [1:0][23:0] _MP_CLK_FREQ_1670915499 = {{24'h895440, 24'h895440}};
    localparam _MP_MIN_DELAY_1670915499 = 5'h14;
    localparam _MP_NUM_SYNC_1670915499 = 2'h2;
    logic [1:0] M_cond_butt_sel_desel_in;
    logic [1:0] M_cond_butt_sel_desel_out;
    
    genvar idx_0_1670915499;
    
    generate
        for (idx_0_1670915499 = 0; idx_0_1670915499 < 2; idx_0_1670915499 = idx_0_1670915499 + 1) begin: forLoop_idx_0_1670915499
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_1670915499[idx_0_1670915499]),
                .MIN_DELAY(_MP_MIN_DELAY_1670915499),
                .NUM_SYNC(_MP_NUM_SYNC_1670915499)
            ) cond_butt_sel_desel (
                .clk(clk),
                .in(M_cond_butt_sel_desel_in[idx_0_1670915499]),
                .out(M_cond_butt_sel_desel_out[idx_0_1670915499])
            );
        end
    endgenerate
    
    
    localparam _MP_CLK_FREQ_1926760792 = 24'h895440;
    localparam _MP_MIN_DELAY_1926760792 = 5'h14;
    localparam _MP_NUM_SYNC_1926760792 = 2'h2;
    logic M_cond_butt_next_play_in;
    logic M_cond_butt_next_play_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_1926760792),
        .MIN_DELAY(_MP_MIN_DELAY_1926760792),
        .NUM_SYNC(_MP_NUM_SYNC_1926760792)
    ) cond_butt_next_play (
        .clk(clk),
    ...
    localparam _MP_CLK_FREQ_592263397 = 24'h895440;
    localparam _MP_MIN_DELAY_592263397 = 5'h14;
    localparam _MP_NUM_SYNC_592263397 = 2'h2;
    logic M_butt_cond_in;
    logic M_butt_cond_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_592263397),
        .MIN_DELAY(_MP_MIN_DELAY_592263397),
        .NUM_SYNC(_MP_NUM_SYNC_592263397)
    ) butt_cond (
        .clk(clk),
        .in(M_butt_cond_in),
        .out(M_butt_cond_out)
    ...
    localparam _MP_RISE_517509744 = 1'h1;
    localparam _MP_FALL_517509744 = 1'h0;
    logic M_edge_next_play_in;
    logic M_edge_next_play_out;
    
    edge_detector #(
        .RISE(_MP_RISE_517509744),
        .FALL(_MP_FALL_517509744)
    ) edge_next_play (
        .clk(clk),
    ...
    localparam _MP_RISE_102510599 = 1'h0;
    localparam _MP_FALL_102510599 = 1'h1;
    logic M_timerclk_in;
    logic M_timerclk_out;
    
    edge_detector #(
        .RISE(_MP_RISE_102510599),
        .FALL(_MP_FALL_102510599)
    ) timerclk (
        .clk(clk),
        .in(M_timerclk_in),
        .out(M_timerclk_out)
    ...
    localparam _MP_RISE_732068805 = 1'h1;
    localparam _MP_FALL_732068805 = 1'h0;
    logic M_gameclk_in;
    logic M_gameclk_out;
    
    edge_detector #(
        .RISE(_MP_RISE_732068805),
        .FALL(_MP_FALL_732068805)
    ) gameclk (
        .clk(clk),
        .in(M_gameclk_in),
        .out(M_gameclk_out)
    ...
    localparam _MP_ADDRESS_SIZE_1190018239 = 3'h5;
    localparam _MP_MATRIX_WIDTH_1190018239 = 7'h40;
    localparam _MP_CLK_FREQ_1190018239 = 24'h895440;
    ...
    display_driver #(
        .ADDRESS_SIZE(_MP_ADDRESS_SIZE_1190018239),
        .MATRIX_WIDTH(_MP_MATRIX_WIDTH_1190018239),
        .CLK_FREQ(_MP_CLK_FREQ_1190018239)
    ) display (
        .clk(clk),
        .rst(rst),
        .data(M_display_data),
    ...
    localparam _MP_SIZE_989047885 = 5'h18;
    localparam _MP_DIV_989047885 = 1'h0;
    localparam _MP_TOP_989047885 = 24'h895440;
    localparam _MP_UP_989047885 = 1'h1;
    logic [23:0] M_gamecounter_value;
    
    counter #(
        .SIZE(_MP_SIZE_989047885),
        .DIV(_MP_DIV_989047885),
        .TOP(_MP_TOP_989047885),
        .UP(_MP_UP_989047885)
    ) gamecounter (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_WIDTH_1899243801 = 2'h2;
    localparam _MP_ENTRIES_1899243801 = 13'h1080;
    ...
    bram #(
        .WIDTH(_MP_WIDTH_1899243801),
        .ENTRIES(_MP_ENTRIES_1899243801)
    ) brams (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_WIDTH_543455433 = 6'h20;
    localparam _MP_ENTRIES_543455433 = 4'h8;
    logic [2:0] M_reg_ra1;
    logic [2:0] M_reg_ra2;
    ...
    regfile #(
        .WIDTH(_MP_WIDTH_543455433),
        .ENTRIES(_MP_ENTRIES_543455433)
    ) L_reg (
        .clk(clk),
        .rst(rst),
        .ra1(M_reg_ra1),
    ...
    localparam _MP_DIGITS_618414737 = 3'h4;
    localparam _MP_DIV_618414737 = 5'h10;
    logic [13:0] M_aseg_driver_value;
    logic [11:0] M_aseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_618414737),
        .DIV(_MP_DIV_618414737)
    ) aseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1545818639 = 3'h4;
    localparam _MP_DIV_1545818639 = 5'h10;
    logic [13:0] M_bseg_driver_value;
    logic [11:0] M_bseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_1545818639),
        .DIV(_MP_DIV_1545818639)
    ) bseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1864824212 = 3'h4;
    localparam _MP_DIV_1864824212 = 5'h10;
    logic [13:0] M_timerseg_driver_value;
    logic [11:0] M_timerseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_1864824212),
        .DIV(_MP_DIV_1864824212)
    ) timerseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_WIDTH_1957603270 = 2'h2;
    localparam _MP_ENTRIES_1957603270 = 3'h4;
    logic [1:0] M_sr1_din;
    logic M_sr1_wput;
    logic M_sr1_full;
    ...
    fifo #(
        .WIDTH(_MP_WIDTH_1957603270),
        .ENTRIES(_MP_ENTRIES_1957603270)
    ) sr1 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr1_din),
    ...
    localparam _MP_WIDTH_1553680992 = 2'h2;
    localparam _MP_ENTRIES_1553680992 = 3'h4;
    logic [1:0] M_sr2_din;
    logic M_sr2_wput;
    logic M_sr2_full;
    ...
    fifo #(
        .WIDTH(_MP_WIDTH_1553680992),
        .ENTRIES(_MP_ENTRIES_1553680992)
    ) sr2 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr2_din),
    ...
    localparam _MP_WIDTH_1296541731 = 2'h2;
    localparam _MP_ENTRIES_1296541731 = 3'h4;
    logic [1:0] M_sr3_din;
    logic M_sr3_wput;
    logic M_sr3_full;
    ...
    fifo #(
        .WIDTH(_MP_WIDTH_1296541731),
        .ENTRIES(_MP_ENTRIES_1296541731)
    ) sr3 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr3_din),
