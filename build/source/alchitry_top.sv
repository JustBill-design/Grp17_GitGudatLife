...
module alchitry_top (
    ...
    localparam _MP_SIZE_1323168124 = 4'hd;
    logic [12:0] M_alum_a;
    logic [12:0] M_alum_b;
    ...
    logic rst;
    logic fifo_rst;
    localparam _MP_STAGES_2049061052 = 3'h4;
    logic M_reset_cond_in;
    logic M_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_2049061052)
    ) reset_cond (
        .clk(clk),
        .in(M_reset_cond_in),
    ...
    localparam _MP_STAGES_1156214441 = 3'h4;
    logic M_fifo_reset_cond_in;
    logic M_fifo_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_1156214441)
    ) fifo_reset_cond (
        .clk(clk),
    ...
    localparam logic [3:0][26:0] _MP_CLK_FREQ_1528691912 = {{27'h5f5e100, 27'h5f5e100, 27'h5f5e100, 27'h5f5e100}};
    localparam logic [3:0][7:0] _MP_MIN_DELAY_1528691912 = {{8'hc8, 8'hc8, 8'hc8, 8'hc8}};
    localparam logic [3:0][4:0] _MP_NUM_SYNC_1528691912 = {{5'h1e, 5'h1e, 5'h1e, 5'h1e}};
    logic [3:0] M_cond_butt_dirs_in;
    logic [3:0] M_cond_butt_dirs_out;
    
    genvar idx_0_1528691912;
    
    generate
        for (idx_0_1528691912 = 0; idx_0_1528691912 < 4; idx_0_1528691912 = idx_0_1528691912 + 1) begin: forLoop_idx_0_1528691912
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_1528691912[idx_0_1528691912]),
                .MIN_DELAY(_MP_MIN_DELAY_1528691912[idx_0_1528691912]),
                .NUM_SYNC(_MP_NUM_SYNC_1528691912[idx_0_1528691912])
            ) cond_butt_dirs (
                .clk(clk),
                .in(M_cond_butt_dirs_in[idx_0_1528691912]),
                .out(M_cond_butt_dirs_out[idx_0_1528691912])
            );
        end
    endgenerate
    
    
    localparam logic [1:0][26:0] _MP_CLK_FREQ_173451474 = {{27'h5f5e100, 27'h5f5e100}};
    localparam logic [1:0][7:0] _MP_MIN_DELAY_173451474 = {{8'hc8, 8'hc8}};
    localparam logic [1:0][4:0] _MP_NUM_SYNC_173451474 = {{5'h1e, 5'h1e}};
    logic [1:0] M_cond_butt_sel_desel_in;
    logic [1:0] M_cond_butt_sel_desel_out;
    
    genvar idx_0_173451474;
    
    generate
        for (idx_0_173451474 = 0; idx_0_173451474 < 2; idx_0_173451474 = idx_0_173451474 + 1) begin: forLoop_idx_0_173451474
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_173451474[idx_0_173451474]),
                .MIN_DELAY(_MP_MIN_DELAY_173451474[idx_0_173451474]),
                .NUM_SYNC(_MP_NUM_SYNC_173451474[idx_0_173451474])
            ) cond_butt_sel_desel (
                .clk(clk),
                .in(M_cond_butt_sel_desel_in[idx_0_173451474]),
                .out(M_cond_butt_sel_desel_out[idx_0_173451474])
            );
        end
    endgenerate
    
    
    localparam _MP_CLK_FREQ_1237262154 = 27'h5f5e100;
    localparam _MP_MIN_DELAY_1237262154 = 8'hc8;
    localparam _MP_NUM_SYNC_1237262154 = 5'h1e;
    logic M_cond_butt_next_play_in;
    logic M_cond_butt_next_play_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_1237262154),
        .MIN_DELAY(_MP_MIN_DELAY_1237262154),
        .NUM_SYNC(_MP_NUM_SYNC_1237262154)
    ) cond_butt_next_play (
        .clk(clk),
    ...
    localparam _MP_RISE_1053331097 = 1'h1;
    localparam _MP_FALL_1053331097 = 1'h0;
    logic M_edge_next_play_in;
    logic M_edge_next_play_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1053331097),
        .FALL(_MP_FALL_1053331097)
    ) edge_next_play (
        .clk(clk),
    ...
    localparam _MP_RISE_2038979410 = 1'h1;
    localparam _MP_FALL_2038979410 = 1'h0;
    logic M_timerclk_in;
    logic M_timerclk_out;
    
    edge_detector #(
        .RISE(_MP_RISE_2038979410),
        .FALL(_MP_FALL_2038979410)
    ) timerclk (
        .clk(clk),
        .in(M_timerclk_in),
        .out(M_timerclk_out)
    ...
    localparam _MP_RISE_1589585887 = 1'h1;
    localparam _MP_FALL_1589585887 = 1'h0;
    logic M_gameclk_in;
    logic M_gameclk_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1589585887),
        .FALL(_MP_FALL_1589585887)
    ) gameclk (
        .clk(clk),
        .in(M_gameclk_in),
        .out(M_gameclk_out)
    ...
    localparam _MP_RISE_360577164 = 1'h1;
    localparam _MP_FALL_360577164 = 1'h0;
    logic M_med_inputclk_in;
    logic M_med_inputclk_out;
    
    edge_detector #(
        .RISE(_MP_RISE_360577164),
        .FALL(_MP_FALL_360577164)
    ) med_inputclk (
        .clk(clk),
    ...
    localparam _MP_RISE_1025172206 = 1'h1;
    localparam _MP_FALL_1025172206 = 1'h0;
    logic M_edge_up_in;
    logic M_edge_up_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1025172206),
        .FALL(_MP_FALL_1025172206)
    ) edge_up (
        .clk(clk),
        .in(M_edge_up_in),
        .out(M_edge_up_out)
    ...
    localparam _MP_SIZE_337825703 = 3'h4;
    localparam _MP_DIV_337825703 = 1'h0;
    localparam _MP_TOP_337825703 = 4'ha;
    localparam _MP_UP_337825703 = 1'h1;
    logic [3:0] M_slow_counter_value;
    
    counter #(
        .SIZE(_MP_SIZE_337825703),
        .DIV(_MP_DIV_337825703),
        .TOP(_MP_TOP_337825703),
        .UP(_MP_UP_337825703)
    ) slow_counter (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_ADDRESS_SIZE_619896486 = 3'h5;
    localparam _MP_MATRIX_WIDTH_619896486 = 7'h40;
    localparam _MP_CLK_FREQ_619896486 = 27'h5f5e100;
    ...
    display_driver #(
        .ADDRESS_SIZE(_MP_ADDRESS_SIZE_619896486),
        .MATRIX_WIDTH(_MP_MATRIX_WIDTH_619896486),
        .CLK_FREQ(_MP_CLK_FREQ_619896486)
    ) display (
        .clk(clk),
        .rst(rst),
        .data(M_display_data),
    ...
    localparam _MP_SIZE_465083038 = 5'h1b;
    localparam _MP_DIV_465083038 = 1'h0;
    localparam _MP_TOP_465083038 = 27'h5f5e100;
    localparam _MP_UP_465083038 = 1'h1;
    logic [26:0] M_gamecounter_value;
    
    counter #(
        .SIZE(_MP_SIZE_465083038),
        .DIV(_MP_DIV_465083038),
        .TOP(_MP_TOP_465083038),
        .UP(_MP_UP_465083038)
    ) gamecounter (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_WIDTH_2062431821 = 2'h2;
    localparam _MP_ENTRIES_2062431821 = 13'h1080;
    ...
    bram #(
        .WIDTH(_MP_WIDTH_2062431821),
        .ENTRIES(_MP_ENTRIES_2062431821)
    ) brams (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_WIDTH_1105112324 = 4'hd;
    localparam _MP_ENTRIES_1105112324 = 4'h8;
    logic [2:0] M_reg_ra1;
    logic [2:0] M_reg_ra2;
    ...
    regfile #(
        .WIDTH(_MP_WIDTH_1105112324),
        .ENTRIES(_MP_ENTRIES_1105112324)
    ) L_reg (
        .clk(clk),
        .rst(rst),
        .ra1(M_reg_ra1),
    ...
    localparam _MP_DIGITS_254244612 = 3'h4;
    localparam _MP_DIV_254244612 = 5'h10;
    logic [13:0] M_aseg_driver_value;
    logic [11:0] M_aseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_254244612),
        .DIV(_MP_DIV_254244612)
    ) aseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_258992164 = 3'h4;
    localparam _MP_DIV_258992164 = 5'h10;
    logic [13:0] M_bseg_driver_value;
    logic [11:0] M_bseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_258992164),
        .DIV(_MP_DIV_258992164)
    ) bseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1914966072 = 3'h4;
    localparam _MP_DIV_1914966072 = 5'h10;
    logic [13:0] M_timerseg_driver_value;
    logic [11:0] M_timerseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_1914966072),
        .DIV(_MP_DIV_1914966072)
    ) timerseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_WIDTH_106033295 = 2'h2;
    localparam _MP_ENTRIES_106033295 = 3'h4;
    logic [1:0] M_sr1_din;
    logic M_sr1_wput;
    logic M_sr1_full;
    ...
    fifo #(
        .WIDTH(_MP_WIDTH_106033295),
        .ENTRIES(_MP_ENTRIES_106033295)
    ) sr1 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr1_din),
    ...
    localparam _MP_WIDTH_1825426907 = 2'h2;
    localparam _MP_ENTRIES_1825426907 = 3'h4;
    logic [1:0] M_sr2_din;
    logic M_sr2_wput;
    logic M_sr2_full;
    ...
    fifo #(
        .WIDTH(_MP_WIDTH_1825426907),
        .ENTRIES(_MP_ENTRIES_1825426907)
    ) sr2 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr2_din),
    ...
    localparam _MP_WIDTH_1694313753 = 2'h2;
    localparam _MP_ENTRIES_1694313753 = 3'h4;
    logic [1:0] M_sr3_din;
    logic M_sr3_wput;
    logic M_sr3_full;
    ...
    fifo #(
        .WIDTH(_MP_WIDTH_1694313753),
        .ENTRIES(_MP_ENTRIES_1694313753)
    ) sr3 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr3_din),
