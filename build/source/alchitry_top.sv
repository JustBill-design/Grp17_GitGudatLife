...
module alchitry_top (
    ...
    localparam _MP_SIZE_1044049041 = 4'hd;
    logic [12:0] M_alum_a;
    logic [12:0] M_alum_b;
    ...
    logic rst;
    logic fifo_rst;
    localparam _MP_STAGES_972518129 = 3'h4;
    logic M_reset_cond_in;
    logic M_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_972518129)
    ) reset_cond (
        .clk(clk),
        .in(M_reset_cond_in),
    ...
    localparam _MP_STAGES_1736010875 = 3'h4;
    logic M_fifo_reset_cond_in;
    logic M_fifo_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_1736010875)
    ) fifo_reset_cond (
        .clk(clk),
    ...
    localparam logic [3:0][26:0] _MP_CLK_FREQ_983692089 = {{27'h5f5e100, 27'h5f5e100, 27'h5f5e100, 27'h5f5e100}};
    localparam logic [3:0][7:0] _MP_MIN_DELAY_983692089 = {{8'hc8, 8'hc8, 8'hc8, 8'hc8}};
    localparam logic [3:0][4:0] _MP_NUM_SYNC_983692089 = {{5'h1e, 5'h1e, 5'h1e, 5'h1e}};
    logic [3:0] M_cond_butt_dirs_in;
    logic [3:0] M_cond_butt_dirs_out;
    
    genvar idx_0_983692089;
    
    generate
        for (idx_0_983692089 = 0; idx_0_983692089 < 4; idx_0_983692089 = idx_0_983692089 + 1) begin: forLoop_idx_0_983692089
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_983692089[idx_0_983692089]),
                .MIN_DELAY(_MP_MIN_DELAY_983692089[idx_0_983692089]),
                .NUM_SYNC(_MP_NUM_SYNC_983692089[idx_0_983692089])
            ) cond_butt_dirs (
                .clk(clk),
                .in(M_cond_butt_dirs_in[idx_0_983692089]),
                .out(M_cond_butt_dirs_out[idx_0_983692089])
            );
        end
    endgenerate
    
    
    localparam logic [1:0][26:0] _MP_CLK_FREQ_1986057360 = {{27'h5f5e100, 27'h5f5e100}};
    localparam logic [1:0][7:0] _MP_MIN_DELAY_1986057360 = {{8'hc8, 8'hc8}};
    localparam logic [1:0][4:0] _MP_NUM_SYNC_1986057360 = {{5'h1e, 5'h1e}};
    logic [1:0] M_cond_butt_sel_desel_in;
    logic [1:0] M_cond_butt_sel_desel_out;
    
    genvar idx_0_1986057360;
    
    generate
        for (idx_0_1986057360 = 0; idx_0_1986057360 < 2; idx_0_1986057360 = idx_0_1986057360 + 1) begin: forLoop_idx_0_1986057360
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_1986057360[idx_0_1986057360]),
                .MIN_DELAY(_MP_MIN_DELAY_1986057360[idx_0_1986057360]),
                .NUM_SYNC(_MP_NUM_SYNC_1986057360[idx_0_1986057360])
            ) cond_butt_sel_desel (
                .clk(clk),
                .in(M_cond_butt_sel_desel_in[idx_0_1986057360]),
                .out(M_cond_butt_sel_desel_out[idx_0_1986057360])
            );
        end
    endgenerate
    
    
    localparam _MP_CLK_FREQ_2055451637 = 27'h5f5e100;
    localparam _MP_MIN_DELAY_2055451637 = 8'hc8;
    localparam _MP_NUM_SYNC_2055451637 = 5'h1e;
    logic M_cond_butt_next_play_in;
    logic M_cond_butt_next_play_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_2055451637),
        .MIN_DELAY(_MP_MIN_DELAY_2055451637),
        .NUM_SYNC(_MP_NUM_SYNC_2055451637)
    ) cond_butt_next_play (
        .clk(clk),
    ...
    localparam _MP_RISE_24057977 = 1'h1;
    localparam _MP_FALL_24057977 = 1'h0;
    logic M_edge_next_play_in;
    logic M_edge_next_play_out;
    
    edge_detector #(
        .RISE(_MP_RISE_24057977),
        .FALL(_MP_FALL_24057977)
    ) edge_next_play (
        .clk(clk),
    ...
    localparam _MP_RISE_917828747 = 1'h1;
    localparam _MP_FALL_917828747 = 1'h0;
    logic M_timerclk_in;
    logic M_timerclk_out;
    
    edge_detector #(
        .RISE(_MP_RISE_917828747),
        .FALL(_MP_FALL_917828747)
    ) timerclk (
        .clk(clk),
        .in(M_timerclk_in),
        .out(M_timerclk_out)
    ...
    localparam _MP_RISE_1739141670 = 1'h1;
    localparam _MP_FALL_1739141670 = 1'h0;
    logic M_gameclk_in;
    logic M_gameclk_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1739141670),
        .FALL(_MP_FALL_1739141670)
    ) gameclk (
        .clk(clk),
        .in(M_gameclk_in),
        .out(M_gameclk_out)
    ...
    localparam _MP_RISE_1633092531 = 1'h1;
    localparam _MP_FALL_1633092531 = 1'h0;
    logic M_med_inputclk_in;
    logic M_med_inputclk_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1633092531),
        .FALL(_MP_FALL_1633092531)
    ) med_inputclk (
        .clk(clk),
    ...
    localparam _MP_RISE_405287827 = 1'h1;
    localparam _MP_FALL_405287827 = 1'h0;
    logic M_edge_up_in;
    logic M_edge_up_out;
    
    edge_detector #(
        .RISE(_MP_RISE_405287827),
        .FALL(_MP_FALL_405287827)
    ) edge_up (
        .clk(clk),
        .in(M_edge_up_in),
        .out(M_edge_up_out)
    ...
    localparam _MP_SIZE_1947831708 = 3'h4;
    localparam _MP_DIV_1947831708 = 1'h0;
    localparam _MP_TOP_1947831708 = 4'ha;
    localparam _MP_UP_1947831708 = 1'h1;
    logic [3:0] M_slow_counter_value;
    
    counter #(
        .SIZE(_MP_SIZE_1947831708),
        .DIV(_MP_DIV_1947831708),
        .TOP(_MP_TOP_1947831708),
        .UP(_MP_UP_1947831708)
    ) slow_counter (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_ADDRESS_SIZE_1693709377 = 3'h5;
    localparam _MP_MATRIX_WIDTH_1693709377 = 7'h40;
    localparam _MP_CLK_FREQ_1693709377 = 27'h5f5e100;
    ...
    display_driver #(
        .ADDRESS_SIZE(_MP_ADDRESS_SIZE_1693709377),
        .MATRIX_WIDTH(_MP_MATRIX_WIDTH_1693709377),
        .CLK_FREQ(_MP_CLK_FREQ_1693709377)
    ) display (
        .clk(clk),
        .rst(rst),
        .data(M_display_data),
    ...
    localparam _MP_SIZE_1531707593 = 5'h1b;
    localparam _MP_DIV_1531707593 = 1'h0;
    localparam _MP_TOP_1531707593 = 27'h5f5e100;
    localparam _MP_UP_1531707593 = 1'h1;
    logic [26:0] M_gamecounter_value;
    
    counter #(
        .SIZE(_MP_SIZE_1531707593),
        .DIV(_MP_DIV_1531707593),
        .TOP(_MP_TOP_1531707593),
        .UP(_MP_UP_1531707593)
    ) gamecounter (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_WIDTH_1490548103 = 2'h2;
    localparam _MP_ENTRIES_1490548103 = 13'h1080;
    ...
    bram #(
        .WIDTH(_MP_WIDTH_1490548103),
        .ENTRIES(_MP_ENTRIES_1490548103)
    ) brams (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_WIDTH_235349463 = 4'hd;
    localparam _MP_ENTRIES_235349463 = 4'h8;
    logic [2:0] M_reg_ra1;
    logic [2:0] M_reg_ra2;
    ...
    regfile #(
        .WIDTH(_MP_WIDTH_235349463),
        .ENTRIES(_MP_ENTRIES_235349463)
    ) L_reg (
        .clk(clk),
        .rst(rst),
        .ra1(M_reg_ra1),
    ...
    localparam _MP_DIGITS_806751984 = 3'h4;
    localparam _MP_DIV_806751984 = 5'h10;
    logic [13:0] M_aseg_driver_value;
    logic [11:0] M_aseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_806751984),
        .DIV(_MP_DIV_806751984)
    ) aseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_296167408 = 3'h4;
    localparam _MP_DIV_296167408 = 5'h10;
    logic [13:0] M_bseg_driver_value;
    logic [11:0] M_bseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_296167408),
        .DIV(_MP_DIV_296167408)
    ) bseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1397447300 = 3'h4;
    localparam _MP_DIV_1397447300 = 5'h10;
    logic [13:0] M_timerseg_driver_value;
    logic [11:0] M_timerseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_1397447300),
        .DIV(_MP_DIV_1397447300)
    ) timerseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_WIDTH_543237889 = 2'h2;
    localparam _MP_ENTRIES_543237889 = 3'h4;
    logic [1:0] M_sr1_din;
    logic M_sr1_wput;
    logic M_sr1_full;
    ...
    fifo #(
        .WIDTH(_MP_WIDTH_543237889),
        .ENTRIES(_MP_ENTRIES_543237889)
    ) sr1 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr1_din),
    ...
    localparam _MP_WIDTH_1618004347 = 2'h2;
    localparam _MP_ENTRIES_1618004347 = 3'h4;
    logic [1:0] M_sr2_din;
    logic M_sr2_wput;
    logic M_sr2_full;
    ...
    fifo #(
        .WIDTH(_MP_WIDTH_1618004347),
        .ENTRIES(_MP_ENTRIES_1618004347)
    ) sr2 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr2_din),
    ...
    localparam _MP_WIDTH_1332855784 = 2'h2;
    localparam _MP_ENTRIES_1332855784 = 3'h4;
    logic [1:0] M_sr3_din;
    logic M_sr3_wput;
    logic M_sr3_full;
    ...
    fifo #(
        .WIDTH(_MP_WIDTH_1332855784),
        .ENTRIES(_MP_ENTRIES_1332855784)
    ) sr3 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr3_din),
