...
module bram #(
    ...
    localparam _MP_WIDTH_1767733534 = WIDTH;
    localparam _MP_ENTRIES_1767733534 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1767733534)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1767733534-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1767733534-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1767733534),
        .ENTRIES(_MP_ENTRIES_1767733534)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_2079979971 = WIDTH;
    localparam _MP_ENTRIES_2079979971 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_2079979971)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_2079979971-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_2079979971-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_2079979971),
        .ENTRIES(_MP_ENTRIES_2079979971)
    ) bram2 (
        .clk(clk),
