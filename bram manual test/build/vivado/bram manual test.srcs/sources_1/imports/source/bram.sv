...
module bram #(
    ...
    localparam _MP_WIDTH_1864881905 = WIDTH;
    localparam _MP_ENTRIES_1864881905 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1864881905)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1864881905-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1864881905-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1864881905),
        .ENTRIES(_MP_ENTRIES_1864881905)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_425934206 = WIDTH;
    localparam _MP_ENTRIES_425934206 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_425934206)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_425934206-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_425934206-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_425934206),
        .ENTRIES(_MP_ENTRIES_425934206)
    ) bram2 (
        .clk(clk),
