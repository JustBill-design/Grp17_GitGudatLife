...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_353943568 = DIGIT_BITS;
    localparam _MP_DIV_353943568 = DIV;
    localparam _MP_TOP_353943568 = DIGITS - 1'h1;
    localparam _MP_UP_353943568 = 1'h1;
    logic [(_MP_SIZE_353943568)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_353943568),
        .DIV(_MP_DIV_353943568),
        .TOP(_MP_TOP_353943568),
        .UP(_MP_UP_353943568)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1532806143 = 3'h4;
    localparam _MP_LEADING_ZEROS_1532806143 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1532806143),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1532806143)
    ) decimal_renderer (
