...
module bram #(
    ...
    localparam _MP_WIDTH_1450831665 = WIDTH;
    localparam _MP_ENTRIES_1450831665 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1450831665)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1450831665-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1450831665-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1450831665),
        .ENTRIES(_MP_ENTRIES_1450831665)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_354407984 = WIDTH;
    localparam _MP_ENTRIES_354407984 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_354407984)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_354407984-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_354407984-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_354407984),
        .ENTRIES(_MP_ENTRIES_354407984)
    ) bram2 (
        .clk(clk),
