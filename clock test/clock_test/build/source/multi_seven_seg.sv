...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_526078007 = DIGIT_BITS;
    localparam _MP_DIV_526078007 = DIV;
    localparam _MP_TOP_526078007 = DIGITS - 1'h1;
    localparam _MP_UP_526078007 = 1'h1;
    logic [(_MP_SIZE_526078007)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_526078007),
        .DIV(_MP_DIV_526078007),
        .TOP(_MP_TOP_526078007),
        .UP(_MP_UP_526078007)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1329734527 = 3'h4;
    localparam _MP_LEADING_ZEROS_1329734527 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1329734527),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1329734527)
    ) decimal_renderer (
