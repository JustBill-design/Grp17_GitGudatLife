...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_647697792 = DIGIT_BITS;
    localparam _MP_DIV_647697792 = DIV;
    localparam _MP_TOP_647697792 = DIGITS - 1'h1;
    localparam _MP_UP_647697792 = 1'h1;
    logic [(_MP_SIZE_647697792)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_647697792),
        .DIV(_MP_DIV_647697792),
        .TOP(_MP_TOP_647697792),
        .UP(_MP_UP_647697792)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1524309870 = 3'h4;
    localparam _MP_LEADING_ZEROS_1524309870 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1524309870),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1524309870)
    ) decimal_renderer (
