...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_56547795 = DIGIT_BITS;
    localparam _MP_DIV_56547795 = DIV;
    localparam _MP_TOP_56547795 = DIGITS - 1'h1;
    localparam _MP_UP_56547795 = 1'h1;
    logic [(_MP_SIZE_56547795)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_56547795),
        .DIV(_MP_DIV_56547795),
        .TOP(_MP_TOP_56547795),
        .UP(_MP_UP_56547795)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1777339226 = 3'h4;
    localparam _MP_LEADING_ZEROS_1777339226 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1777339226),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1777339226)
    ) decimal_renderer (
