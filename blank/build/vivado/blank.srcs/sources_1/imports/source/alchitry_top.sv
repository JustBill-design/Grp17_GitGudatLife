...
module alchitry_top (
    ...
    localparam _MP_SIZE_1693765239 = 4'hd;
    logic [12:0] M_alum_a;
    logic [12:0] M_alum_b;
    ...
    logic rst;
    logic fifo_rst;
    localparam _MP_STAGES_1033796709 = 3'h4;
    logic M_reset_cond_in;
    logic M_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_1033796709)
    ) reset_cond (
        .clk(clk),
        .in(M_reset_cond_in),
    ...
    localparam _MP_STAGES_254614334 = 3'h4;
    logic M_fifo_reset_cond_in;
    logic M_fifo_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_254614334)
    ) fifo_reset_cond (
        .clk(clk),
    ...
    localparam logic [3:0][26:0] _MP_CLK_FREQ_752211190 = {{27'h5f5e100, 27'h5f5e100, 27'h5f5e100, 27'h5f5e100}};
    localparam logic [3:0][7:0] _MP_MIN_DELAY_752211190 = {{8'hc8, 8'hc8, 8'hc8, 8'hc8}};
    localparam logic [3:0][4:0] _MP_NUM_SYNC_752211190 = {{5'h1e, 5'h1e, 5'h1e, 5'h1e}};
    logic [3:0] M_cond_butt_dirs_in;
    logic [3:0] M_cond_butt_dirs_out;
    
    genvar idx_0_752211190;
    
    generate
        for (idx_0_752211190 = 0; idx_0_752211190 < 4; idx_0_752211190 = idx_0_752211190 + 1) begin: forLoop_idx_0_752211190
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_752211190[idx_0_752211190]),
                .MIN_DELAY(_MP_MIN_DELAY_752211190[idx_0_752211190]),
                .NUM_SYNC(_MP_NUM_SYNC_752211190[idx_0_752211190])
            ) cond_butt_dirs (
                .clk(clk),
                .in(M_cond_butt_dirs_in[idx_0_752211190]),
                .out(M_cond_butt_dirs_out[idx_0_752211190])
            );
        end
    endgenerate
    
    
    localparam logic [1:0][26:0] _MP_CLK_FREQ_670028842 = {{27'h5f5e100, 27'h5f5e100}};
    localparam logic [1:0][7:0] _MP_MIN_DELAY_670028842 = {{8'hc8, 8'hc8}};
    localparam logic [1:0][4:0] _MP_NUM_SYNC_670028842 = {{5'h1e, 5'h1e}};
    logic [1:0] M_cond_butt_sel_desel_in;
    logic [1:0] M_cond_butt_sel_desel_out;
    
    genvar idx_0_670028842;
    
    generate
        for (idx_0_670028842 = 0; idx_0_670028842 < 2; idx_0_670028842 = idx_0_670028842 + 1) begin: forLoop_idx_0_670028842
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_670028842[idx_0_670028842]),
                .MIN_DELAY(_MP_MIN_DELAY_670028842[idx_0_670028842]),
                .NUM_SYNC(_MP_NUM_SYNC_670028842[idx_0_670028842])
            ) cond_butt_sel_desel (
                .clk(clk),
                .in(M_cond_butt_sel_desel_in[idx_0_670028842]),
                .out(M_cond_butt_sel_desel_out[idx_0_670028842])
            );
        end
    endgenerate
    
    
    localparam _MP_CLK_FREQ_340574059 = 27'h5f5e100;
    localparam _MP_MIN_DELAY_340574059 = 8'hc8;
    localparam _MP_NUM_SYNC_340574059 = 5'h1e;
    logic M_cond_butt_next_play_in;
    logic M_cond_butt_next_play_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_340574059),
        .MIN_DELAY(_MP_MIN_DELAY_340574059),
        .NUM_SYNC(_MP_NUM_SYNC_340574059)
    ) cond_butt_next_play (
        .clk(clk),
    ...
    localparam _MP_RISE_1286817542 = 1'h1;
    localparam _MP_FALL_1286817542 = 1'h0;
    logic M_edge_next_play_in;
    logic M_edge_next_play_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1286817542),
        .FALL(_MP_FALL_1286817542)
    ) edge_next_play (
        .clk(clk),
    ...
    localparam _MP_RISE_1636221786 = 1'h1;
    localparam _MP_FALL_1636221786 = 1'h0;
    logic M_timerclk_in;
    logic M_timerclk_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1636221786),
        .FALL(_MP_FALL_1636221786)
    ) timerclk (
        .clk(clk),
        .in(M_timerclk_in),
        .out(M_timerclk_out)
    ...
    localparam _MP_RISE_1386639389 = 1'h1;
    localparam _MP_FALL_1386639389 = 1'h0;
    logic M_gameclk_in;
    logic M_gameclk_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1386639389),
        .FALL(_MP_FALL_1386639389)
    ) gameclk (
        .clk(clk),
        .in(M_gameclk_in),
        .out(M_gameclk_out)
    ...
    localparam _MP_RISE_944010148 = 1'h1;
    localparam _MP_FALL_944010148 = 1'h0;
    logic M_med_inputclk_in;
    logic M_med_inputclk_out;
    
    edge_detector #(
        .RISE(_MP_RISE_944010148),
        .FALL(_MP_FALL_944010148)
    ) med_inputclk (
        .clk(clk),
    ...
    localparam _MP_RISE_748836055 = 1'h1;
    localparam _MP_FALL_748836055 = 1'h0;
    logic M_edge_up_in;
    logic M_edge_up_out;
    
    edge_detector #(
        .RISE(_MP_RISE_748836055),
        .FALL(_MP_FALL_748836055)
    ) edge_up (
        .clk(clk),
        .in(M_edge_up_in),
        .out(M_edge_up_out)
    ...
    localparam _MP_WIDTH_1899941423 = 2'h2;
    localparam _MP_ENTRIES_1899941423 = 13'h1080;
    ...
    bram #(
        .WIDTH(_MP_WIDTH_1899941423),
        .ENTRIES(_MP_ENTRIES_1899941423)
    ) brams (
        .clk(clk),
    ...
    localparam _MP_ADDRESS_SIZE_1985178832 = 3'h5;
    localparam _MP_MATRIX_WIDTH_1985178832 = 7'h40;
    localparam _MP_CLK_FREQ_1985178832 = 27'h5f5e100;
    ...
    display_driver #(
        .ADDRESS_SIZE(_MP_ADDRESS_SIZE_1985178832),
        .MATRIX_WIDTH(_MP_MATRIX_WIDTH_1985178832),
        .CLK_FREQ(_MP_CLK_FREQ_1985178832)
    ) display (
        .clk(clk),
        .rst(rst),
        .data(M_display_data),
    ...
    localparam _MP_SIZE_910656626 = 5'h1b;
    localparam _MP_DIV_910656626 = 1'h0;
    localparam _MP_TOP_910656626 = 27'h5f5e100;
    localparam _MP_UP_910656626 = 1'h1;
    logic [26:0] M_gamecounter_value;
    
    counter #(
        .SIZE(_MP_SIZE_910656626),
        .DIV(_MP_DIV_910656626),
        .TOP(_MP_TOP_910656626),
        .UP(_MP_UP_910656626)
    ) gamecounter (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_WIDTH_113095814 = 4'hd;
    localparam _MP_ENTRIES_113095814 = 4'h8;
    logic [2:0] M_reg_ra1;
    logic [2:0] M_reg_ra2;
    ...
    regfile #(
        .WIDTH(_MP_WIDTH_113095814),
        .ENTRIES(_MP_ENTRIES_113095814)
    ) L_reg (
        .clk(clk),
        .rst(rst),
        .ra1(M_reg_ra1),
    ...
    localparam _MP_DIGITS_423072963 = 3'h4;
    localparam _MP_DIV_423072963 = 5'h10;
    logic [13:0] M_aseg_driver_value;
    logic [11:0] M_aseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_423072963),
        .DIV(_MP_DIV_423072963)
    ) aseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_709529383 = 3'h4;
    localparam _MP_DIV_709529383 = 5'h10;
    logic [13:0] M_bseg_driver_value;
    logic [11:0] M_bseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_709529383),
        .DIV(_MP_DIV_709529383)
    ) bseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_862547597 = 3'h4;
    localparam _MP_DIV_862547597 = 5'h10;
    logic [13:0] M_timerseg_driver_value;
    logic [11:0] M_timerseg_driver_out;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_862547597),
        .DIV(_MP_DIV_862547597)
    ) timerseg_driver (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_WIDTH_1878875551 = 2'h2;
    localparam _MP_ENTRIES_1878875551 = 3'h4;
    logic [1:0] M_sr1_din;
    logic M_sr1_wput;
    logic M_sr1_full;
    ...
    fifo #(
        .WIDTH(_MP_WIDTH_1878875551),
        .ENTRIES(_MP_ENTRIES_1878875551)
    ) sr1 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr1_din),
    ...
    localparam _MP_WIDTH_1291868005 = 2'h2;
    localparam _MP_ENTRIES_1291868005 = 3'h4;
    logic [1:0] M_sr2_din;
    logic M_sr2_wput;
    logic M_sr2_full;
    ...
    fifo #(
        .WIDTH(_MP_WIDTH_1291868005),
        .ENTRIES(_MP_ENTRIES_1291868005)
    ) sr2 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr2_din),
    ...
    localparam _MP_WIDTH_1062162697 = 2'h2;
    localparam _MP_ENTRIES_1062162697 = 3'h4;
    logic [1:0] M_sr3_din;
    logic M_sr3_wput;
    logic M_sr3_full;
    ...
    fifo #(
        .WIDTH(_MP_WIDTH_1062162697),
        .ENTRIES(_MP_ENTRIES_1062162697)
    ) sr3 (
        .clk(clk),
        .rst(fifo_rst),
        .din(M_sr3_din),
