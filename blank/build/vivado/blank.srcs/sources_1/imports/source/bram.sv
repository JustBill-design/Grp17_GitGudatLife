...
module bram #(
    ...
    localparam _MP_WIDTH_1298150723 = WIDTH;
    localparam _MP_ENTRIES_1298150723 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1298150723)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1298150723-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1298150723-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1298150723),
        .ENTRIES(_MP_ENTRIES_1298150723)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_14980198 = WIDTH;
    localparam _MP_ENTRIES_14980198 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_14980198)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_14980198-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_14980198-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_14980198),
        .ENTRIES(_MP_ENTRIES_14980198)
    ) bram2 (
        .clk(clk),
