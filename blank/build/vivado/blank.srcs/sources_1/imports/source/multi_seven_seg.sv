...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_721852588 = DIGIT_BITS;
    localparam _MP_DIV_721852588 = DIV;
    localparam _MP_TOP_721852588 = DIGITS - 1'h1;
    localparam _MP_UP_721852588 = 1'h1;
    logic [(_MP_SIZE_721852588)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_721852588),
        .DIV(_MP_DIV_721852588),
        .TOP(_MP_TOP_721852588),
        .UP(_MP_UP_721852588)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_1122672628 = 3'h4;
    localparam _MP_LEADING_ZEROS_1122672628 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_1122672628),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_1122672628)
    ) decimal_renderer (
