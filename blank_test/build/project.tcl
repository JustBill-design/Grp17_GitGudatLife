...
set verilogSources [list "./source/alchitry_top.sv" "./source/reset_conditioner.sv" "./source/fsm.sv" "./source/display_driver.sv" "./source/regfile.sv" "./source/bram.sv" "./source/alu.sv" "./source/multi_seven_seg.sv" "./source/simple_dual_port_ram.v" "./source/pipeline.sv" "./source/simple_ram.v" "./source/fifo.sv" "./source/button_conditioner.sv" "./source/bin_to_dec.sv" "./source/counter.sv" "./source/edge_detector.sv" "./source/lucid_globals.sv" ]
