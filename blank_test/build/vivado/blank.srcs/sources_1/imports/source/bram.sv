...
module bram #(
    ...
    localparam _MP_WIDTH_1485300180 = WIDTH;
    localparam _MP_ENTRIES_1485300180 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1485300180)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1485300180-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1485300180-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1485300180),
        .ENTRIES(_MP_ENTRIES_1485300180)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1707272752 = WIDTH;
    localparam _MP_ENTRIES_1707272752 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1707272752)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1707272752-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1707272752-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1707272752),
        .ENTRIES(_MP_ENTRIES_1707272752)
    ) bram2 (
        .clk(clk),
