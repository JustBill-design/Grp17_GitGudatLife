...
module multi_seven_seg #(
    ...
    localparam _MP_SIZE_789755795 = DIGIT_BITS;
    localparam _MP_DIV_789755795 = DIV;
    localparam _MP_TOP_789755795 = DIGITS - 1'h1;
    localparam _MP_UP_789755795 = 1'h1;
    logic [(_MP_SIZE_789755795)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_789755795),
        .DIV(_MP_DIV_789755795),
        .TOP(_MP_TOP_789755795),
        .UP(_MP_UP_789755795)
    ) ctr (
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_519757321 = 3'h4;
    localparam _MP_LEADING_ZEROS_519757321 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_519757321),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_519757321)
    ) decimal_renderer (
